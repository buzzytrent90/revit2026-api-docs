...
# IFailuresPreprocessorPreprocessFailures Method  
...
failuresAccessor [FailuresAccessor](dea68b06-a061-fc05-d814-db741f2e7f14.md)
     The Interface class that provides access to the failure information. 

#### Return Value

[FailureProcessingResult](f147e6e6-4b2e-d61c-df9b-8b8e5ebe3fcb.md) Notifies end of transaction code about further actions required. Return values are interpreted as follows: 
