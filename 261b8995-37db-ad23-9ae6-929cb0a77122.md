...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBFabricationPartType
...
The FabricationPartType type exposes the following members.
...
|  | [Create](b36e8a6b-8bf0-8332-e366-bc6da145adac.md) | Creates a fabrication part type element based on a specific fabrication servic button and condition. |
...
|  | [Lookup](5b71bce4-f161-6f8c-48dd-96f745990157.md) | Looks up an existing fabrication part type based on a specfic fabrication service button and condition. |
