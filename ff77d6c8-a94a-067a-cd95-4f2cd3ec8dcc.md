...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBImageInstance
...
The ImageInstance type exposes the following members.
...
|  | [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.md) | When true the ImageInstance has snaps that can be enabled with the [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.md) property |
...
|  | [DrawLayer](81510a8d-d74e-bf19-dd79-f8909b178d20.md) | The layer the ImageInstance will be drawn in. |
|  | [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.md) | When true the ImageInstance will have its snaps enabled, but only if [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.md) is true |
...
|  | [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md) | The height of the ImageInstance. |
|  | [HeightScale](c0c41a38-7554-4472-479a-794b561a6534.md) | The factor applied to the [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md) to calculate the [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md) of the ImageInstance. |
...
|  | [LockProportions](2eda8038-9240-00f5-ffa3-a65d8b4df5f2.md) | When true the proportion of [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md) to [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md) will be maintained |
...
|  | [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md) | The width of the ImageInstance. |
|  | [WidthScale](c938de3b-849b-11a0-c80b-cb852b65c64b.md) | The factor applied to the width of the [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md) to calculate the [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md) of the ImageInstance. |
...
|  | [Create](0f4cd250-7925-6714-3e08-2bd7c0266252.md) | Creates a new ImageInstance element placed in a view. |
...
|  | [GetLocation](c275e3bf-00ab-2d2f-8c41-7d4cd7ff79fe.md) | Returns the location of one of the points of the ImageInstance |
...
|  | [IsValidView](ee7cd29b-d142-27e8-4fc0-4eff2109b1c1.md) | Check that the view is a valid view for ImageInstance elements |
...
|  | [SetLocation](2ca53d23-6e03-838c-b755-2478f778357d.md) | Moves the ImageInstance to the specified location |
