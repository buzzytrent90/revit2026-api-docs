...
# RebarBarTypeCanCrankParametersBeComputedUsingCrankStraightLength Method  
...
Boolean Returns true if the crank paramters can be computed using the input crank straight length, false otherwise. 
