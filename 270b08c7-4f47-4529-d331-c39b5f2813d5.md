...
# IFCParameterTemplateSetPropertySetExportingFlag Method  
...
```
```vb
Public Sub SetPropertySetExportingFlag ( 
...
```cpp
public:
void SetPropertySetExportingFlag(
	PropertySetupType propertySetupType, 
	String^ propertySetName, 
	bool exportFlag
)
```
```fsharp
member SetPropertySetExportingFlag : 
        propertySetupType : PropertySetupType * 
        propertySetName : string * 
        exportFlag : bool -> unit 
```
