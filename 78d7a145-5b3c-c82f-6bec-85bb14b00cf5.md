...
[WallCrossSection](c0017a61-ed27-8124-f3f7-17d73c446169.md)

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The current wall does not support the cross section wallCrossSection. |
...
This value determines whether the wall is vertical, slanted or tapered. See also: [WallCrossSection](c0017a61-ed27-8124-f3f7-17d73c446169.md). Setting the value to "SingleSlanted" or "Tapered" will enable other parameters to control the slanted angle(s) for a slanted or a tapered wall. 
