...
Creates a new instance of Structural Section User Defined shape with the associated set of parameters, used to attach to structural element. 
...
new : 
        ...
        shearAreaWeakAxis : float -> StructuralSectionUserDefined
```
