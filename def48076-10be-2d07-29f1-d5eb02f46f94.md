...
# AnalyticalPowerDistributableNodeDataGetConnectedPhasesOnDownstream Method  
...
```
```vb
Public Function GetConnectedPhasesOnDownstream ( 
	id As ElementId
) As ElectricalConnectedPhases
```
```cpp
public:
ElectricalConnectedPhases GetConnectedPhasesOnDownstream(
	ElementId^ id
)
```
```fsharp
member GetConnectedPhasesOnDownstream : 
        id : ElementId -> ElectricalConnectedPhases 
```
...
[ElectricalConnectedPhases](19486d97-997f-11da-a2f3-6de29bd7ef41.md) The electrical connected phases of the downstream node. 
