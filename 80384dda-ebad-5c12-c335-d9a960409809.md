...
# RebarBarTypeCanCrankParametersBeComputedUsingCrankAngledLength Method  
...
Boolean Returns true if the crank paramters can be computed using the input crank angled length, false otherwise. 
