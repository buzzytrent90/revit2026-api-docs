...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBPointCloudType
...
The PointCloudType type exposes the following members.
...
|  | [ColorEncoding](322946b6-a9c1-ea15-ead5-5672be3644ea.md) | The color encoding used by points extracted from instances of this point cloud. |
...
|  | [EngineIdentifier](4cb3c05e-4a87-ffe3-fcb2-fba451dd8004.md) | The identifier of the engine responsible for handling of the point cloud. |
...
|  | [FoundStatus](4fdf0074-3b7e-e6dc-0bf2-2c9b47685a30.md) | Shows whether the Point Cloud external file could be found. |
...
|  | [Offset](e6e7fa66-77d5-9bd4-e79f-6116494733c7.md) | Returns the offset stored in the point cloud. |
...
|  | [Scale](5d96579f-ac8d-885e-ce1a-09caeff015ef.md) | The multiplier applied to the points in all instances of this point cloud. |
...
|  | [Create](2a1fb419-d46e-1acb-90ee-a668ae3ff3eb.md) | Creates a new point cloud type for a given point cloud engine. |
...
|  | [GetPath](0705dfa3-03c4-12ff-b2ef-7dfae8fa768b.md) | Gets the path of the link source from which the points are loaded. |
