...
```
```vb
Public Class StructuralSectionConcreteRound
...
```
```fsharp
type StructuralSectionConcreteRound = 
    class
...
The StructuralSectionConcreteRound type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionConcreteRound](4c5df507-ff7a-71c1-8726-06349bee5355.md) | Creates a new instance of Structural Section Concrete Round shape with the associated set of parameters, used to attach to structural element. |
