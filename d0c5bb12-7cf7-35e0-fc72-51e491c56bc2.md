...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalElectricalSetting
...
The ElectricalSetting type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddDistributionSysType](298ea72a-5647-a71d-d6d5-9da1dab5ecbd.md) | Add a new distribution system type to project. |
|  | [AddVoltageType](49eaeba6-d43d-5af8-a80e-4f0259d137c7.md) | Add a new type definition of voltage into project. |
|  | [AddWireMaterialType](bda3127d-4237-2400-aae0-2e3d9d861a98.md) | **Obsolete.** Add a new type of wire material. |
|  | [AddWireType](96fef9f1-166b-082d-1ec7-e844ac51297f.md) | **Obsolete.** Add a new wire type to project. |
...
|  | [GetCircuitNamingSchemeSettings](33a63ebf-0879-2386-9a91-b52d78b60462.md) | Gets the circuit naming scheme settings of the project. |
...
|  | [GetElectricalSettings](302abeae-4875-bb5d-db5d-d6e6cfa8afb8.md) | Get the electrical settings of the project. |
...
|  | [GetSpecificFittingAngles](b0948977-6da0-58fb-3a38-5d10e685ecc4.md) | Gets the list of specific fitting angles. |
|  | [GetSpecificFittingAngleStatus](0d6e6888-83d5-89fb-77ba-dfab13f2ca81.md) | Gets the status of given specific fitting angle. |
...
|  | [IsValidSpecificFittingAngle](3ba25c52-38b9-2908-c073-3632537977a6.md) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
|  | [RemoveDistributionSysType](1170cd1f-0209-53f6-dd7c-f294bc4e3e8f.md) | Remove an existing distribution system type from the project. |
|  | [RemoveVoltageType](657db947-8a83-86fa-da81-2451fc2026d6.md) | Remove the voltage type from project. |
|  | [RemoveWireMaterialType](d3193518-abc6-0c64-cbf8-332b04bef8ad.md) | **Obsolete.** Remove the wire material type from project. |
|  | [RemoveWireType](2a4cbba1-f777-47b5-e3c2-941950f172ba.md) | Remove wire type definition from project. |
...
|  | [SetSpecificFittingAngleStatus](799e261d-93b7-062c-efcb-f370550ce67c.md) | Sets the status of given specific angle. |
