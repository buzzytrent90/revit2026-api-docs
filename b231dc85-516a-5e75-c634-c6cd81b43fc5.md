...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBFilterElement](909615cd-8abd-044a-cff2-f21fd95b8ee7.md) Autodesk.Revit.DBParameterFilterElement
...
|  | [ClearRules](c6ad088a-38c2-8d3f-947a-83fe0dff11eb.md) | Removes all rules from this filter. |
...
|  | [GetCategories](7e497437-277e-8e15-bdc5-9065d868f464.md) | Gets the categories admitted by this filter. |
...
|  | [GetElementFilter](9b14bfc0-597d-36ab-77d6-d801c3053873.md) | Returns an ElementFilter representing the combination of rules used by this filter. |
|  | [GetElementFilterParameters](132d12c4-20b4-0b81-7c06-e5ad6f3f903f.md) | Retrieves a list of the parameters associated with each rule in the filter. |
|  | [GetElementFilterParametersForCategory](7b1992bb-a55f-f872-b35b-0a2db840bf68.md) | Retrieves a list of the parameters associated with all rules in the filter that are combined (using logical AND) with a FilterCategoryRule corresponding to single %categoryId%. |
...
|  | [IsNameUnique(String)](018d3415-a9b7-0935-98cd-453022be6f59.md) | Determines whether a potential filter element name is unique. (Inherited from [FilterElement](909615cd-8abd-044a-cff2-f21fd95b8ee7.md)) |
...
|  | [SetCategories](a124ea27-f102-fa18-aa6c-72038f89cc7a.md) |  |
|  | [SetElementFilter](42927817-dfe1-2787-b133-af3480ae0921.md) | Sets the rules that must be satisfied for a given element to pass this filter. |
