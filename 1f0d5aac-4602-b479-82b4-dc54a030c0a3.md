...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The family type id familyTypeId is invalid for the give family category familyCategoryId. -or- familyCategoryId is not a built in category or parameter Element ID. |
