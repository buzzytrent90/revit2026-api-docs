...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBDisplacementPath
...
The DisplacementPath type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AncestorIdx](fed5f5e3-2f84-1ccf-458d-d2c3f30d3a02.md) | Specifies the end point of the path. |
...
|  | [PathStyle](b812339e-d1c8-6303-5538-091fdbcaf838.md) | Specifies the style of the path. |
...
|  | [Create](c3a023a5-b875-4de1-a092-f62002a258cf.md) | Creates a new DisplacementPath referencing a DisplacementElement and edge or curve and adds it to the document. |
...
|  | [IsValidParam](2e1abd7d-718e-26af-7fbc-6746ec2963c2.md) | Is the specified value a valid edge or curve parameter. |
|  | [IsValidReference](f3c1aeed-e6e3-77cd-1c03-21280f06f755.md) | Does the specified pick represent an edge or a curve belonging to one of the displaced elements. |
...
|  | [SetAnchorPoint](5d92709f-6736-b8b9-b31b-68f0af5f8ee1.md) | Sets the reference that determines the origin of this DisplacementPath. |
