...
# BarTerminationsDataEndTreatmentTypeIdAtEnd Property  
  
---  
  
Identifies the end treatment type at the end of bar. Setting this property to a valid value, will set the CrankTypeIdAtEnd and HookTypeIdAtEnd to ElementId.InvalidElementId. 
