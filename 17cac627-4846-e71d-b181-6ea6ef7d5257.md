...
# RebarFreeFormAccessorRemoveUpdatingSharedParameter Method  
...
```
```vb
Public Sub RemoveUpdatingSharedParameter ( 
...
```
```fsharp
member RemoveUpdatingSharedParameter : 
...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This RebarFreeFormAccessor Rebar doesn't contain a valid server GUID. -or- parameterId is a parameter that is not bound to the Rebar element category. |
