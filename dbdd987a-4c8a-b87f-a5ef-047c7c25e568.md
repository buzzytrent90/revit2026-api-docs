...
# RebarBendDataCrankStraightLength1 Property  
...
```csharp
public double CrankStraightLength1 { get; }
```
```vb
Public ReadOnly Property CrankStraightLength1 As Double
	Get
```
```cpp
public:
property double CrankStraightLength1 {
	double get ();
}
```
```fsharp
member CrankStraightLength1 : float with get
```
