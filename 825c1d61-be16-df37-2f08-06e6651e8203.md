...
# StructuralSettingsBraceBelowSymbol Property  
...
```csharp
public ElementId BraceBelowSymbol { get; set; }
```
```vb
Public Property BraceBelowSymbol As ElementId
	Get
	Set
```
```cpp
public:
property ElementId^ BraceBelowSymbol {
	ElementId^ get ();
	void set (ElementId^ value);
}
```
```fsharp
member BraceBelowSymbol : ElementId with get, set
```
