...
# GlobalParametersManagerMoveParameterDownOrder Method  
...
```
```vb
Public Shared Function MoveParameterDownOrder ( 
...
```
```fsharp
static member MoveParameterDownOrder : 
        document : Document * 
...
Boolean Indicates whether the parameter could be moved Down in order or not. 
