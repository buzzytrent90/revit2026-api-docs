...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ElectricalTemperatureRatingType
...
```csharp
[ObsoleteAttribute("TemperatureRatingType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use TemperatureRating instead. TemperatureRatings will be created by TemperatureRatingTypes properly during document upgrade.")]
...
```
```cpp
[ObsoleteAttribute(L"TemperatureRatingType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use TemperatureRating instead. TemperatureRatings will be created by TemperatureRatingTypes properly during document upgrade.")]
...
The TemperatureRatingType type exposes the following members.
...
|  | [CorrectionFactors](e0b0df88-e174-3f9d-c33a-5a7f510a4c3a.md) | Get all correction factors defined in this temperature rating type and its corresponding material type. |
...
|  | [InsulationTypes](5cdebb2b-28d5-c269-77a9-88397ec71ab8.md) | Get all insulation types defined in this temperature rating type and its corresponding material type. |
|  | [IsInUse](299c4fea-6792-f095-ddeb-a5f0369c9b67.md) | Indicate whether the temperature rating type is in use. |
...
|  | [MaterialType](866dd039-e888-66fb-d844-c99b2b14a11f.md) | Get the material type information which this temperature rating type belongs to. |
|  | [Name](35bbef58-e76c-35bf-b2e2-1ccd3e99f1e1.md) | Get name of temperature rating type. (Overrides [ElementTypeName](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.md)) |
...
|  | [WireSizes](e3774ff7-1914-815d-8611-abb1c3174021.md) | Get all electrical wire sizes defined in this temperature rating type and its corresponding material type. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddCorrectionFactor](c8c0c7ac-34af-bc90-e55f-6f1a7baa0572.md) | Add a new electrical correction factor type to this temperature rating type. The given temperature value should be quantified in the document's selected unit of electrical temperature. |
|  | [AddInsulationType](b8c6e5cd-0913-b410-f2c2-ef2592da1536.md) | Add a new kind of insulation type into this temperature rating type. |
|  | [AddWireSize](21783809-813d-46fa-b237-e516e06517c2.md) | Add a new kind of wire size type into this temperature rating type. |
...
|  | [RemoveCorrectionFactor](2f2d2223-1a23-bac7-4666-68c2ef5a92d0.md) | Remove an existing correction factor from this temperature rating type in Revit MEP project. |
|  | [RemoveInsulationType](1195de62-fe29-f235-70f1-2e78c6e5f849.md) | Remove an existing insulation type from this temperature rating type. |
|  | [RemoveWireSize](a6195154-d5f0-46f3-3bb4-f5325de5da17.md) | Remove an existing wire size type from this temperature rating type. |
