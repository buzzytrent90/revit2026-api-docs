...
```
```vb
Public Class StructuralSectionGeneralLZ
...
```
```fsharp
type StructuralSectionGeneralLZ = 
    class
...
The StructuralSectionGeneralLZ type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionGeneralLZ](4284623a-86c6-68e7-d190-7f85f49fc855.md) | Creates a new instance of Z Cold Formed shape. |
...
|  | [BottomFlangeLength](37c21158-3e55-a913-050e-a035e564118f.md) | Bottom Flange segment length. |
...
|  | [LipLength](cbdb5460-ca39-0a5b-e965-97fa4f12822b.md) | Lip segment length. |
