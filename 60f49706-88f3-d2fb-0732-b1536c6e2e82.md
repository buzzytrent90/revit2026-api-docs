...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalCircuitNamingSchemeSettings
...
```
```vb
Public Class CircuitNamingSchemeSettings
	Inherits Element
```
```cpp
...
```
```fsharp
type CircuitNamingSchemeSettings = 
    class
        inherit Element
    end
```
...
The CircuitNamingSchemeSettings type exposes the following members.
...
|  | [CircuitNamingSchemeId](2cc3d296-fb16-e1b4-b2f3-b344702d11a2.md) | The circuit naming scheme id set in CircuitNamingSchemeSettings. |
...
|  | [GetCircuitNamingSchemeSettings](fdb5ac56-200e-61aa-c2b9-4ffdd6ba9a12.md) | Gets the circuit naming scheme settings of the project. |
...
|  | [IsValidCircuitNamingSchemeId](8bcc2aff-09a1-ab45-2c32-3624af0b877a.md) | Verifies that the circuit naming scheme id can be used with CircuitNamingSchemeSettings. |
