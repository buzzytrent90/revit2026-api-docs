...
# StructuralSettingsBraceAboveSymbol Property  
...
```
```vb
Public Property BraceAboveSymbol As ElementId
	Get
	Set
```
```cpp
public:
property ElementId^ BraceAboveSymbol {
	ElementId^ get ();
	void set (ElementId^ value);
}
```
```fsharp
member BraceAboveSymbol : ElementId with get, set
```
