...
# ViewScheduleRestoreImageSize Method  
...
All images in the schedule will be restored to their original sizes when viewed as a ScheduleSheetInstance on a ViewSheet. This reverts any changes made by setting [RowHeight](aca396e1-2fec-666c-005d-7e36d5153999.md). Calling this method has no effect if HasImageField is false. 
