...
# DuctSettingsSetDownFromBottom Property  
...
```csharp
public string SetDownFromBottom { get; set; }
```
```vb
Public Property SetDownFromBottom As String
	Get
	Set
```
```cpp
public:
property String^ SetDownFromBottom {
	String^ get ();
	void set (String^ value);
}
```
```fsharp
member SetDownFromBottom : string with get, set
```
