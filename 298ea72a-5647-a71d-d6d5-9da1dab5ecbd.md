...
phase [ElectricalPhase](aff8cc61-d006-c2df-8687-86c41f219384.md)
    Single or three phase this type is
phaseConfig [ElectricalPhaseConfiguration](fa91ef24-f277-a8b8-822c-7ec5fc076035.md)
    Configuration property of given phase
numWire Int32
    Wire number of this distribution system
volLineToLine [VoltageType](6b462685-b825-f8f9-f218-035107f7aaf0.md)
    Type of line to line voltage in this system
volLineToGround [VoltageType](6b462685-b825-f8f9-f218-035107f7aaf0.md)
    Type of line to ground voltage in this system

#### Return Value

[DistributionSysType](03754b33-fd20-b19b-a718-6dc2eeccd76c.md)New added distribution system type object.

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The name can't be , empty string, or equal with any existing one, phaseConfig should be defined and numWire can only be 3 or 4 in case of three phase, numWire can only be 2 or 3 in case of single phase, otherwise exception will be thrown. |
