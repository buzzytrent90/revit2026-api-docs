...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) [Autodesk.Revit.DBMEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md) [Autodesk.Revit.DBInsulationLiningBase](938d1b57-b9bb-44b0-81ec-c22dff57fc8e.md) Autodesk.Revit.DB.MechanicalDuctInsulation
...
```csharp
public class DuctInsulation : InsulationLiningBase
```
```vb
...
```
```cpp
public ref class DuctInsulation : public InsulationLiningBase
```
```fsharp
type DuctInsulation = 
    class
        inherit InsulationLiningBase
    end
```


The DuctInsulation type exposes the following members.
...
|  | [HostElementId](3bd52d75-7aea-1d0f-0ff6-0eae6b9a4928.md) | The id of the host element for the insulation or lining element. (Inherited from [InsulationLiningBase](938d1b57-b9bb-44b0-81ec-c22dff57fc8e.md)) |
...
|  | [Thickness](c3461678-f53e-f347-8d47-0b7a9c7e5671.md) | Thickness of the insulation or lining element. (Inherited from [InsulationLiningBase](938d1b57-b9bb-44b0-81ec-c22dff57fc8e.md)) |
...
|  | [Create](2b56ea02-1c59-5704-7d9e-ebf9fd4a80d4.md) | Creates a new instance of duct insulation. |
