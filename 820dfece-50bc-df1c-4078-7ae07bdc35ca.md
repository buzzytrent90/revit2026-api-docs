...
layer [CompoundStructureLayer](faece83a-6d49-41b0-2713-fe6cfaa5a3b5.md)
     The layer to be set. 
...
If the layer function is not Membrane or StructuralDeck, the width must be greater than zero. If the layer function is not StructuralDeck, then the deck embedding type must be Invalid, and the deck profile id must be InvalidElementId. The priority must be valid to match the function. Refer to [IsValidLayerPriority(Int32, Int32)](6cbf7458-d62f-2f95-9f51-8eb53af114f4.md). 
