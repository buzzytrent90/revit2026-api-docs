...
```
```vb
Public Shared ReadOnly Property TileLineShift As String
	Get
```
```cpp
public:
static property String^ TileLineShift {
	String^ get ();
}
```
```fsharp
static member TileLineShift : string with get
```
