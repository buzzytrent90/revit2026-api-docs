...
center [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)
...
justification [StairsRunJustification](4d75bda7-267b-dc0e-286a-b5efb839655f.md)
     The location path justification of the new stairs run. 

#### Return Value

[StairsRun](ea0e49a0-a007-79d0-c902-a24b1359ae28.md) The new stairs run. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The stairsId is not a valid stairs element. -or- The given value for startAngle is not finite -or- The input center is not a valid center for spiral run (probably the Z coordinate doesn't meet the restrictions) -or- The includedAngle doesn't satisfy riser restriction to generate spiral run (probably it's too small). |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | A non-optional argument was null |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | The given value for radius must be greater than 0 and no more than 30000 feet. -or- The given value for includedAngle must be positive. -or- A value passed for an enumeration argument is not a member of that enumeration |
| [ArgumentsInconsistentException](05972c68-fa6d-3a83-d720-ad84fbc4780f.md) | The radius is too small to generate a spiral run at the given justification. |
...
| [RegenerationFailedException](787bb389-74c2-5ce7-cdd6-32211209ded2.md) | The center, radius, startAngle, includedAngle don't satisfy restrictions to generate spiral run. |
