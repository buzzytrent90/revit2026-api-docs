...
otherConnector [ConnectorElement](cd7d7579-1058-e8ca-d55a-c3a914843667.md)
     The connector to link to. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The connector being linked to is a different domain than that of the calling connector. -or- The connector being linked to is the same as the calling connector. |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This connector type does not support linked connectors. |
