...
# DirectContext3DDocumentUtilsIsADirectContext3DHandleInstance Method  
...
```
```vb
Public Shared Function IsADirectContext3DHandleInstance ( 
...
```
```fsharp
static member IsADirectContext3DHandleInstance : 
        aDocument : Document * 
...
Boolean True, if the element is a valid DirectContext3D handle instance, false otherwise. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | aDocument is not a project document. -or- elementId is not a valid Element identifier. |
