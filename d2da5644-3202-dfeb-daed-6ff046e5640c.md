...
| Exception | Condition |
| --- | --- |
| [FileArgumentNotFoundException](ca9ccaa9-ed08-d40d-31a7-1af3ad2dcb84.md) | Thrown when manifest file which is specified by fileName doesn't exist. |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | Thrown if the fileName is null or empty. |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown if the fileName doesn't end with 'addin'. |
| [ApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) | Thrown if the manifest file can't be parsed successfully. |
