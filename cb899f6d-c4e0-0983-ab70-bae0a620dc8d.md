...
surfaceGeom [BRepBuilderSurfaceGeometry](c21d4101-cc15-1990-ee9f-994b487bf95d.md)
...
[BRepBuilderGeometryId](f7d0b679-926a-9f1d-8f2a-dda9c2f3fe7a.md) An id that can be used to identify the face while the BRepBuilder is actively building geometry (e.g., to add a loop to a face). 
