...
# GroupShowAllAttachedDetailGroups Method  
...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The input group is not a model group and can therefore not have attached detail groups. -or- This exception is thrown if this group's attached detail groups cannot be found in the current document. |
