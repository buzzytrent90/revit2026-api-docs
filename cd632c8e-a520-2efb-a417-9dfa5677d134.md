...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.MechanicalDuctSettings
...
The DuctSettings type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AirDensity](fffd52f7-044c-1a46-6943-ff877dec3279.md) | The air density in kg/ft^3. |
|  | [AirDynamicViscosity](d06453cd-944c-38bf-9c81-1ee23481353a.md) | The dynamic viscosity of air in kg/(ft*s). |
...
|  | [Centerline](9a7b2e55-5810-62ea-76a4-5db9b5f2e5ab.md) | The abbreviation of the Centerline (=) string. |
|  | [ConnectorSeparator](ca95fd1d-8c62-437a-f0be-feefe37ec20f.md) | The duct connector separator string. |
...
|  | [FittingAngleUsage](8112e243-c20e-35e6-02aa-f0e061538cd0.md) | Determine how to use fitting angle during duct layout or modifying layout. |
|  | [FittingAnnotationSize](ad1cbd39-b54e-6532-3db4-4621d0158663.md) | The value of fitting annotation size. |
|  | [FlatOnBottom](6d4acd42-372e-9ed4-bad2-dc019b99239f.md) | The abbreviation of the Flat On Bottom (FOB) string. |
|  | [FlatOnTop](717ef71c-64bf-953a-adad-213004aaf6ca.md) | The abbreviation of the Flat On Top (FOT) string. |
...
|  | [NetworkBasedCalculations](b888c721-828c-a71e-32bb-5545f8e07103.md) | Indicates whether to enable network based calculations for duct networks. |
|  | [OvalDuctSizeSeparator](fcde64b8-e345-25cd-29ad-0164438b16ef.md) | The oval duct size separator string. |
|  | [OvalDuctSizeSuffix](01a4fd90-4660-a555-b3d4-4388b3e9b4c3.md) | The oval duct size suffix string. |
...
|  | [RectangularDuctSizeSeparator](5bbed76e-f811-b98b-288a-6f74aa2b0f2c.md) | The rectangular duct size separator string. |
|  | [RectangularDuctSizeSuffix](6f59f18c-7a72-2819-3670-19f80aede525.md) | The rectangular duct size suffix string. |
|  | [RiseDropAnnotationSize](37074af6-8bb9-b562-2521-a0370382eed8.md) | The rise drop annotation size. |
|  | [RoundDuctSizePrefix](d1f1f1df-ff92-8640-4aa1-72dd2ef1114c.md) | The round duct size prefix string. |
|  | [RoundDuctSizeSuffix](abf0c448-17e8-dd63-bc37-8e695d268b75.md) | The round duct size suffix string. |
|  | [SetDown](a6b3a1bd-acd6-6ed0-ff42-00cf4ef48d18.md) | The abbreviation of the Set Down from top (TD) of fitting string. |
|  | [SetDownFromBottom](a58f3175-0d33-e7ae-fe40-e332b19ea490.md) | The abbreviation of the Set Down from bottom (BD) of fitting string. |
|  | [SetUp](158723ab-631f-05b6-48d2-75cd9aa0edf0.md) | The abbreviation of the Set Up from top (TU) of fitting string. |
|  | [SetUpFromBottom](45e7e748-e45b-1d98-04db-ea9a48314163.md) | The abbreviation of the Set Up from bottom (BU) of fitting string. |
...
|  | [UseAnnotationScaleForSingleLineFittings](ca019bfb-0ff9-8e14-9848-797bd3fcdd9a.md) | Indicates whether use annotation scale for single line fittings or not. |
...
|  | [GetDuctSettings](80923557-908d-ce4b-b711-9134e567a658.md) | Get the duct settings of the project. |
...
|  | [GetPressLossCalculationServerInfo](301d0233-9033-7ed8-9a66-aaa55c63ddfd.md) | Get the MEPServerInfo of the current pipe pressure loss calculation server. |
|  | [GetSpecificFittingAngles](0f140871-90cc-03cb-81f7-0cc33a1b24bc.md) | Gets the list of specific fitting angles. |
|  | [GetSpecificFittingAngleStatus](3d357c63-7ac9-01d1-7468-ebd4a3bf998a.md) | Gets the status of given specific angle. |
...
|  | [IsNetworkBasedCalculationsEnabled](ec71c154-e6cc-496f-3e73-c51735b4a2bc.md) | Indicates whether network based calculations for duct networks is enabled in the specified document. |
...
|  | [IsValidSpecificFittingAngle](4bfcf63d-bb63-a480-0487-a1d75f1308f7.md) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
|  | [SetPressLossCalculationServerInfo](8632a1d8-5126-ead1-985e-ade923e55461.md) | Set the MEPServerInfo of the current pipe pressure loss calculation server. |
|  | [SetSpecificFittingAngleStatus](9461503b-101d-ff04-6ad4-805578deb5f8.md) | Sets the status of given specific angle. |
