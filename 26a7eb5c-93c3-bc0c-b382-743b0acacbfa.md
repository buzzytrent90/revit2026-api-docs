...
# DocumentChangedEventArgsGetModifiedElementIds(ElementFilter) Method  
...
ICollection[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The set of ElementId for modified elements that pass the filter. Returns empty set if no elements are found which pass the filter. 
