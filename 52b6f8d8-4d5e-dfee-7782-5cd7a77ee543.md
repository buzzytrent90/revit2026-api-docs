...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBRevisionNumberingSequence
...
```
```vb
Public Class RevisionNumberingSequence
	Inherits Element
```
```cpp
...
The RevisionNumberingSequence type exposes the following members.
...
|  | [NumberType](40fa01d2-22a9-16aa-b363-ba9e1343aab6.md) | Indicates the revision number type of the revision numbering sequence. |
...
|  | [SequenceName](443a595a-51e1-c93e-d32b-0986178c777d.md) | The name of this revision numbering sequence. |
...
|  | [CreateAlphanumericSequence](295c5ef7-04e4-34c8-a25d-625ff61044cf.md) | Creates a new alphanumeric revision numbering sequence in the document. |
|  | [CreateNumericSequence](b3cc881b-67ea-8bf5-476e-ae9c5b9d455a.md) | Creates a new numeric revision numbering sequence in the document. |
...
|  | [GetAllRevisionNumberingSequences](dd3dd3e5-ed85-a7e4-6280-1a0e5464f5d0.md) | Gets all of the revision numbering sequences from the document. |
|  | [GetAlphanumericRevisionSettings](46b8cc2b-f31d-f4e3-e140-7b05ce50730c.md) | Returns a copy of the AlphanumericRevisionSettings owned by this revision numbering sequence. |
...
|  | [GetNumericRevisionSettings](63cbff5e-855c-9237-a160-e90f7e1f7a17.md) | Returns a copy of the NumericRevisionSettings owned by this revision numbering sequence. |
...
|  | [HasValidAlphanumericRevisionSettings](4dd5b623-eac0-0940-cf51-8e4cd6d7dc9f.md) | Checks whether the revision numbering sequence owns a valid alphanumeric revision settings. |
|  | [HasValidNumericRevisionSettings](4592ebc9-6662-6da7-0a59-0b038b60ef23.md) | Checks whether the revision numbering sequence owns a valid numeric revision settings. |
|  | [HasValidRevisionSettingsForNumberType](e9934563-b89b-3e28-f83d-9a029578aa26.md) | Checks whether the revision numbering sequence owns a valid revision settings for number type. |
...
|  | [SetAlphanumericRevisionSettings](e0c9a915-c30d-ed9c-eb5e-65a7e1f73e91.md) | Replaces the current alphanumeric revision numbering settings with the provided settings. |
...
|  | [SetNumericRevisionSettings](70bd6afe-8775-cf7d-6f8e-3198f988ae71.md) | Replaces the current numeric revision numbering settings with the provided settings. |
