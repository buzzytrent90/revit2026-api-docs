...
# DocumentNewLineBoundaryConditions(Reference, TranslationRotationValue, Double, TranslationRotationValue, Double, TranslationRotationValue, Double, TranslationRotationValue, Double) Method  
...
X_Rotation [TranslationRotationValue](0b6cf7fa-b211-2f21-98a0-4f4e0fe2ca0e.md)
...
[BoundaryConditions](58a98f0e-e2e5-4c8b-bea1-8228b30f1685.md)If successful, NewLineBoundaryConditions returns an object for the newly created BoundaryConditions with the BoundaryType = 1 - "Line".  is returned if the operation fails.
