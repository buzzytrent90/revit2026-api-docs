...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureFabricSheet
...
|  | [GetBendProfile](537ba6c2-26dd-3ce5-e359-5613eec5ef9b.md) | Returns the profile (not including generated fillets) that defines the shape of the Fabric Sheet bending. |
|  | [GetBendProfileWithFillets](aaae8dee-8b2e-0c57-fa52-adbfb0390581.md) | Returns the profile with generated fillets that defines the shape of the Fabric Sheet bending. |
...
|  | [GetReinforcementRoundingManager](6dc752d4-a675-2f4f-03fd-42a58620dae3.md) | Returns an object for managing reinforcement rounding override settings. |
|  | [GetSegmentParameterIdsAndLengths](1542c812-735a-0483-e5b5-7f02bc16b2f9.md) | Returns the array of pairs [parameter ID, length] that correspond to segments of a bent fabric sheet (like A, B, C, D etc.). |
|  | [GetSheetLocation](71a5aa6f-f57d-001d-bb8a-a5f8e7c27bfe.md) | Gets the position and the orientation of the Fabric Sheet instance. |
...
|  | [IsCoverOffsetValid](55e266df-8cb2-0f2c-4fab-492089461196.md) | Identifies if the specified value is valid for use as a cover offset. |
...
|  | [IsNotBent](32e650c7-8da2-f519-a238-dfed1cfa323f.md) | Method to verify that a fabric sheet is flat. |
...
|  | [IsSingleFabricSheetWithinHost](d0e85e9c-31f1-6ee4-c98b-8c124cc33d9c.md) | Identifies if the specified single Fabric Sheet position is within the host. |
|  | [IsUnobscuredInView](20c69421-426e-2f52-d8e2-0a808c12a036.md) | Checks if this fabric sheet is shown unobscured in a view. |
...
|  | [PlaceInHost](f1eb07fb-91a6-6ca9-f763-44f29e34014d.md) | Inserts the single Fabric Sheet instance into the host element. |
...
|  | [SetBendProfile](086c6100-798a-6998-f8e0-fac6d856e6be.md) | Sets new profile that defines the shape of the Fabric Sheet bending. |
...
|  | [SetSegmentLength](0c2d43a6-7e9f-115a-65a2-56e370747aa5.md) | Sets the value of the bent fabric sheet segment(like A, B, C, D etc.) |
|  | [SetUnobscuredInView](6df4a862-4a9b-1844-28d6-76076b8a8cdf.md) | Sets this fabric sheet to be shown unobscured in a view. |
