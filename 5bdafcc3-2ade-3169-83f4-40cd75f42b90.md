...
# RebarShapeDrivenAccessorBaseFinishingTurns Property  
...
```
```fsharp
member BaseFinishingTurns : int with get, set
```
...
| Exception | Condition |
| --- | --- |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | When setting this property: turns must be between 0 and 100. |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This RebarShapeDrivenAccessor is not an instance of a spiral shape. -or- This RebarShapeDrivenAccessor doesn't contain a valid rebar reference. |
