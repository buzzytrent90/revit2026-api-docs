...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBExportDWGSettings
...
The ExportDWGSettings type exposes the following members.
...
|  | [FindByName](8c4fd57e-67b9-92d5-6bbe-88be485f25dd.md) | Returns the pre-defined non-in-session exporting settings for DWG in the given document with the specified name. |
|  | [GetActivePredefinedSettings](94addb49-9531-141c-bfca-20377e135fa9.md) | Returns the active pre-defined non-in-session exporting settings for DWG in the given document. |
...
|  | [GetDWGExportOptions](d5372a5c-b19a-03a8-4a2b-5f3617acec61.md) | Gets the options stored in the these settings. |
|  | [GetDXFExportOptions](c678af47-2536-4301-8167-85d1aacf604e.md) | Gets the options stored in the these settings. |
...
|  | [ListNames](03a2609a-7777-f049-5013-c90eaa7054a2.md) | Returns a list of names of dwg/dxf export settings. |
...
|  | [SetDWGExportOptions](f518e57c-4b51-f1ba-114e-51a7d9d3dd92.md) | Sets the options stored in these settings. |
|  | [SetDXFExportOptions](0936653b-e358-404e-17cc-70cc6341dcb0.md) | Sets the options stored in these settings. |
