...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisMassSurfaceData
...
The MassSurfaceData type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Area](4c34a460-d3dc-3708-b8c7-d64036b0d273.md) | Area of the references that the MassSurfaceData provides properties for. |
...
|  | [CategoryIdForConceptualSurfaceType](ab56a667-e4a1-5a9f-9357-7aa40666b095.md) | Returns the mass subcategory ElementId used for ConceptualSurfaceType for this MassSurfaceData. |
|  | [ConceptualConstructionId](c496d32e-ed1d-5aa2-d342-e9f40a67252e.md) | The id of the conceptual construction associated with the reference surface. |
...
|  | [IsConceptualConstructionByEnergyData](f346fb03-72ad-4ad6-9503-7a883cb5b3ba.md) | True when the ConceptualConstructionType id is synchronized to the EnergyDataSettings. False when the ConceptualConstructionType id is overridden for this MassSurfaceData. |
|  | [IsGlazingShaded](59b5e249-17e5-7c0b-585b-7f0ce1210b5f.md) | Indicates if shade geometry is auto-generated on the top edge of auto-generated glazing. |
...
|  | [IsSlab](68e047a8-1349-2e7d-2029-e5afa9b14eeb.md) | Indicates if a floor is a slab. |
...
|  | [IsUnderground](31d63dc4-429b-c2b2-bd42-6b7f30d16147.md) | Indicates if the roof, floor, slab, or wall surface reference is underground. |
...
|  | [MassLevelDataId](c5c4242f-c490-ad24-dfdc-cdad552f728a.md) | The MassLevelData used when the surface is horizontal, planar, and at the same height as a MassLevelData related to the same mass as the referenced face. |
|  | [MaterialId](e5373a1f-b213-7f42-8efc-74347a9b3732.md) | The visualization material used for the surface for displaying the energy analytical model. |
|  | [MaterialType](9218731b-4b3b-012d-3db5-a474d01e513d.md) | material type of mass zone |
...
|  | [PercentageGlazing](c6d03198-1d30-f0d8-e2b9-d4b94128b984.md) | The target percentage of the reference wall surface that is to be covered with automatically generated windows. Revit will use this number when determining the size, shape, and location of automatically generated windows. |
|  | [PercentageSkylights](789c7354-a904-227b-2135-95fcce25c476.md) | The target percentage of the reference roof surface that is to be covered with automatically generated skylights. Revit will use this number when determining the size, shape, and location of automatically generated skylights. |
...
|  | [ReferenceElementId](771ae7d7-0977-660c-1881-6fba10dd6a1f.md) | The ElementId of the element whose face the MassSurfaceData primarily refers to. |
|  | [ShadeDepth](ba4db97e-3d36-b436-cf0b-69cb93013f67.md) | How far any auto-generated shades should extend from the wall surface. |
|  | [SillHeight](03f384b6-7a50-15c9-aed0-ab39d18c6b52.md) | The height above the level where the bottoms of auto-generated windows will be located. |
|  | [SkylightWidth](4856cafe-222b-44c4-e88a-2c3494e1898b.md) | The length dimension to be used for the sides of each individual square skylight produced in the grid of auto-generated skylights. |
|  | [SurfaceDataSource](2f9126ea-17e4-c221-40f8-e430dfae5262.md) | Indicates whether the MassSurfaceData properties are driven by the EnergyDataSettings of the Document or are overridden for the surface. |
...
|  | [GetFaceReferences](a7afead8-f134-96b4-daf6-e2ceee81f3e5.md) | Gets References to the faces that the MassSurfaceData provides properties for. |
