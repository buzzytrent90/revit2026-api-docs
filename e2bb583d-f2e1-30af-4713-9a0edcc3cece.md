...
# ViewScheduleIsValidCategoryForMaterialTakeoff Method  
...
```
```vb
Public Shared Function IsValidCategoryForMaterialTakeoff ( 
...
```
```fsharp
static member IsValidCategoryForMaterialTakeoff : 
