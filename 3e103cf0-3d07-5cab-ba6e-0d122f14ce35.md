...
# BuiltInFailuresTagFailuresCannotCopyTag Property  
...
```
```vb
Public Shared ReadOnly Property CannotCopyTag As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ CannotCopyTag {
	FailureDefinitionId^ get ();
}
```
```fsharp
static member CannotCopyTag : FailureDefinitionId with get
```
