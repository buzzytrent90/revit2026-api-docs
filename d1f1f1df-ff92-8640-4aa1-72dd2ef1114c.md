...
# DuctSettingsRoundDuctSizePrefix Property  
...
```csharp
public string RoundDuctSizePrefix { get; set; }
```
```vb
Public Property RoundDuctSizePrefix As String
	Get
	Set
```
```cpp
public:
property String^ RoundDuctSizePrefix {
	String^ get ();
	void set (String^ value);
}
```
```fsharp
member RoundDuctSizePrefix : string with get, set
```
