...
```
```vb
Public Class StructuralSectionConcreteRectangle
...
```
```fsharp
type StructuralSectionConcreteRectangle = 
    class
...
The StructuralSectionConcreteRectangle type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionConcreteRectangle](2f2cb5ed-dd20-5d25-2aa4-d86feb48002b.md) | Creates a new instance of Structural Section Concrete Rectangle shape with the associated set of parameters, used to attach to structural element. |
