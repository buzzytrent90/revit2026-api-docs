...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisEnergyAnalysisZone
...
```csharp
public class EnergyAnalysisZone : Element
```
```vb
Public Class EnergyAnalysisZone
	Inherits Element
```
```cpp
public ref class EnergyAnalysisZone : public Element
```
```fsharp
type EnergyAnalysisZone = 
    class
        inherit Element
    end
```
...
The EnergyAnalysisZone type exposes the following members.
