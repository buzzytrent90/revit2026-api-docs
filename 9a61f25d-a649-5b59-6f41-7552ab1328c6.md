...
SystemObject [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSection](65b59d7d-bd7b-c71b-7159-dfc506a912ee.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionRectangular](fc038108-6279-839c-285b-effe342b4491.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionGeneralH](512d0768-c2d3-f601-fd3e-c1db53d68f27.md) Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionRectangleHSS
...
```
```vb
Public Class StructuralSectionRectangleHSS
...
```
```fsharp
type StructuralSectionRectangleHSS = 
    class
        inherit StructuralSectionGeneralH
    end
```


The StructuralSectionRectangleHSS type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionRectangleHSS](f32bc888-da37-c5a7-71e4-0838f0d46393.md) | Creates a new instance of Structural Section Rectangle HSS shape with the associated set of parameters, used to attach to structural element. |
