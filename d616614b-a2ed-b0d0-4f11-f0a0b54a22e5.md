...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBSunAndShadowSettings
...
|  | Name | Description |
| --- | --- | --- |
|  | [ActiveFrame](dbf75176-4862-b20f-81e2-e948934a193e.md) | Identifies the active animation frame for a single-day or multi-day study, starting at 1.0 for the first frame and incrementing in intervals of 1.0. |
|  | [ActiveFrameTime](b675e63b-2f7e-75d8-7843-069dbf933195.md) | Identifies the date and time of the SunAndShadowSettings element for the active frame. |
|  | [Altitude](7dac428d-6e9e-dd74-afcd-9fb86f863054.md) | Altitude setting (angle in radians). This is only relevant when dealing with a SunAndShadowSettings element that uses lighting mode. |
...
|  | [Azimuth](e4908ede-9cb1-a604-1a3c-443d39709eb0.md) | Azimuth setting (angle in radians). This is only relevant when dealing with a SunAndShadowSettings element that uses lighting mode. |
...
|  | [EndDateAndTime](dff3f509-3f12-5323-6bb9-5d4e2b195800.md) | Identifies the end date and time. |
...
|  | [GroundPlaneHeight](4ba357f9-5fe6-e9fd-39d3-9d1e6b256884.md) | Identifies the ground plane height. |
|  | [GroundPlaneLevelId](cb9cf987-a64c-e1cb-7d85-f4374eb953e9.md) | Identifies the element id of the Ground Plane level for the SunAndShadowSettings element. |
...
|  | [Latitude](895a7159-b8b0-cdae-47d9-8b88e95332d0.md) | Identifies the current latitude used by the SunAndShadowSettings element. |
...
|  | [Longitude](7c6ce169-ddda-00f3-9560-ef719bec0a2a.md) | Identifies the current longitude used by the SunAndShadowSettings element. |
...
|  | [NumberOfFrames](5c820dcf-f2dc-5d96-edc7-31c0ce7b94f9.md) | Identifies the total number of animation frames for a single-day or multi-day study. |
...
|  | [ProjectLocationId](f57ae482-95dd-3398-6997-97199c5bad20.md) | Identifies the ProjectLocation element used by the SunAndShadowSettings element. |
|  | [ProjectLocationName](dabc3f88-77ac-aec9-01e4-3219d37f362a.md) | Identifies the name of the project location used by the SunAndShadowSettings element. |
|  | [RelativeToView](696386a4-6e66-3d6a-a55d-3873d0f66966.md) | Identifies whether the SunAndShadowSettings element is relative to the view direction. This is only relevant for lighting mode. |
|  | [SharesSettings](8cfd7bb8-754b-e1ee-4eb9-c43f9acdd65b.md) | Identifies whether settings are shared globally. |
|  | [StartDateAndTime](e50880d2-cab4-3cb5-56c8-6a7faaa0725b.md) | Identifies the start or current date and time. |
|  | [SunAndShadowType](0ea43c30-7953-b56e-9091-0e4524154b5e.md) | Identifies the type of the SunAndShadowSettings element. |
|  | [SunriseToSunset](72802bd9-8241-b14d-97f3-c915861485a2.md) | Identifies whether the current single day sun study is set to run from sunrise to sunset. |
|  | [TimeInterval](6c98d4af-72bc-07dc-1920-ff9909f0486a.md) | Identifies the time interval between animation frames. |
|  | [TimeZone](aa185d98-d4a2-58f5-0a45-8e8eac070f5a.md) | Identifies the time zone. |
...
|  | [UsesDST](34284848-ddf6-1fda-d1d2-43f8c2e2ad78.md) | Identifies whether the SunAndShadowSettings element is using daylight savings time. |
|  | [UsesGroundPlane](9e3de085-3afd-e61a-d0e6-87659e6e1997.md) | Identifies whether the SunAndShadowSettings element uses a ground plane. |
...
|  | [Visible](453465ac-2b3a-b6a1-ce46-5c860da3b6a3.md) | Visibility in current view for a per-view SunAndShadowSettings element. |
...
|  | [CalculateTimeZone](2206c828-d85c-d54b-73f1-471e67a3ce36.md) | Use Revit's utilities to calculate the time zone for a given longitude and latitude. |
...
|  | [FitToModel](b9de8188-ffe3-407c-102e-850e92977a32.md) | Adjust SunAndShadowSettings to fit around the current model geometry. |
|  | [GetActiveSunAndShadowSettings](172fb455-c62c-7baf-6d11-a458a1c9b725.md) | Returns the current SunAndShadowSettings element assigned to the active view for the supplied document. |
...
|  | [GetFrameAltitude](6150a802-4969-342a-4b5b-0bc7834f0fa0.md) | Identifies the altitude of the sun (angle in radians) for a specific frame. |
|  | [GetFrameAzimuth](e0eea2bf-5dd0-4337-46c1-fb9755c47457.md) | Identifies the azimuth of the sun (angle in radians) for a specific frame. |
|  | [GetFrameTime](59465c30-c6a5-d5a7-0d40-0c05ea64b60d.md) | Identifies the date and time of the SunAndShadowSettings element for a given frame. |
...
|  | [GetMatchingPreset](fb84ce23-7f06-bac4-aec4-d63890b10597.md) | Finds the name of the 'per-document' SunAndShadowSettings that matches the properties of this per-view element. |
...
|  | [GetSunrise](5ed2edef-f53c-0fcb-010d-f4a33d685fba.md) | Identifies the sunrise time for the SunAndShadowSettings element at its current location and indicated date. |
|  | [GetSunset](a8f1a800-1d06-b994-09f7-fc94474416b0.md) | Identifies the sunset time for the SunAndShadowSettings element at its current location and indicated date. |
...
|  | [IsAfterStartDateAndTime](7ab7d45b-eea2-5559-d003-74cd29aa6955.md) | Checks whether the end date and time is valid. |
|  | [IsBeforeEndDateAndTime](e67696b5-0ad9-42f6-c58c-ae65f71c8754.md) | Checks whether the start date and time is valid. |
...
|  | [IsFrameValid](998481b3-00fe-dbe9-1152-10466d565753.md) | Checks whether the frame is valid for the supplied SunAndShadowSettings. |
|  | [IsGroundPlaneLevelValid](55c05757-98af-05dd-24c3-9793d595af51.md) | Checks whether the element represents a valid Ground Plane level. |
...
|  | [IsTimeIntervalValid](74661a1d-f8c1-1929-cb22-e8407ca1e1bc.md) | Checks whether the time interval is valid for the SunAndShadowType. |
