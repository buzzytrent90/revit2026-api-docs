...
# CeramicCeramicBumpAmount Property  
...
```csharp
public static string CeramicBumpAmount { get; }
```
```vb
Public Shared ReadOnly Property CeramicBumpAmount As String
	Get
```
```cpp
public:
static property String^ CeramicBumpAmount {
	String^ get ();
}
```
```fsharp
static member CeramicBumpAmount : string with get
```
