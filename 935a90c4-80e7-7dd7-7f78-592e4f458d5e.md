...
scheduleCategoryId [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
...
[ViewSchedule](0dae24ba-5dcb-9a34-cccc-0cf8cc52bcd3.md) A new single-category schedule assembly view. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | assemblyInstanceId is not an AssemblyInstance. -or- scheduleCategoryId is not a valid category for a regular schedule. -or- viewTemplateId is not a correct view template for the schedule view. |
