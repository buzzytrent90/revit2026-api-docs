...
# IExternalResourceServerGetResourceVersionStatus Method  
...
reference [ExternalResourceReference](ffad9c15-8fc9-fbfd-f328-101533f4cf74.md)
     The ExternalResourceReference to check. 

#### Return Value

[ResourceVersionStatus](d9fae98e-e39a-9b69-07b9-b77cb777800c.md) An enum indicating whether the resource is current, out of date, or of unknown status. 
