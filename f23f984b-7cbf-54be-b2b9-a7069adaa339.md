...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBMultipleValuesIndicationSettings
...
```
```vb
Public Class MultipleValuesIndicationSettings
	Inherits Element
```
```cpp
...
```
```fsharp
type MultipleValuesIndicationSettings = 
    class
        inherit Element
    end
```
...
The MultipleValuesIndicationSettings type exposes the following members.
...
|  | [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.md) | If true, [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.md) is used as multiple values indication, otherwise a hardcoded standard value. |
|  | [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.md) | Value used as multiple values indication if [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.md) is set to true. |
...
|  | [Value](c2d9f859-179c-ee21-4bed-4480d4112e06.md) | Value to be used as multiple values indication in the document. If [Custom](5bae32ca-edb3-80b4-e809-50cb7e0e720d.md) is true, returns [CustomValue](c1d337d1-c676-cdd5-0945-bb60c0b1d2ee.md), otherwise returns a hardcoded standard value. |
...
|  | [GetMultipleValuesIndicationSettings](9f006777-7f5e-4bac-a7c9-ce951c0184ac.md) | Returns the MultipleValuesIndicationSettings element for a given document. |
