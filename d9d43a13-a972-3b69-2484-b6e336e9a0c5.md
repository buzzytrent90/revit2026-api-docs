...
# IndependentTagTagOrientation Property  
...
[TagOrientation](0f1faf70-46a4-71a1-63c0-3425dfc691a0.md) for the supported orientations. Tags from types that have rotate with component turned on ignore the TagOrientation property. Tags that are not in tag mode ignores the TagOrientation property. 
