...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.PlumbingPipeSettings
...
The PipeSettings type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AnalysisForClosedLoopHydronicPipingNetworks](c8df4a55-893f-aeed-d388-51c923ff0c07.md) | Indicates whether to enable analysis for closed loop hydronic piping networks. |
...
|  | [Centerline](c1bb6ed5-c673-eb76-df28-c0d430272cb2.md) | The abbreviation of the Centerline (=) string. |
|  | [ConnectorSeparator](360f9362-1069-16bd-2587-86ad8a3bbf24.md) | The connector separator string. |
|  | [ConnectorTolerance](d0cf1441-bb4e-dcdd-304d-e8a1c0d0d0c9.md) | The connector tolerance value. |
...
|  | [FittingAngleUsage](846e530e-49de-308b-fd72-c3414b3e5257.md) | Determine how to use fitting angle during pipe layout or modifying layout. |
|  | [FittingAnnotationSize](6b0c6492-4c82-ce34-4f0f-544a0b3f65f1.md) | The value of fitting annotation size. |
|  | [FlatOnBottom](8ec7fb54-c9bf-542b-3335-ce20bc11caf7.md) | The abbreviation of the Flat On Bottom (FOB) string. |
|  | [FlatOnTop](8d175d9d-119e-410b-065b-94202c25ecb3.md) | The abbreviation of the Flat On Top (FOT) string. |
...
|  | [SetDown](ae3bff2f-151e-9924-cd83-0ef3f3411e54.md) | The abbreviation of the Set Down (SD) string. |
|  | [SetDownFromBottom](453be523-ae50-a6e2-cc66-5303d87a211f.md) | The abbreviation of the Set Down from bottom of fitting (SDB) string. |
|  | [SetUp](5406391e-2f9e-dcf3-76f2-47c99ffb1701.md) | The abbreviation of the Set Up (SU) string. |
|  | [SetUpFromBottom](29ddd25b-8e8e-9c3e-6828-417dec598e58.md) | The abbreviation of the Set Up from bottom of fitting(SUB) string. |
|  | [SizePrefix](24468d2e-1e90-8be7-07ca-b055788a19ea.md) | The size prefix string. |
|  | [SizeSuffix](49eb536d-ce5e-5484-8311-7d8c13947b2d.md) | The size suffix string. |
...
|  | [UseAnnotationScaleForSingleLineFittings](803e4b6a-85a0-fee5-830a-231cb89826b6.md) | Indicates whether use annotation scale for single line fittings or not. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddPipeSlope](8ae86cd1-edbe-be80-e8bc-eb7cbbb573d5.md) | Add a pipe slope value. |
...
|  | [GetFlowConvertionServerInfo](9ab99425-32ed-3b7b-2353-2d76cc364468.md) | Get the MEPServerInfo of the current plumbing flow convertion server. |
...
|  | [GetPipeSettings](58e77947-e8ba-935c-d732-95c585dcc6cd.md) | Get the pipe settings of the project. |
|  | [GetPipeSlopes](fc405942-f9f1-36b7-b29f-eda46e433e1d.md) | Get pipe slopes. |
|  | [GetSpecificFittingAngles](be4b50bb-22ce-550e-babf-573de87a344e.md) | Gets the list of specific fitting angles. |
|  | [GetSpecificFittingAngleStatus](251d69ee-91fa-38fe-3868-35b82f1866de.md) | Gets the status of given specific angle. |
...
|  | [IsAnalysisForClosedLoopHydronicPipingNetworksEnabled](13190276-346c-eeac-fcba-3c749092cf7f.md) | Indicates whether analysis for closed loop hydronic piping networks is enabled in the specified document. |
...
|  | [IsValidSpecificFittingAngle](ca0d771a-33e9-f073-083b-098d4d74e924.md) | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
|  | [SetFlowConvertionServerInfo](4abe0a72-4d41-3d95-3e5e-aeb7a3d8f639.md) | Set the MEPServerInfo of the current plumbing flow convertion server. |
|  | [SetPipeSlopes](7d44bf12-8f5d-731c-9e72-8ae76cae8be3.md) |  |
|  | [SetSpecificFittingAngleStatus](fe684616-5a84-6984-d731-b9efe21367ed.md) | Sets the status of given specific angle. |
