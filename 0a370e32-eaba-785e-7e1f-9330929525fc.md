...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.StructureRebarShape
...
|  | [HigherEnd](e3c2b8f8-5d6b-3bf8-0e9d-68848f2a78fd.md) | Defines the higher end of rebar shape. |
...
|  | [RebarStyle](ec72e836-ea5a-8d74-40f0-55344ae095bd.md) | Whether the shape represents a standard bar or a stirrup. |
|  | [ShapeFamilyId](60b519a8-b0cd-f078-559b-d35b7ab88b1c.md) | Get and return the rebar shape family id. |
|  | [SimpleArc](7c63c3f5-bac9-9d24-90fd-8dbc03a6df4f.md) | Check whether this shape consists of a single arc, possibly with hooks. |
|  | [SimpleLine](462b2fbb-597c-c17b-dc80-0ff74c690b83.md) | Check whether this shape consists of a single straight segment, possibly with hooks. |
|  | [StirrupTieAttachment](5e8deedb-9319-b087-a573-03c9ad996f2c.md) | The attachment type of stirrup ties and rebars. |
...
|  | [GetAllowed](20f58bef-6bf7-63c6-d50d-61eb1d74ee4d.md) | Check whether a bar type can be used with this RebarShape. Bar types are allowed by default. |
|  | [GetCurvesForBrowser](d07fdab5-5af9-a9e6-3840-d3a4b52d6979.md) | Generate curves for the shape, as used in the shape browser. |
|  | [GetDefaultHookAngle](89fe9654-9f1c-6ba8-d87c-1b38b63feb31.md) | **Obsolete.** Get the hook angle, expressed as an integral number of degrees (common values are 0, 90, 135, and 180). |
|  | [GetDefaultHookOrientation](2a97de53-42d6-cf64-f998-73ad9b79fcf0.md) | **Obsolete.** Gets the termination's orientation. The orientation it's the same for both hook and crank. |
...
|  | [GetEndTreatmentTypeId](d78defed-af7e-8feb-6e71-2c067fcc3397.md) | **Obsolete.** Gets the id of the EndTreatmentType at the specified rebar shape end. |
...
|  | [GetHookRotationAngle](76a3c46d-031e-37c6-d8c2-3342a60d8bc5.md) | **Obsolete.** Gets the termination's (e.g hook, crank) out of plane rotation angle at the specified end. The angle is used for both hook and crank. |
...
|  | [GetMultiplanarDefinition](9366f4cf-b2aa-3fd1-bdc0-984caeda0aaa.md) | The optional 3D structure of the shape. |
...
|  | [GetRebarShapeDefinition](80019bb8-76a4-f6e1-476d-2f9992286adb.md) | Return the definition of the RebarShape. |
...
|  | [GetTerminationsData](3530f767-ccd7-7ab3-b9a3-845651926449.md) | Gets the terminations (e.g. hook, crank) data. |
...
|  | [HasEndTreatment](488b6145-c8b9-a18a-93d0-0b6449df7f52.md) | Identifies if the rebar shape has end treatment at at least one end. |
...
|  | [IsSameShapeIgnoringHooks](5815937c-ac80-2f85-ff5a-4e728336251e.md) | **Obsolete.** Test whether two shapes have equivalent definitions by comparing the RebarShapeDefinition and MultiplanarDefinition properties. |
|  | [IsSameShapeIgnoringTerminations](5db9cdfe-9e7d-b6f5-9a81-563602eb45d6.md) | Test whether two shapes have equivalent definitions by comparing the RebarShapeDefinition and MultiplanarDefinition properties. |
...
|  | [RebarShapeMatchesCurvesAndTerminationsData](3902cca7-5188-bfb2-6e25-859a8833fb22.md) |  |
...
|  | [SetAllowed](5779735a-5105-127d-eaae-31fb0f2b81e4.md) | Specify which bar types can be used with this RebarShape. Bar types are allowed by default. |
|  | [SetEndTreatmentTypeId](f7c875ee-c66f-e08b-78e2-ad40b0d83ea4.md) | **Obsolete.** Sets the EndTreatmentType id at the specified rebar shape end. |
...
|  | [SetHookRotationAngle](b30a6f55-b672-e942-7c1f-ab3d9b27dd4e.md) | **Obsolete.** Sets the termination's (e.g hook, crank) out of plane rotation angle at the specified end. The angle will be used for both hook and crank. |
