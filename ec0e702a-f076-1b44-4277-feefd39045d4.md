...
SystemObject SystemException [Autodesk.Revit.ExceptionsApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) [Autodesk.Revit.ExceptionsRevitServerException](cb9f496c-f65b-7d27-0fe4-e42f80261b38.md) Autodesk.Revit.ExceptionsRevitServerModelNameBreaksConventionException
...
```vb
<SerializableAttribute>
Public Class RevitServerModelNameBreaksConventionException
...
```fsharp
[<SerializableAttribute>]
type RevitServerModelNameBreaksConventionException = 
    class
...
The RevitServerModelNameBreaksConventionException type exposes the following members.
