...
The [IPipePressureDropServer](5f6479aa-4e07-560d-f505-16d44cdd795c.md) type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Calculate](8af1cf1a-1cc0-8fcd-7845-f7ac2a653425.md) | Calculate the pipe pressure drop. |
...
|  | [GetHtmlDescription](10c0425e-04e8-a43c-30ea-b367deb71862.md) | The method that Revit will invoke to get an HTML formatted description of the server. |
|  | [GetInformationLink](8cbc4b35-bd71-3172-c993-8f3eb8b22f66.md) | The method that Revit will invoke to obtain a URL address which provides more information about the server. |
