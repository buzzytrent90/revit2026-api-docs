...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) [Autodesk.Revit.DBCeilingAndFloor](2132815c-5748-a477-a626-fc29139d3518.md) Autodesk.Revit.DBToposolid
...
The Toposolid type exposes the following members.
...
|  | [HostTopoId](d16ba5b3-da97-b262-3dc8-5de0a9816f74.md) | The host Toposolid id of the current Toposolid subdivision. If the object is not a Toposolid subdivision, hostTopoId will be InvalidElementId. |
...
|  | [SketchId](e2fc2a37-4ad1-a77f-9454-a7ccd6ea6e9d.md) | Returns id of the sketch. |
...
|  | [CanBeExcavatedBy](ed8909b2-a302-158b-0eae-05de0c05a40c.md) | Checks if the given element can be used to excavate the Toposolid. |
...
|  | [Create(Document, IListCurveLoop, ElementId, ElementId)](35fc44fe-c86f-6963-c2b2-e6290288c748.md) |  |
|  | [Create(Document, IListXYZ, ElementId, ElementId)](fb528545-b035-bfe2-71da-88baa9a979ff.md) |  |
|  | [Create(Document, IListCurveLoop, IListXYZ, ElementId, ElementId)](0d4cd6ef-eadd-ace6-2999-2270c1317fb1.md) |  |
|  | [CreateFromTopographySurface](662a7ccb-63b9-a106-1b3e-659af6a35c70.md) | Creates a Toposolid element from a host TopographySurface, and Toposolid sub-divisions from its subregions. |
|  | [CreateSubDivision(Document, IListCurveLoop)](6120f56d-5fa1-5682-587f-7e790b73f43a.md) |  |
|  | [CreateSubDivision(Document, ElementId, IListCurveLoop)](6b4bcf67-0432-9549-dafb-464f8ca07eec.md) |  |
...
|  | [ExcavateBy](00ff5e57-e904-3779-31d2-25f3ea4ea64b.md) | Excavates the Toposolid by a given element. |
...
|  | [GetIntersectingElementData](e9c2d73c-4672-8f85-43c5-29d780b82183.md) | Gets intersection data of all intersecting elements. |
...
|  | [GetSlabShapeEditor](4b7c441c-9f4f-4756-14bc-5fc387043c3e.md) | Gets a SlabShapeEditor that can be used to add or modify points of this Toposolid. |
|  | [GetSubDivisionIds](0a8cf5c3-61c8-b255-06e7-bb42a9097788.md) | Gets all element ids of Toposolid subdivisions with the current Toposolid as its host. |
...
|  | [IsCutVoidStabilityEnabled](edae798c-d914-2d4c-12d5-96cce8f06290.md) | Identifies if the setting for stability of Boolean operations for Toposolid elements is enabled or disabled. |
...
|  | [IsSmoothedSurfaceEnabled](96dbefd0-7927-7a7e-dd50-536eb6c56e88.md) | Gets smoothed surface setting of Toposolid. |
...
|  | [RemoveExcavationBy](2366a1f0-2898-e99a-c1f1-2f0e4454477f.md) | Removes the excavation between the given element and the Toposolid. |
|  | [SetCutVoidStability](761c4843-5b80-e13f-cd0d-410f6aa4f621.md) | Enables or disables the setting for stability of Boolean operations for Toposolid elements. |
...
|  | [SetSmoothedSurface](a565b8eb-196a-415d-3826-81b58d1e4018.md) | Sets smoothed surface setting of Toposolid. |
|  | [Simplify](dabded04-9e0a-e675-b90e-8b9b0ae7e479.md) | Simplifies the Toposolid by reducing the number of inner vertices to the given percentage. |
|  | [Split](a7760dc6-515d-6ac2-6164-d0581c7d6dee.md) |  |
