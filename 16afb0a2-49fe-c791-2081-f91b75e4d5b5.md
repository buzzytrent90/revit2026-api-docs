...
# StructuralAssetWoodPerpendicularCompressionStrength Property  
...
```
```vb
Public Property WoodPerpendicularCompressionStrength As Double
	Get
	Set
```
```cpp
public:
property double WoodPerpendicularCompressionStrength {
	double get ();
...
| Exception | Condition |
| --- | --- |
| [InapplicableDataException](dc1a6d15-8923-a1fe-722a-4e976634a519.md) | When setting this property: the material type must be wood to set this property. |
