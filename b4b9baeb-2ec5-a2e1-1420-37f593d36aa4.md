...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBReferencePoint
...
|  | [CoordinatePlaneVisibility](bf3a953f-f4e0-8413-99ca-48f8b8440002.md) | Visibility settings for the coordinate reference planes. |
...
|  | [Name](ce62ef45-46cc-6fe7-ffcc-1578c16f8d6b.md) | (Overrides [ElementName](e372092e-ff47-71c2-1272-50ab08e5a41d.md)) |
...
|  | [Position](4f540b05-f562-8a72-37ef-834d45cea027.md) | The position of the ReferencePoint. |
|  | [ShowNormalReferencePlaneOnly](8a713d3d-c2ac-3b64-3cf9-574a08bcbb64.md) | Whether all three coordinate planes are shown, or only the normal (XY) plane. |
...
|  | [Visible](f0617f4c-2184-3bfe-e4f7-644abc06071b.md) | Whether the point is visible when the family is loaded into a project. |
...
|  | [GetCoordinatePlaneReferenceXY](d32ec824-4333-7f68-2b38-83cd1aacb732.md) | A reference for the XY plane of the coordinate system. |
|  | [GetCoordinatePlaneReferenceXZ](05a63882-e91c-fb83-e9d5-151459f0e1c3.md) | A reference for the XZ plane of the coordinate system. |
|  | [GetCoordinatePlaneReferenceYZ](b1644ffd-1afe-9c08-9add-562747356733.md) | A reference for the YZ plane of the coordinate system. |
|  | [GetCoordinateSystem](809b7a59-5911-a62d-4144-3e0d498d81a0.md) | The position and orientation of the ReferencePoint. |
...
|  | [GetHubId](1f0de8b1-04fa-3513-a139-079cbb14853f.md) | Id of associated Hub. |
|  | [GetInterpolatingCurves](1b1517e8-b244-e249-9f01-e6137b40c886.md) | The set of CurveByPoints elements that interpolate a ReferencePoint. |
...
|  | [GetPointElementReference](9baba8f4-1cf5-3349-a6b5-5fc8a69ba761.md) | Retrieve a copy of the rule that computes the location of the ReferencePoint relative to other elements in the document. |
...
|  | [GetVisibility](61c9a859-14a2-1e9e-455c-efa77220a149.md) | Gets the visibility for the point. |
...
|  | [SetCoordinateSystem](1531d27f-9b12-57d7-533e-eda4daf99adb.md) | The position and orientation of the ReferencePoint. |
...
|  | [SetPointElementReference](2fe8dd3a-06f6-42f0-52c6-49e83c2c28f2.md) | Change the rule for computing the location of the ReferencePoint relative to other elements in the document. |
|  | [SetVisibility](6a4ba016-bc5e-8511-4990-c588a9311a6d.md) | Sets the visibility for the point. |
