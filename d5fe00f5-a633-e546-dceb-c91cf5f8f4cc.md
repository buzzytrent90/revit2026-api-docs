...
The [DisplacementElement](08113547-eaaa-5ec1-5ff1-de609fe7c29c.md) type exposes the following members.
...
|  | [CanCategoryBeDisplaced](cdab956b-de93-bf5a-1698-5d5746447934.md) | Indicates whether elements of the specified category are eligible as displaced elements. |
...
|  | [CanElementsBeAddedToDisplacementSet](45d2fc58-535b-2b9b-2bf5-ccefd5f93123.md) |  |
...
|  | [Create](891b2088-81e0-aa88-5e8b-3ffacc3d35a3.md) |  |
...
|  | [GetAbsoluteDisplacement](0debfbc3-451e-a43a-a1dd-99a25b35da25.md) | The absolute displacement applied to the displaced elements. |
|  | [GetAdditionalElementsToDisplace](97d02f11-7308-579c-031a-5102dc40ae4f.md) | Identify a set of elements that potentially should be displaced along with a given element. |
|  | [GetChildren](d7e84ab1-d970-b926-eea8-00032962431a.md) | Returns a set of DisplacementElements which have this DisplacementElement as a parent. |
...
|  | [GetDisplacedElementIds](653f228c-8b72-aa94-4ab0-131d1f1b322f.md) | The ids of the elements affected by this DisplacementElement. |
|  | [GetDisplacedElementIds(View)](e77c4376-b546-9939-53d8-af17afa16bd9.md) | Returns the element ids of all displaced elements in the specified view. |
|  | [GetDisplacedElementIdsFromAllChildren](63740fb6-7911-9756-e4e1-c1377083216b.md) | The element ids of elements displaced by this DisplacementElement and any DisplacementElement which declare this one as parent. |
|  | [GetDisplacementElementId](c4790d71-c7a4-b298-8428-035de9981392.md) | The element id of the DisplacementElement that includes the specified element. |
|  | [GetDisplacementElementIds](a8f8e350-c1c1-c3f7-ff73-660388b40098.md) | The element ids of all DisplacementElements owned by the specified view. |
...
|  | [GetRelativeDisplacement](a2e39847-b4bb-1d58-91e1-cbc16c89b638.md) | The relative displacement applied to the displaced elements by this DisplacementElement. |
...
|  | [IsAllowedAsDisplacedElement](4b243f84-5a2c-48de-2e6c-b9b9e3e4ab11.md) | Indicates if the specified element is allowed to be displaced. |
...
|  | [IsElementDisplacedInView](54e4ac85-61ee-0701-c682-3240bf640983.md) | Indicates if the specified element displaced in the specified View. |
...
|  | [IsNotEmpty](e8e91140-0a9e-fac8-ab7a-3de5fd57bf0a.md) |  |
...
|  | [IsValidAsParentInView](d9da79d4-c559-96ec-a4cf-c2778221121c.md) | Indicates whether the specified DisplacementElement can be used as a parent when creating a DisplacementElement in the specified view. |
...
|  | [RemoveDisplacedElement](a5d36a3a-e62a-ff86-bb7e-2572bef749f0.md) | Remove a displaced element from this DisplacementElement. |
|  | [ResetDisplacedElements](47cc710d-262c-066f-84c9-a47b43183b0a.md) | Sets the translation of the DisplacementElement to (0, 0, 0). The DisplacementElement continues to exist, but its elements are displayed in their actual location. |
|  | [SetDisplacedElementIds](e1071a6a-2856-6672-4e7d-8a60bb6fdbd7.md) |  |
...
|  | [SetRelativeDisplacement](8f1c4d35-4642-25de-7509-8f7917267186.md) | Sets the relative displacement applied to the displaced elements by this DisplacementElement. |
