...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBNestedFamilyTypeReference
...
```
```fsharp
type NestedFamilyTypeReference = 
    class
        inherit Element
    end
```
...
The NestedFamilyTypeReference type exposes the following members.
...
|  | [CategoryId](18d2498d-d503-58c1-6c22-ac25cedf32e0.md) | Category Id of the referenced family |
...
|  | [FamilyName](6a7374ea-c6ff-6f53-f5ee-a72ada1bf6a6.md) | Name of the referenced family |
...
|  | [TypeName](76e74eb3-5217-5f99-f781-ef29996eea85.md) | Type of the referenced family |
