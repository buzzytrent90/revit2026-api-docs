...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.StructureLoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md) Autodesk.Revit.DB.StructureAreaLoad
...
The AreaLoad type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Area](f5c2ce0d-e793-05b0-0f0c-2f24c1a13756.md) | Returns area of the area load. |
...
|  | [ForceVector1](2fa5cdff-3d4c-a479-fbc6-f2bae9c06884.md) | The force vector applied to the 1st reference point of the area load, oriented according to OrientTo setting. |
|  | [ForceVector2](c5f25cdc-7120-6e86-b0ec-70cc4ffec360.md) | The force vector applied to the 2nd reference point of the area load, oriented according to OrientTo setting. |
|  | [ForceVector3](000a344f-d68f-8718-c6e5-72edef5ce04c.md) | The force vector applied to the 3rd reference point of the area load, oriented according to OrientTo setting. |
...
|  | [IsProjected](56b7d8d9-6d4f-0d27-2395-e3991b69a29a.md) | Indicates if the load is projected. |
...
|  | [NumRefPoints](8f5aea83-d302-f0a0-5e8a-57141b0f6549.md) | Returns the total number of reference points for the area load. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AreCurveLoopsValid](dcecb068-30b8-215c-98ea-eb873cf1d513.md) |  |
...
|  | [GetLoops](6d423e73-bd6a-aaa7-7818-84297f2a6e1b.md) | Returns curve loops that define geometry of the area load. |
...
|  | [GetRefPoint](3bd2e404-2705-ad16-42c3-42c808890bb4.md) | Returns the physical location of the reference point. |
...
|  | [IsCurveLoopsInsideHostBoundaries](56f7aaed-c85f-b5ae-07ca-a49eae4efb94.md) |  |
...
|  | [IsValidHostId](25e62c90-a5b5-09d5-9c49-03058e5e51b0.md) | Indicates if the provided host id can host area loads The document containing both the host and the load The id of the analytical element that is about to host an area load True if an area load can be placed on the input host id |
...
|  | [SetLoops](264cfd98-5af1-1019-5055-e14816eae450.md) |  |
