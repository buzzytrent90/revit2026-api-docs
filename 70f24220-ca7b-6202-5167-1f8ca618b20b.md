...
# ViewScheduleGetDefaultParameterNameForKeySchedule Method  
...
```
```vb
Public Shared Function GetDefaultParameterNameForKeySchedule ( 
...
```
```fsharp
static member GetDefaultParameterNameForKeySchedule : 
        document : Document * 
...
String The default parameter name. 
