...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBExportDGNSettings
...
The ExportDGNSettings type exposes the following members.
...
|  | [FindByName](ca567957-39e9-3750-b515-c91bf67186d6.md) | Returns the pre-defined non-in-session exporting settings for DGN in the given document with the specified name. |
|  | [GetActivePredefinedSettings](36729722-5758-bb63-2645-8cadd3981b75.md) | Returns the active pre-defined non-in-session exporting settings for DGN in the given document. |
...
|  | [GetDGNExportOptions](bdbe8341-e660-3e86-0cb5-03bfac3927f7.md) | Gets the options stored in the these settings. |
...
|  | [ListNames](1a7d76ec-3042-cb83-cb8f-8c521398c843.md) | Returns a list of names of dgn export settings. |
...
|  | [SetDGNExportOptions](afc5d70c-308f-7289-8391-eaaeb116ea86.md) | Sets the options stored in these settings. |
