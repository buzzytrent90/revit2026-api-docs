...
# ParameterFilterRuleFactoryCreateEqualsRule(ElementId, Double, Double) Method  
...
```
```vb
Public Shared Function CreateEqualsRule ( 
...
```cpp
public:
static FilterRule^ CreateEqualsRule(
	ElementId^ parameter, 
	double value, 
	double epsilon
)
```
```fsharp
static member CreateEqualsRule : 
        parameter : ElementId * 
        value : float * 
...
[CreateEqualsRule Overload](0637b53b-96aa-7683-6535-8a1217c5809e.md)
