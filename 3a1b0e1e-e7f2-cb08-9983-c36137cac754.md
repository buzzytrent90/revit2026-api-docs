...
ICollection[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The set of elements that are joined to the given element. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | document is not a project document. -or- The element element was not found in the given document. |
