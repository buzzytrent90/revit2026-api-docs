...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | NullOrEmpty -or- Contains invalid characters. -or- The input options were not valid. Check the exception message for specific details. |
...
| [OperationCanceledException](aea34480-ceb5-b49f-129d-0799e7bb1c21.md) | The export operation is cancelled in event handler. |
| [OptionalFunctionalityNotAvailableException](0612a676-b6ba-8c37-2e28-b197438305ab.md) | A Navisworks Exporter is not available in the installed Revit. |
