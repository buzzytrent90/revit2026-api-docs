...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | This option is only available for realistic bending detail elements. -or- The given value for rotation is not a number -or- The given value for rotation is not finite |
