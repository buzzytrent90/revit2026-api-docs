...
# CurveIntersectResultGetOverlaps Method  
...
IList[CurveOverlapPoint](a81ce2d6-5a82-3d0a-6788-3e589ca290a2.md) The list of CurveOverLapPoints corresponding to points of intersection and/or intervals of overlap for the two curves. 

| Exception | Condition |
| --- | --- |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This CurveIntersectResult only contains simple output. Use CurveIntersectResultOption::Detailed to compute detailed output. |
