...
| Exception | Condition |
| --- | --- |
| [RegenerationFailedException](787bb389-74c2-5ce7-cdd6-32211209ded2.md) | Thrown when the operation fails. |
...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Modification of the document is forbidden. Typically, this is because there is no open transaction; consult documentation for Document.IsModified for other possible causes. |
