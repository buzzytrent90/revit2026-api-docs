...
# BuiltInFailuresStairRampFailuresRailCurveTooShort Property  
...
```
```vb
Public Shared ReadOnly Property RailCurveTooShort As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ RailCurveTooShort {
	FailureDefinitionId^ get ();
}
```
```fsharp
static member RailCurveTooShort : FailureDefinitionId with get
```
