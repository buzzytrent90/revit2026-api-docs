...
The [ElectricalAnalyticalNode](562d1f7d-c9df-bee5-4659-4f8607ee4333.md) type exposes the following members.
...
|  | [CanConnectToUpstreamNode](9a2c6050-dcab-dff8-96bb-35183a60ddf7.md) | Verifies that the current node can connect to the upstream node. |
...
|  | [CanDisconnectFromUpstreamNode](a5d77780-b6e8-6657-b0b1-e629bd145ee6.md) | Verifies that the current node can disconnect from the upstream node. |
...
|  | [ConnectToUpstreamNode](ff97d96b-a3ed-7ad6-c428-a4a274088c9a.md) | Connects to upstream node. |
|  | [Create](c751bc8b-9141-efbb-3b86-1be8b94a8c69.md) | Creates an electrical analytical node. |
...
|  | [DisconnectFromUpstreamNode](9d1cdc60-34df-2ca6-8022-8742731743a1.md) | Disconnects from upstream node. |
...
|  | [GetAllDownstreamLoadIds](6d99429d-8994-86c8-c99e-6095096d8454.md) | Get all the descendant Electrical Analytical Load ids of the node. |
|  | [GetAnalyticalPropertyData](1b6aa6c7-35a8-46cf-8e05-efa5665f8f5d.md) | Gets the electrical analytical node property data,  if not available. |
...
|  | [GetDownstreamNodeIds](5ff642a5-6bb9-fc6f-6b1a-52f337a9be5d.md) | Gets the downstream node ids. |
...
|  | [GetUpstreamNodeIds](8f3adbf1-ccaa-dc1f-8440-a8cdf9ba747c.md) | Gets upstream node ids. |
