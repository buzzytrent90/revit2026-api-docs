...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBDividedSurface
...
The DividedSurface type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AllGridRotation](7e0b73cf-13dc-658f-e597-442c0efe6ae9.md) | Angle of rotation applied to the U- and V- directions together. |
...
|  | [BorderTile](906ce695-322f-9ae6-ad7c-26586af86005.md) | Determines the handling of tiles that overlap the surface's boundary. |
...
|  | [ComponentRotation](78cdcbbd-b322-c6e7-1465-29f7cc300fce.md) | The rotation of the pattern by a multiple of 90 degrees. |
...
|  | [Host](cf5cae80-7977-ad86-0381-3a56ee3c2b6c.md) | The element whose surface has been divided. |
|  | [HostReference](c90a0505-ae70-eac4-94a4-d72289a90e62.md) | A reference to the divided face on the host. |
...
|  | [IsComponentFlipped](82f331a5-8933-d7f7-8be7-e8dbad1236c5.md) | Whether the pattern is flipped. |
|  | [IsComponentMirrored](e4095192-0151-0abf-7ff3-522dc249d306.md) | Whether the pattern is mirror-imaged. |
...
|  | [NumberOfUGridlines](3c74565b-6322-14ed-26b0-c6fc85f6d2e8.md) | Get the number of U-gridlines used on the surface. |
|  | [NumberOfVGridlines](a5fff574-f64f-746e-8f1f-c1de57ff9699.md) | Get the number of V-gridlines used on the surface. |
...
|  | [UPatternIndent](6ac8981f-2a39-db05-7cf8-0fb3ecd898f1.md) | The offset applied to the pattern by an integral number of grid nodes in the U-direction. |
|  | [USpacingRule](bcb80bc9-33d9-2718-3080-500a9d8119de.md) | Access to the rule for laying out the first series of equidistant parallel lines on the surface. |
...
|  | [VPatternIndent](2e1c2b7b-2a2f-c7f2-ad66-15d72739e8ac.md) | The offset applied to the pattern by an integral number of grid nodes in the V-direction. |
|  | [VSpacingRule](b5dabf3b-96ff-26e5-0d91-314391ceddb2.md) | Access to the rule for laying out the second series of equidistant parallel lines on the surface. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddIntersectionElement](ac41d76c-ea3f-bb52-f9bb-c2cd064a25f8.md) | Adds an intersection element to the divided surface. |
...
|  | [CanBeDivided](14e87b16-51cf-52e8-87f0-06b47f80c1de.md) | This returns true if the reference represents a face that can be used to create a divided surface. |
...
|  | [CanBeIntersectionElement](208f7d38-eea3-5676-1eb6-d5ccaee8eda7.md) | Checks if the element can be an intersection reference. |
...
|  | [Create](b90ea001-cbb4-0fdf-89a0-1635255bdfd2.md) | Creates a new instance of a divided surface with a default layout. |
...
|  | [GetAllIntersectionElements](d2debd59-e78a-e355-a89f-eee8de6f874b.md) | Gets all intersection elements which produce division lines. |
...
|  | [GetDividedSurfaceForReference](718252c3-faac-2f25-ec76-ca2a027c663a.md) | Get a divided surface for a given reference. Returns null if the reference does not host a divided surface. |
...
|  | [GetGridNodeLocation](688f7190-8b0f-e7f0-f9a6-2dc9298efc2a.md) | Specify whether a particular grid node is interior to the surface, on the boundary, or outside the boundary. |
|  | [GetGridNodeReference](62738bc9-7201-894a-20bc-954e106b2061.md) | Get a reference to the geometric point associated with a grid node. |
|  | [GetGridNodeUV](30c8cf73-bcc3-5241-b48f-ab5c7be834e8.md) | Get the position of a grid node in UV coordinates in the surface. |
|  | [GetGridSegmentReference](ac22065a-c06b-a610-8274-b7e9f6e6dacd.md) | Get a reference to a line segment connecting two adjacent grid nodes. |
...
|  | [GetReferencesWithDividedSurfaces](4714c725-4863-5e56-e23f-49e207942e02.md) | For a given host element get references to all the faces that host a divided surface |
...
|  | [GetTileFamilyInstance](173b76c6-254c-a9a3-83de-b7384e1ecae7.md) | Get a reference to a tile element associated with a given seed node. |
|  | [GetTileReference](2ef73679-a240-0240-90c5-d08d2593de73.md) | Get a reference to one of the tile surfaces associated with a given seed node. |
...
|  | [IsSeedNode](861a3148-b87c-315d-cde4-402428d5d470.md) | Reports whether a grid node is a "seed node," a node that is associated with one or more tiles. |
...
|  | [RemoveAllIntersectionElements](90969247-211f-92f5-1973-5202e9b2287f.md) | Removes all the intersection elements from a divided surface. |
|  | [RemoveIntersectionElement](c5098b67-9c5c-58f2-bfea-24174072e816.md) | Removes an intersection element from a divided surface. |
