...
# FabricationPartAlignPartByInsertionPoint Method  
...
```
```vb
Public Shared Function AlignPartByInsertionPoint ( 
...
```
```fsharp
static member AlignPartByInsertionPoint : 
        document : Document * 
        partId : ElementId * 
        position : XYZ * 
        rotation : float * 
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The element is not a fabrication part. -or- Not all of the fabrication part's connectors are open. |
