...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBCurveElement](61673852-2d08-003d-e9fd-4be89d533774.md) [Autodesk.Revit.DBDetailCurve](21cd770e-fb1b-9fd9-b3a0-cdd6ba87df2b.md) Autodesk.Revit.DBDetailArc

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class DetailArc : DetailCurve
```
```vb
...
```
```cpp
public ref class DetailArc : public DetailCurve
```
```fsharp
type DetailArc = 
    class
...
The DetailArc type exposes the following members.
