...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) Autodesk.Revit.DBWall
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddAttachment](bef619ea-dede-2795-d767-04a464a997f0.md) | Attaches the wall to the target. If an attachment already exists with the same "attachmentLocation" value, an exception is thrown. The target should be a roof, floor, ceiling, toposolid, or other wall. |
|  | [AllowWrappingAtLocation](bcd819a6-20ae-9b1f-6eff-82a96fb500a0.md) | Allow end wrapping at the location. |
...
|  | [CanHaveProfileSketch](63ddfb69-5168-af0a-224c-4608ddd2352c.md) | Checks whether this wall has or can have a profile sketch. |
...
|  | [CreateProfileSketch](d582a742-d89d-6edb-90e2-dd16633bd8b8.md) | Creates a new Wall profile Sketch. |
...
|  | [DisallowWrappingAtLocation](9661e553-0f70-c038-7934-7fc593086b67.md) | Disallow end wrapping at the location. |
...
|  | [Flip](4fa072e8-7840-66bc-78a4-e13ef24f0d41.md) | The wall orientation will be flipped. |
|  | [GetAttachmentIds](3f317dcc-f9ad-3670-c89c-1703c813e8be.md) | Gets the ids of the target elements that are attached to the Wall. |
...
|  | [GetStackedWallMemberIds](66ec8d4e-25cd-1e14-3b25-d9d3a0f5cce9.md) | Get the sub walls which belongs to the wall. |
...
|  | [GetValidWrappingLocationIndices](c9dfbbdf-ef2c-07c5-2f47-4393692e260b.md) | Gets all valid locations for end wrapping. |
|  | [GetWrappingLocationAsCurveParameter](4755c9ba-cbb5-e2f8-703d-eeb0f1cd463d.md) | Gets the non-normalized (actual) curve parameter of the location. |
|  | [GetWrappingLocationAsReferences](f8a0e79e-7e80-2b41-2d33-86371ff85fb8.md) | Gets an array of references to faces at the location. |
...
|  | [IsValidTargetAttachment](e795b763-9f7e-00a6-5289-f9f4d8bf9da5.md) | Says whether the element id can be used as a target for a new attachment. |
...
|  | [IsWallCrossSectionValid](3da9a916-d6ca-2f56-b818-4cc60d7252a7.md) | Checks whether the desired cross section is valid for the current wall. |
|  | [IsWrappingAtLocationAllowed](511b03c0-64ca-67fc-0fd6-74a820dd6aea.md) | If end wrapping is allowed at the location. |
...
|  | [RemoveProfileSketch](7bd6782b-b088-9a3e-c5b6-3609c83f0070.md) | Reverts an edited wall to its original shape. |
