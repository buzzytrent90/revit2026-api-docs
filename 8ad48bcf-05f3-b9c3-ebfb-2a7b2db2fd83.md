...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalElectricalDemandFactorDefinition
...
The ElectricalDemandFactorDefinition type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [ElectricalDemandFactorDefinition](db9d6a75-8b04-fbe5-c036-6eba20cd8cd3.md) | Constructs a new ElectricalDemandFactorDefinition with default settings. |
  
|  | Name | Description |
| --- | --- | --- |
|  | [AdditionalLoad](4d1eafe2-5a2e-e49c-9d59-bc4649899ada.md) | Additional load to be included during demand load calculation. |
...
|  | [IncludeAdditionalLoad](11a9318d-aff9-fbe6-e5e1-a588c8ca3573.md) | Should the additional load (if set) be included in demand load calculations. |
...
|  | [RuleType](d6257806-a101-d1db-0745-15735a67e23a.md) | The rule type for this demand factor definition. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddValue](26518198-1bce-4119-da60-888e62785ba4.md) | Adds a value to the value set for this demand factor definition |
...
|  | [ClearValues](7d9ea288-d929-5c5d-aafc-756901eae87f.md) | Clears all the values stored for this demand factor definition. |
|  | [Create](e6a68683-24ac-2ea8-72d8-bd9228802df4.md) | Creates a new instance of a demand factor definition. |
...
|  | [GetApplicableDemandFactor](3ed202d6-0aae-32ec-5b02-50ac0274728b.md) | This method will return the applicable demand factor for the specified number of devices or load. |
...
|  | [GetValues](6f45b084-2c52-bfae-ae08-1945f716f55d.md) | Provides access to the value set stored with this demand factor definition |
|  | [GetValuesCount](21b2635c-7f4f-f8fd-262f-5a8377f08e12.md) | Returns the number of values in the set. |
...
|  | [RemoveValue](09a2e38a-645e-5653-88fb-83228454e6bb.md) | Removes a value to the value set for this demand factor definition |
...
|  | [SetValues](f602e175-2135-be17-81cd-9ca8bcf178ba.md) |  |
