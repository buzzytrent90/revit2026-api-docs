...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBSpatialElementCalculationLocation](f4fed5e0-0964-a973-c8f5-7beb046a2849.md) Autodesk.Revit.DBSpatialElementCalculationPoint
...
```
```fsharp
type SpatialElementCalculationPoint = 
    class
...
The SpatialElementCalculationPoint type exposes the following members.
...
|  | [Position](075179a0-ad84-9333-7d58-7c3625603b26.md) | The position of the "in" spatial element calculation point. |
