...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ArchitectureStairsPathType
...
The StairsPathType type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [ArrowheadTypeId](3c6c3cb9-9fa0-ecbf-c6a3-1ef77d783708.md) | The arrow head type of the stairs path. |
...
|  | [DistanceToCutMark](5c6dfd11-3bb4-8d71-0b82-9147ca6d52a3.md) | The distance from the stairs path arrow to cut mark. |
...
|  | [DrawForEachRun](f6dcd6ab-6f15-e30c-f6f5-ab8abbe4606c.md) | True if stairs paths should be drawn for each run, false if it should be drawn for the whole stairs. |
|  | [EndAtRiser](2c25b1cc-0b50-b659-c710-45cda63bbf9c.md) | Represents whether the stairs path ends at the riser. |
...
|  | [FullStepArrow](b1549a36-1d99-7920-df34-b0d7cffc4545.md) | True if the arrow fills the full step width, false if it fills by the specified arrow size. |
...
|  | [LineShapeAtCorner](8b7246ac-dfdb-da83-1c17-ebe4c9584828.md) | The line shape of stairs path at the corner. |
...
|  | [ShowArrowheadToCutMark](fb981813-456a-c975-1610-aafc2a0fd1dd.md) | True if the stairs path arrowhead should be shown to the cutmark, false if the arrow head is not shown. |
|  | [StairsPathDirection](88664f2e-edbc-b606-046e-ac8b20a89ae5.md) | The style of the stairs path. |
|  | [StartExtension](4d0fa7e4-92cd-4469-ba57-bf180e8f7a1d.md) | The start extension length of the stairs path. |
|  | [StartFromRiser](5e756a64-b50d-dee6-92f6-a76e9c6e6448.md) | True if the stairs path starts from the riser, false if it starts from the tread. |
|  | [StartSymbolTypeId](9d3eb283-4348-8330-99f9-6440074e7aaf.md) | The start symbol type of stairs path. |
