...
Creates a new instance of Structural Section L Profile shape with the associated set of parameters, used to attach to structural element. 
...
new : 
        ...
        shearAreaWeakAxis : float -> StructuralSectionLProfile
```
