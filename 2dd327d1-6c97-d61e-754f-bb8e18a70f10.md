...
# CeramicCeramicApplication Property  
...
```csharp
public static string CeramicApplication { get; }
```
```vb
Public Shared ReadOnly Property CeramicApplication As String
	Get
```
```cpp
public:
static property String^ CeramicApplication {
	String^ get ();
}
```
```fsharp
static member CeramicApplication : string with get
```
