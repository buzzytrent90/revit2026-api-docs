...
SystemObject SystemException [Autodesk.Revit.ExceptionsApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) [Autodesk.Revit.ExceptionsInvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) Autodesk.Revit.ExceptionsCannotOpenBothCentralAndLocalException
...
```vb
<SerializableAttribute>
Public Class CannotOpenBothCentralAndLocalException
...
```fsharp
[<SerializableAttribute>]
type CannotOpenBothCentralAndLocalException = 
    class
...
The CannotOpenBothCentralAndLocalException type exposes the following members.
