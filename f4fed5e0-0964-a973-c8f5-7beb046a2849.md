...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBSpatialElementCalculationLocation [Autodesk.Revit.DBSpatialElementCalculationPoint](01206063-c774-da20-48ef-2cabf599e106.md) [Autodesk.Revit.DBSpatialElementFromToCalculationPoints](a6fe424e-af41-c1de-7bc2-e6facd9f2386.md)
...
```
```fsharp
type SpatialElementCalculationLocation = 
    class
        inherit Element
    end
```
...
The SpatialElementCalculationLocation type exposes the following members.
...
|  | [MarkerPosition](11e13d93-8417-5f44-b33f-3f2ac4169d59.md) | The position of the spatial element calculation location marker. |
