...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBRevitLinkType
...
|  | [AttachmentType](456da4bd-16ef-a039-9934-2644f84fdb3b.md) | The attachment/overlay status of this link. |
...
|  | [IsNestedLink](cae32f75-fc08-8625-650a-dc6427d3b985.md) | Indicates whether this link is a nested or top-level link. |
...
|  | [LocallyUnloaded](ae370efc-5079-dbd8-5fb5-713086aae86e.md) | Checks whether a Revit link in a local model is unloaded only for the current user. |
...
|  | [PathType](c0517436-dea9-9728-1876-de384b2fbc96.md) | The type of path the link uses. |
...
|  | [GetChildIds](8336bb72-f686-c742-dbbe-b6245e6b33b4.md) | Gets the ids of the immediate children of this link. |
|  | [GetConversionData](9809ada4-fced-197c-7e4c-f339e75a2b80.md) | Returns the optional data that is necessary to generate the Revit file for this link. |
...
|  | [GetLinkedFileStatus](796710c2-4c58-af44-affa-eab4f985b5f3.md) | Returns the LinkedFileStatus of this link. |
...
|  | [GetParentId](937f7497-a73c-f97c-dc49-1da47d098200.md) | Gets the id of this link's immediate parent. |
|  | [GetPhaseMap](4d322c11-c2b3-a096-4f10-3b23c9112308.md) | Returns a mapping between phases in the host document and phases in the linked document. |
...
|  | [GetRootId](f50ff34a-11db-04ae-8085-636be561031d.md) | Gets the id of the top-level link which this link is linked into. |
...
|  | [HasSaveablePositions](2759f2e4-241d-f39d-c450-2b5674af5b24.md) | Determines whether the link has changes to shared positioning that could be saved. |
...
|  | [IsFromLocalPath](ff52a707-e3cc-4b90-d15b-d9db4f52766a.md) | Checks whether the Revit link uses a local path, such as a hard drive. |
|  | [IsFromRevitServer](514f1781-700e-558c-70c9-c9328139da6c.md) | Checks whether the Revit link is located on Revit Server. |
...
|  | [IsLoaded](a59a0c41-0fe3-9ecf-e448-82414966b745.md) | Checks whether the link with this id is loaded. |
...
|  | [IsNotLoadedIntoMultipleOpenDocuments](7e675de0-ce86-ef2e-fdef-f5e12558684d.md) | Checks whether the link is loaded into more than one open document in this session of Revit. If the link is loaded into multiple open documents, reload will be disabled. |
...
|  | [Load](f46b3b6c-1a9e-a2ab-19d7-367918b3e9f0.md) | Loads or reloads the Revit link from its currently-stored location. If the link is an external resource, Revit will contact the IExternalResourceServer to get the latest version of the link. |
|  | [LoadFrom(ExternalResourceReference, WorksetConfiguration)](f76e2dd3-7448-3aac-baf7-303851f50873.md) | Loads or reloads the Revit link. The link will be loaded from the location given in the input ExternalResourceReference. |
|  | [LoadFrom(ModelPath, WorksetConfiguration)](bdb3a91e-9a0a-e68d-51da-c460535f5fd2.md) | Loads or reloads the Revit link from disk or cloud. The link will be loaded from the input path. |
...
|  | [Reload](86830eb9-5ddb-c342-fddd-6963e5c03564.md) | Loads or reloads the Revit link from its currently-stored location. If the link is an external resource, Revit will contact the IExternalResourceServer to get the latest version of the link. |
|  | [RevertLocalUnloadStatus](4768dc29-83be-99f9-169c-a723202a1b8d.md) | Restores the workshared load status of a link that has been unloaded only for the current user, in a local copy of a workshared model. |
|  | [SavePositions](2bfb9cc1-5a29-a195-0892-92bef673ab66.md) | Saves shared coordinates changes back to the linked document. |
...
|  | [Unload](83f4add7-1c0a-ddfa-b8ab-5be6df0f28a2.md) | Unloads the Revit link. |
|  | [UnloadLocally](2b12bdb3-1505-960c-7cdb-e41a1295ff60.md) | Unloads a Revit link for the current user only. |
|  | [UpdateFromIFC(Document, ExternalResourceReference, String, Boolean)](a3196dab-5524-da34-df34-d01034e98df1.md) | Updates a Revit link type from an IFC file and loads the linked document. |
|  | [UpdateFromIFC(Document, String, String, Boolean)](c13bd6d6-8292-7fa0-0e78-c81dc1b3ecc3.md) | Updates a Revit link type from an IFC file and loads the linked document. |
