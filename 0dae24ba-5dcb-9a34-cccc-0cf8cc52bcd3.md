...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBView](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) [Autodesk.Revit.DBTableView](ba608411-21af-e924-2aa2-3595548ab39f.md) Autodesk.Revit.DBViewSchedule
...
|  | [BodyTextTypeId](980d0623-f826-bfee-7f68-78d1db70d663.md) | Defines the default text style used for the data section of the schedule. |
...
|  | [Definition](fe88f8dc-4926-4ff4-4490-7aee58d5a3f4.md) | The primary ScheduleDefinition. |
...
|  | [EmbeddedDefinition](d844369e-1bf1-28af-8d93-80a7e3f19cf8.md) | The embedded ScheduleDefinition. |
...
|  | [HasStripedRows](763633f3-f3c0-088a-b599-794cecf5e784.md) | Indicates whether this schedule has striped rows. |
|  | [HeaderTextTypeId](615568b8-7f0e-7680-7560-e5e475220396.md) | Defines the default text style used in the column headers in the body section of the schedule. |
...
|  | [IsHeaderFrozen](f7cef912-84ae-e4cc-94dc-784f4e182874.md) | A static property defining if the schedule header frozen setting is turned on or off in current Revit Application Session. |
|  | [IsInternalKeynoteSchedule](148b56a4-69df-af56-78a7-4a30265e7f54.md) | Identifies if this ViewSchedule is an internal schedule used when keynotes are filtered based on the elements that are shown on a sheet. |
...
|  | [IsTitleblockRevisionSchedule](21cbed70-7510-4321-4878-8b60d40b3e7e.md) | Identifies if this ViewSchedule is an internal schedule used to display revision schedules as part of a titleblock. |
...
|  | [KeyScheduleParameterName](c6fce00e-ec7c-dccb-7dcc-7297ab6368a9.md) | In a key schedule, the name of the parameter for choosing one of the keys. |
...
|  | [RowHeight](aca396e1-2fec-666c-005d-7e36d5153999.md) | Defines the schedule body rows height. |
|  | [RowHeightOverride](92cfddb5-13af-dc32-0b27-2f0fc35dbae2.md) | Defines the override that is applied to the row height. |
...
|  | [TitleTextTypeId](5dc9d891-f903-edac-33fa-30dda043b711.md) | Defines the default text style used in the header section of the schedule. |
...
|  | [UseStripedRowsOnSheets](3ffca97c-3963-1d68-0775-fbab3644856e.md) | Indicates whether a property setting of true will also change the display of this schedule to show striped rows on a sheet. If true, setting that property to true will also change the display. If false, striped rows will not display for this schedule on a sheet no matter what value is set for HasStripedRows. |
...
|  | [CanGroupHeaders](509911b4-ea7b-535d-f5f6-3b377c292e4c.md) | Indicates if selected headers can be grouped for this schedule. |
...
|  | [CanUngroupHeaders](2c5cbf50-8d29-a5d2-103d-06621e08da0b.md) | Indicates if selected headers can be ungrouped. |
...
|  | [SplitSegment](1ff6fd89-a9bc-c51e-e8c8-dc808add5af3.md) |  |
