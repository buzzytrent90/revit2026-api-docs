...
The [TableView](ba608411-21af-e924-2aa2-3595548ab39f.md) type exposes the following members.
...
|  | [GetAvailableParameterCategories](ba9bbe03-12e6-f5b4-d817-89a1e05f7f8f.md) | Get all available parameter categories. |
|  | [GetAvailableParameters](a97f0bbc-537f-5930-5430-144885dfd39a.md) | Gets a list of valid parameters for the specified category that can be used in the table view. |
...
|  | [GetCalculatedValueName](42fa111f-c7a2-e8b0-7d57-db0e1cf7719b.md) | Gets the calculated value name for a cell from the template view. |
|  | [GetCalculatedValueText](7a18ae01-215e-70a7-ee3b-ebfee6b8e3a8.md) | Gets the calculated value text for a cell from the instance view. |
...
|  | [GetCellText](fb43e302-3ba7-a5cd-0ca2-428ec9e6a422.md) | Gets the cell's text based on its type |
...
|  | [IsValidSectionType](5c2f17c8-6be8-b344-74fd-1d5c47cf7bca.md) | Identifies if the section type is valid for this view. |
