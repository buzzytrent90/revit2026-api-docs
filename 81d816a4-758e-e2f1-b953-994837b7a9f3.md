...
# AdvancedWoodWoodEarlycolorPerlinProf Property  
...
```
```vb
Public Shared ReadOnly Property WoodEarlycolorPerlinProf As String
	Get
```
```cpp
public:
static property String^ WoodEarlycolorPerlinProf {
	String^ get ();
}
```
```fsharp
static member WoodEarlycolorPerlinProf : string with get
```
