...
The [FilledRegionType](850ae173-379b-bfd6-7295-3950ccc229ca.md) type exposes the following members.
...
|  | [IsValidBackgroundPatternId](b28e67d3-68ed-d50f-59e8-c0436a41d25f.md) | Check if the id is valid for a background pattern |
...
|  | [IsValidFillPatternId](89d56b97-4909-03af-cda7-46e695394124.md) | Check if the id is a FillPatternElement or an invalidElementId |
|  | [IsValidForegroundPatternId](af2a14d3-08b4-76ae-f05d-57b840bc77fa.md) | Check if the id is valid for a foreground pattern |
|  | [IsValidLineWeight](36e69e7b-4bb3-b27a-f8e0-7d2afc3baf3a.md) | Indicates whether the given line weight value is valid. |
|  | [IsValidMasking](b0c57e6c-8ca1-1ae4-fba3-4cd7528c40d8.md) | Check that in a family the FillRegionType is always masking. |
|  | [IsValidSolidFillPatternId](6daab179-221d-8844-0677-f256de956add.md) | Checks if the id is valid for a background pattern |
