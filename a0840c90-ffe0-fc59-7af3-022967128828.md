...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBMEPAnalyticalConnectionType
...
```
```fsharp
type MEPAnalyticalConnectionType = 
    class
        inherit ElementType
    end
```
...
The MEPAnalyticalConnectionType type exposes the following members.
...
|  | [PressureLoss](74624771-7eca-8142-21f5-108e5cf476f2.md) | The pressure loss of this analytical connection type. |
...
|  | [Create](5b10a892-0a51-73e7-f8b1-73cca20c206d.md) | Creates an analytical connection type element. |
...
|  | [FindTypeByName](3c93daf3-82ed-b686-57ff-6e80f06c618e.md) | Finds the analytical connection type by its name. |
...
|  | [IsNameUnused](235f1ec6-7058-2592-be87-f434e934e404.md) | Checks if this is an unused name. |
