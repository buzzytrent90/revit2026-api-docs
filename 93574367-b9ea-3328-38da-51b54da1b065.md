...
# GenericGenericDiffuseImageFade Property  
...
```
```vb
Public Shared ReadOnly Property GenericDiffuseImageFade As String
	Get
```
```cpp
public:
static property String^ GenericDiffuseImageFade {
	String^ get ();
}
```
```fsharp
static member GenericDiffuseImageFade : string with get
```
