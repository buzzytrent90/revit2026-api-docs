...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureTruss
...
The Truss type exposes the following members.
...
|  | [Curves](1cc0d1e3-a946-f2bd-56ca-fcd407dc552c.md) | Get all the truss curves. |
...
|  | [Members](ac8c1ca8-0d19-706e-403b-3be82c6f082f.md) | Get all the members of truss. |
...
|  | [TrussType](e5aac783-7724-bc13-3d49-002edf50ef66.md) | Retrieve/set an object that represents the type of the truss. |
...
|  | [AttachChord](a0fc36fe-2c63-1a2c-0643-627b8560f09c.md) | Attach a truss's specific chord to a specified element, the element should be a roof or floor. |
...
|  | [Create](2d6a9c76-9a39-8161-a203-e4f8084495ef.md) | Creates a new Truss. |
...
|  | [DetachChord](a4540c86-9de5-1b40-1839-99d7224d4cde.md) | Detach a truss's specific chord from the element to which it is attached. |
|  | [Dispose](e3b07ee4-f500-1b95-c786-8984289a5143.md) | (Inherited from [Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)) |
|  | [DropTruss](397bb02f-794d-a0e9-5ea8-4ca3dc9a459c.md) | Drop truss Family, it will disassociate all members from the truss and delete the truss. |
...
|  | [GetTrussMemberInfo](885bcdab-10c1-5857-29db-3b95fe43be6d.md) | Query if a given element is a member of a truss, its lock status and its usage, etc. |
...
|  | [RemoveProfile](4c7c3d83-3288-ba90-0f6d-b3797422d818.md) | Remove the profile of a truss. |
...
|  | [SetProfile](5d80c385-94dd-4601-f83a-1e7db3662a25.md) | Add or modify the profile of a truss. |
|  | [TogglePinMember](675dc4a6-ee96-22d5-367e-ed2b44d8562d.md) | Pin/Unpin a truss member. |
