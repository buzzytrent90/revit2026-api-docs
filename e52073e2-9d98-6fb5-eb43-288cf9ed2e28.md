...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBIndependentTag [Autodesk.Revit.DBSpanDirectionSymbol](15890f37-0c4c-2b2e-8f34-a575baee7f14.md) [Autodesk.Revit.DB.StructureFabricReinSpanSymbol](ed051a39-7717-6be5-43a9-6f6598fd82f7.md) [Autodesk.Revit.DB.StructurePathReinSpanSymbol](b0741415-4247-d50f-20dc-e678f40bd65e.md) [Autodesk.Revit.DB.StructureRebarSystemSpanSymbol](f749c169-ea93-fb71-eb1e-c6febb10e54d.md)
...
The IndependentTag type exposes the following members.
...
|  | [HasLeader](ce3fe3a9-4048-3b29-4dcb-57ca86de4267.md) | Identifies if a tag has at least one visible leader, or if all leaders are hidden. |
...
|  | [IsMaterialTag](7670e365-227c-bc9d-a4b0-c77f793034e2.md) | Identifies if it is a material tag or not. |
...
|  | [IsMulticategoryTag](91f6e4f0-6a6b-efa6-5730-ea32a5cb203c.md) | Identifies if it is a multi-category tag or not. |
|  | [IsOrphaned](4906fa9c-e424-92e7-0b7e-15389726ca78.md) | Identifies if the tag is orphaned or not. |
...
|  | [LeaderEndCondition](0b0575d6-446d-d3e8-3ef7-12faed553b20.md) | The leader end condition of the tag, such as if the end of the leader is attached to the host or free floating. |
|  | [LeadersPresentationMode](f0d5e29e-0407-cdc0-cdf7-69ea516bd632.md) | Identifies the Presentation Mode that is applied to tag leaders. |
...
|  | [MergeElbows](5c5ad800-7512-be12-dc1a-ebcda5513622.md) | Identifies if the leaders' elbows are merged or not. If they are are merged, all elbows are in the same point and they move together. |
|  | [MultiLeader](5501affb-b03f-8bca-de56-c12a42915bc6.md) | Returns if the tag if referencing multiple elements and/or sub-elements. |
|  | [MultiReferenceAnnotationId](30363f1b-0fd1-fa0e-5617-be77d683662e.md) | The multi-reference annotation which owns this tag. |
...
|  | [RotationAngle](3b257113-5220-c9df-dd3c-50e1e28b847b.md) | The rotation angle of the tag relative to its view |
|  | [TagHeadPosition](4f49d3f3-e5c5-108a-49dd-2a36697bd08e.md) | The position of the head of tag in model coordinates. |
|  | [TagOrientation](d9d43a13-a972-3b69-2484-b6e336e9a0c5.md) | The tag orientation of the tag's head, such as horizontal or vertical. |
|  | [TagText](8e297dee-920d-f620-6198-0bed494e3f04.md) | The text associated with the tag. If there are several strings assiciated with the tag, the strings will be returned concatenated. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddReferences](333fc505-2f6b-e754-6841-fb7f7639284e.md) |  |
...
|  | [CanLeaderEndConditionBeAssigned](83343fd7-5244-12ae-faa0-3fcf082d483e.md) | Checks whether the LeaderEndCondition can be changed. |
...
|  | [GetLeaderElbow](cb3f9617-d5a4-7c45-1686-d7c2f60effad.md) | Returns the position of the elbow of the tag's leader that points to specified reference. Position of leader's elbow. |
|  | [GetLeaderEnd](d6f69738-aa40-d45c-5ab5-ba02d55d0837.md) | Returns the end position of the tag's leader that points to specified reference. |
...
|  | [GetTaggedElementIds](43260944-f46c-d5df-c9ea-f3a44e24d1a2.md) | Returns a set of LinkElementId for all tagged elements, if any. A LinkElementId will be provided for each subelement that is being referenced by the tag. |
|  | [GetTaggedLocalElementIds](142026b1-69d5-7b1e-f5b3-3360abc0f9be.md) | Returns a set of IDs for all tagged local elements, if any. A local element ID will be provided for each subelement that is being referenced by the tag. Set of all the element ids in the local file. For each subelement a local element id will be provided. |
|  | [GetTaggedLocalElements](f238e2c7-e184-172c-546a-7dd694857e56.md) | Get the tagged local elements, if any. An Element will be provided for each subelement that is being referenced by the tag. |
|  | [GetTaggedReferences](63a90870-6b37-57b2-26fe-6fa1e605a9da.md) | Get the host references of the tag. An array of all the tagged references. |
...
|  | [HasLeaderElbow](f4febfed-3134-a5c0-0f8e-d4e6c5b4b675.md) | Whether the tag's leader that points to the reference has an elbow point or not. |
...
|  | [HasTagBehavior](fadc39b4-eb80-2e00-f9af-e5752a0bb498.md) | Checks if the IndependentTag has a tag behavior. |
|  | [HasTagText](e32f82d2-9aaa-5845-397f-6ff9264ad31b.md) | Checks if the IndependentTag has a valid tag text. |
...
|  | [IsLeaderVisible](8ad822df-1fb8-938f-66d4-60ade8983c40.md) | Returns if leader that points to specified reference is visible or not. |
...
|  | [IsTaggedOnSubelement](8f6f8b8c-1b1b-1141-e165-1eecd4b765a1.md) | Returns true if the any of the tagged references is a subelement. |
...
|  | [RemoveReferences](902f7f27-964e-d7cd-e582-07f45750d768.md) |  |
...
|  | [SetIsLeaderVisible](b0b7f9bc-163b-01a6-9a8c-fa7cfc6c61a0.md) | Set tag's leader that points to specified reference to be visible or not. This option can be set only if the LeadersPresentationMode is ShowSpecificLeaders. |
|  | [SetLeaderElbow](dd5a7d21-cb13-d3d7-6dd6-8e8e427e4873.md) | Set the position of the elbow of the tag's leader that points to specified reference. If this tag is a multileader tag and the elbows are merged, the input position will be set to all leaders. |
|  | [SetLeaderEnd](fb54c007-6873-68f4-4772-e777609a441b.md) | Set the end position of the tag's leader that points to specified reference. |
