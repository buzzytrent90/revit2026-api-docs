...
# DocumentDocumentSavingAs Event  
...
EventHandler[DocumentSavingAsEventArgs](1bb9bb9f-be64-3c6f-804b-66fe6a2b0562.md)

This event is raised when Revit is just about to save the document with a new file name. Note that the first save of a newly created document will raise DocumentSavingAs rather than [DocumentSaving](26a118b5-c583-a9b2-c935-c11b270e140e.md) event. 
...
Another event [DocumentSavedAs](7ace570d-870f-be20-e493-e80ffa27f454.md) will be raised immediately after the document has been saved with a new file name.
