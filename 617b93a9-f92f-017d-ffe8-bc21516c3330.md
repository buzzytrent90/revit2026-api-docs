...
# ElectricalSystemRunsNumber Property  
...
```csharp
public int RunsNumber { get; }
```
```vb
Public ReadOnly Property RunsNumber As Integer
	Get
```
```cpp
public:
property int RunsNumber {
	int get ();
}
```
```fsharp
member RunsNumber : int with get
```
