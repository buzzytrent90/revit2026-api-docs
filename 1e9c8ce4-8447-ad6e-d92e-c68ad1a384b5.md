...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.PlumbingPipeInsulationType
...
```
```vb
Public Class PipeInsulationType
...
The PipeInsulationType type exposes the following members.
