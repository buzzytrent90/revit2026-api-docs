...
[ElectricalCircuitPathMode](ee98a836-6a40-db03-ef1e-655424d04a9a.md)
...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | When setting this property: The electrical system circuit path does not have customized path, so the CircuitPathMode cannot be set as Custom. |
