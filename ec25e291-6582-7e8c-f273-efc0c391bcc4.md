...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBWorksharingDisplaySettings
...
The WorksharingDisplaySettings type exposes the following members.
...
|  | [CanUserHaveOverrides](e50869c9-ce9d-6dad-44cf-e4d929b2196b.md) | Checks whether a single username can have customized graphic overrides. |
...
|  | [GetAllUsersWithGraphicOverrides](4df2c37c-fca2-80a3-980d-50a478220c58.md) | Returns all usernames that have graphic overrides. This list consists of all users included in the user table + all users who have explicitly been assigned overrides. |
...
|  | [GetOrCreateWorksharingDisplaySettings](32871a69-64cd-adcb-7fd9-ae9a60f3615a.md) | Returns the worksharing display settings for the document, creating new settings for the current user if necessary. |
...
|  | [GetRemovedUsers](1a79abbd-a072-2e11-1405-06252915fd9e.md) | Returns the set of users who have been explicitly removed from the settings. |
...
|  | [RemoveUsers](d714db4a-2b0e-e8da-2002-3508a3d71772.md) |  |
|  | [RestoreUsers](da4f0c9e-3c5d-1869-3351-5c93d815fe7a.md) |  |
...
|  | [UserHasGraphicOverrides](84a5e6ac-480e-cc1e-936c-912f22080c1d.md) | Checks whether there are graphic overrides that would apply to elements owned by the given user in the "Individual Owners" display mode. |
