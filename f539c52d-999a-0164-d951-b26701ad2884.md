...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.ElectricalCableTrayConduitRunBase](6820d2a3-d692-2d8e-cb69-d42060ace467.md) Autodesk.Revit.DB.ElectricalCableTrayRun
...
type CableTrayRun = 
    class
        inherit CableTrayConduitRunBase
    end
```


The CableTrayRun type exposes the following members.
...
|  | [Length](8d9b3472-e7b0-969f-92ee-6708c8263847.md) | The length of the whole (cable tray or conduit) run default 0.0 (Inherited from [CableTrayConduitRunBase](6820d2a3-d692-2d8e-cb69-d42060ace467.md)) |
