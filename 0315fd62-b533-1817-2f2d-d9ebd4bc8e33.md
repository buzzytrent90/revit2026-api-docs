...
| [OperationCanceledException](aea34480-ceb5-b49f-129d-0799e7bb1c21.md) | Thrown when the Revit user cancels this operation. Thrown when the Revit user tried to switch the active view, close the active document or Revit application when responding to this mode. |
