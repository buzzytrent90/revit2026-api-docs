...
members [CombinableElementArray](dc5f6afb-a30d-dc82-fcd3-340eff1685c7.md)
    A list of combinable elements to be combined.

#### Return Value

[GeomCombination](75501cfa-a83b-0acf-c446-b368551da6c4.md)If successful, the newly created geometry combination is returned, otherwise an exception with error information will be thrown.

| Exception | Condition |
| --- | --- |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | Thrown when the input argument is . |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when members contains less than two elements. Thrown when members contains  elements. |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when creation of the combination failed. |
