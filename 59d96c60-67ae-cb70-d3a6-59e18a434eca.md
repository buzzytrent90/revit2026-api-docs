...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.AnalysisConceptualConstructionType
...
The ConceptualConstructionType type exposes the following members.
...
|  | [MassSurfaceSubCategoryId](7ab3f987-cb65-4c2f-0f9f-e0f74e29416d.md) | The surface type subcategory element id associated with the ConceptualConstructionType. |
|  | [MaterialId](84212ac3-afd4-e6a8-1a8e-9830d78da630.md) | Material used for visualization of this construction. |
...
|  | [GetAllConceptualConstructionsForCategory](3752bcdb-0982-44cc-e31c-2c2ccf4c86e9.md) | Get all the ids of constructions applicable to the input massSubCategory |
...
|  | [GetFloorOrSlabConstructionType](4a20ade5-4456-b707-679e-ee4ef9e98b1f.md) | Get a Floor or Slab ConceptualConstructionType by its ConceptualConstructionFloorSlabType. |
|  | [GetGBSId](75f60a0b-3afa-13b7-559a-b70122c92fad.md) | Gets the Green Building Studio identifier associated with the construction. |
...
|  | [GetOpeningConstructionType](e8d1aefe-8978-d5af-706c-44a8b79027a1.md) | Get an Opening ConceptualConstructionType by its ConceptualConstructionOpeningType. |
...
|  | [GetRoofConstructionType](a7f16a35-0726-2a8b-369f-c64031c90e83.md) | Get a Roof ConceptualConstructionType by its ConceptualConstructionRoofType. |
|  | [GetShadeConstructionType](363f5434-3f4a-5748-80f8-3279ee1d1067.md) | Get a Shade ConceptualConstructionType by its ConceptualConstructionShadeType. |
...
|  | [GetWallConstructionType](e331e491-dfd1-0eb5-a9bf-66ee72297d9e.md) | Get a Wall ConceptualConstructionType by its ConceptualConstructionWallType. |
|  | [GetWindowOrSkylightConstructionType](5ff744e9-1b68-ac93-4731-68b304548ce8.md) | Get a Window or Skylight ConceptualConstructionType by its ConceptualConstructionWindowSkylightType. |
...
|  | [IsValidConceptualConstructionId](220c0588-536a-5806-6d35-54dbb4110ef2.md) | Indicates if the ElementId is an id of a ConceptualConstructionType. |
|  | [IsValidConceptualConstructionIdForCategory](eaeb8997-5870-bd9a-6a41-58de6834e2cb.md) | Indicate if a ConceptualConstruction is appropriate to assign to a MassSurfaceData of a particular Mass subcategory. |
...
|  | [IsValidSubcategoryForMassSurfaceDatas](75031bc8-15f5-cb88-1275-cb7d88ab04e4.md) | Validate if a subcategory is appropriate for assignment to Massing surfaces (MassSurfaceData). This is the list of acceptable values: |
...
| [IsValidSurfaceSubcategoryForConstruction](5f71a8d2-2c1f-427b-818b-139f01f33db5.md)|  Indicates if this ConceptualConstructionType is appropriate for the input MassSurfaceData subcategory.   
