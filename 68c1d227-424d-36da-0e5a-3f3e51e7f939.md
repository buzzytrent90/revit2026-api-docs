...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.MechanicalDuctSizeSettings
...
```
```fsharp
type DuctSizeSettings = 
    class
        inherit Element
        interface IEnumerable<KeyValuePair<DuctShape, DuctSizes>>
    end
```


The DuctSizeSettings type exposes the following members.
...
|  | [Item](04a9f724-107f-17ff-12d5-92a309df53d1.md) | Get the DuctSizes for this DuctShape. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddSize](ed95c206-c4f5-8aff-9c88-ff393dbb333e.md) | Inserts a new MEPSize in to the duct size settings. The duct shape determines the location of the new size in the size table. |
...
|  | [GetBasicIEnumerator](f64b5fd8-aa58-7785-c3e6-9d99283eb8cc.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetDuctSizeSettingIterator](124c6b6d-9730-696e-1e96-66c3159512aa.md) | Returns a DuctSizeSettingIterator object that iterates through the collection. |
|  | [GetDuctSizeSettings](a402c704-e6fc-19d4-993f-a7fc7d61bc23.md) | Get the duct size settings of the project. |
...
|  | [GetEnumerator](03568478-23c1-d14e-f151-f283d600f7a3.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetSizeCount](3fbdf755-b50c-4d08-8a56-dac84a37e12a.md) | Get the size count of the duct size table. The duct shape determines the location of the size in the size table. |
...
|  | [RemoveSize](9c4ba863-f8c4-574f-97e4-40fd3f2b6013.md) | Erase the existing MEPSize with this nominal diameter. The duct shape determines the location of the size in the size table. |
