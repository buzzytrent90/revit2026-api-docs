...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBDimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md) Autodesk.Revit.DBSpotDimension
...
The SpotDimension type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Above](a515077d-e21e-9f6d-58c2-f1f19577373d.md) | The text shown above the segment's value.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [AreReferencesAvailable](cdfc60a1-dd37-9428-6b47-d94870801559.md) | Indicates if this dimension's references can be resolved. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [AreSegmentsEqual](0d28a47a-b40e-c0fc-bfe0-d1b391f2c176.md) | Indicates if all segments are forced to be equal.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [Below](2d8fb2e2-b504-66da-30d5-a9b1a4099629.md) | The text shown below the segment's value.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [Curve](83e340d0-8c2c-d845-d8d5-2fb6aa64f085.md) | A curve that represents the dimension line. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [DimensionShape](7141f360-1215-f1d8-571f-4004452c79de.md) | The shape of this dimension.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [DimensionType](5f982cf1-cc62-8bb5-5a31-5061b97b6ddc.md) | The dimension style of this dimension. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [FamilyLabel](cd34752d-ff4f-e6f7-05e5-82405af00e52.md) | The family parameter label of the dimension.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [HasLeader](f37b29fc-4ea1-604f-25f4-182a66764251.md) | True if dimension has leader, false otherwise. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [IsLocked](496d64c6-3642-577d-7631-96956baed820.md) | Indicates if this dimension is locked. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [IsValid](a4382d5b-23af-acd0-1e58-0d964d483482.md) | Indicates if this dimension is valid. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [LeaderEndPosition](cf75655f-f779-5c31-5ea5-dc27839c46d5.md) | The position of the dimension's leader end point. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [LeaderHasShoulder](7285e050-0673-cd70-64c4-de7df60f05c2.md) | True is dimension has leader with shoulder, false otherwise. |
|  | [LeaderShoulderPosition](cb42a9d3-8a01-433c-46fb-2e390218f67a.md) | Position of spot dimension's leader shoulder point. |
...
|  | [Name](4c4c2704-48d2-8add-8309-427ff77a8955.md) | Retrieves or changes the name associated with the Dimension.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [NumberOfSegments](3e01937d-a001-8fd4-9cc8-270ad4b4ba10.md) | The number of segments for the dimension.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [Origin](df8b9dc6-9d36-ac2b-04cf-816d88f039b8.md) | The dimension origin. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [Prefix](36e450c8-09af-54af-a25d-9fede511522f.md) | The text shown before the segment's value.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [References](fc3bc889-b274-3262-a126-849df2af9019.md) | Returns an array of geometric references to which the dimension is attached. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [Segments](d7fcdab2-ca81-0ed1-4813-f7aa092430d7.md) | The segments in the dimension.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [SpotDimensionType](e653cdb6-319d-6c7a-c5b0-16992144e6f6.md) | The dimension style of this dimension. |
|  | [Suffix](e8817946-d9c0-9f75-ca44-c7d379caa388.md) | The text shown after the segment's value.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [TextPosition](2a3b8401-48c9-8425-1f98-b142babdf0a2.md) | The position of the dimension text's drag point. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [Value](883a5cec-31db-39c1-2745-210a45d67374.md) | The value of the dimension. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [ValueOverride](4560ec6c-5aab-fcae-a64c-6f939ae06d94.md) | The text that replaces the segment's value.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
|  | [ValueString](8608426e-2490-158c-f52b-f79d88f793f6.md) | The dimension value as a user visible string.(Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [View](8520fd39-b766-2f43-7937-1ffb4e0bc59a.md) | Supplies the view that contains the dimension if the dimension is view specific. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [CanFlip](c953bd97-f7ee-c385-9cde-68bde956ff75.md) | Verifies that the direction of the dimension can be flipped. |
...
|  | [Flip](f12f812e-64ce-1421-63fc-34ce0ecc51b1.md) | Flips dimension to the other side of the host. |
...
|  | [HasOneSegment](7fc64c23-c5fc-9180-26bd-f52749178056.md) | Determines whether a dimension has one segment. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [IsTextPositionAdjustable](e3d0717c-713d-64b0-64a9-336cbb95519a.md) | Indicates if this dimension is supported to set/get TextPosition/LeaderEndPosition. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
...
|  | [ResetTextPosition](2e4a13c9-1fc0-c1a4-6d85-1dcbc65b3e22.md) | Resets the text position of the dimension to the initial position determined by its type and parameters. (Inherited from [Dimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md)) |
