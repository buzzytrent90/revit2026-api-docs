...
# TableCellStyleOverrideOptionsHorizontalAlignment Property  
...
```
```vb
Public Property HorizontalAlignment As Boolean
	Get
	Set
```
```cpp
public:
property bool HorizontalAlignment {
	bool get ();
	void set (bool value);
}
```
```fsharp
member HorizontalAlignment : bool with get, set
```
