...
# AnalyticalPowerDistributableNodeDataSetConnectedPhasesOnDownstream Method  
...
connectedPhases [ElectricalConnectedPhases](19486d97-997f-11da-a2f3-6de29bd7ef41.md)
     The electrical connected phases to set to the downstream node. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The id isn't a downstream node id of the power distributable node. -or- The electrical connected phases can't be used to connect the downstream node to the power distributable node. |
