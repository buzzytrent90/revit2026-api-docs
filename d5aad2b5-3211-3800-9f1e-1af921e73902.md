...
# GeometryInstanceGetInstanceGeometry(Transform) Method  
...
```
```vb
Public Function GetInstanceGeometry ( 
...
[GeometryElement](09eaeb08-58bb-8049-8925-f3a5aa846fdc.md)An element which contains the computed geometry for the transformed instance.
...
[GetInstanceGeometry Overload](78c57647-ef0f-2d9d-2e16-d221fd5255c2.md)
