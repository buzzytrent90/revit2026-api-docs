...
# DisplacementElementGetAbsoluteDisplacement Method  
...
```
```fsharp
member GetAbsoluteDisplacement : unit -> XYZ 
```


#### Return Value

[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) The absolute displacement. 
