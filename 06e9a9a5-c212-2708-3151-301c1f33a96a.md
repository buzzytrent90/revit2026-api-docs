...
SystemObject SystemException [Autodesk.Revit.ExceptionsApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) Autodesk.Revit.ExceptionsExternalApplicationException
...
```vb
<SerializableAttribute>
Public Class ExternalApplicationException
...
```fsharp
[<SerializableAttribute>]
type ExternalApplicationException = 
    class
...
The ExternalApplicationException type exposes the following members.
...
|  | [GetObjectData](282e8a48-6451-d800-c9bb-73e63c9f115e.md) | Retrieves data needed to serialize the target object.(Overrides [ApplicationExceptionGetObjectData(SerializationInfo, StreamingContext)](7d12871e-63b5-bee1-e68d-e9b5565e7bb6.md)) |
