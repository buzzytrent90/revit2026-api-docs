...
# BuiltInFailuresDesignOptionFailuresNeverInOption Property  
...
```
```vb
Public Shared ReadOnly Property NeverInOption As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ NeverInOption {
