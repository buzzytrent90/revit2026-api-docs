...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBBeamSystem
...
The BeamSystem type exposes the following members.
...
|  | [BeamSystemType](f738ec01-4d36-884c-cc40-3a78c8b1b2bd.md) | Retrieves or changes the type of the BeamSystem. |
|  | [BeamType](c1f1e42c-b564-b968-6632-a014104b4877.md) | Retrieves or changes the Beam Type of the BeamSystem. |
...
|  | [Direction](8eccbd73-eb9b-7eaa-2449-d1bcfc0a8e84.md) | The Direction of the BeamSystem. |
...
|  | [Elevation](9ca4a8bf-9749-3a00-042b-5cfa9c345c68.md) | Retrieves or changes the Elevation of the BeamSystem. |
...
|  | [LayoutRule](2db288d4-8e26-b710-6371-72c8054a3d8b.md) | Retrieves or changes the LayoutRule of the BeamSystem. |
|  | [Level](ee3933b3-51ff-1476-cfe0-76042df715b0.md) | Get or change the level of the BeamSystem. When the level is changed, the elevation is changed to make the the BeamSystem remain the location. |
...
|  | [Profile](fb63b4c6-1702-538c-01b8-ee622e3e9993.md) | Retrieve or set the profile of the BeamSystem. |
...
|  | [BeamBelongsTo](66187e95-4034-01aa-afc4-5488de3b5414.md) | Find out the BeamSystem to which the beam belongs. |
...
|  | [DropBeamSystem](c1c29f1c-bcc2-947c-8cf6-380e0b5d64be.md) | Drop beam system, it will disassociate all members from the beam system and delete the beam system. |
...
|  | [GetBeamIds](0f489cca-4830-9016-fe8d-d17ba4b9f4d0.md) | Gets all the beams of the BeamSystem. |
