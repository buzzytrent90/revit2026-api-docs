...
# RebarConstraintGetTargetRebarAngleOnBarOrHookBend Method  
...
| Exception | Condition |
| --- | --- |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | RebarConstraint is no longer valid. -or- The RebarConstraint is not of RebarConstraintType 'ToOtherRebar'. -or- The RebarTargetConstraintType is not 'HookBend' or 'BarBend'. -or- Constrained rebar isn't a shape driven rebar element. |
