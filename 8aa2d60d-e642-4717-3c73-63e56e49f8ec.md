...
SystemObject Autodesk.Revit.DBBuiltInFailuresViewFailures
...
```
```vb
Public NotInheritable Class ViewFailures
```
```cpp
public ref class ViewFailures abstract sealed
```
```fsharp
[<AbstractClassAttribute>]
[<SealedAttribute>]
type ViewFailures = class end
```
