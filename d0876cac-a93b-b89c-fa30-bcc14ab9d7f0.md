...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBView](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) Autodesk.Revit.DBViewDrafting [Autodesk.Revit.DBImageView](d81ffc17-044c-2671-c2f1-374e1dd90c53.md)
...
```
```cpp
public ref class ViewDrafting : public View
```
```fsharp
type ViewDrafting = 
    class
...
The ViewDrafting type exposes the following members.
...
|  | [Create](93dbfef8-b014-3912-124d-812c10b8ebdb.md) | Creates a new ViewDrafting in the model. |
