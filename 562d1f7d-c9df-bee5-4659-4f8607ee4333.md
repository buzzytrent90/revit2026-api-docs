...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalElectricalAnalyticalNode
...
```
```vb
Public Class ElectricalAnalyticalNode
	Inherits Element
```
```cpp
...
The ElectricalAnalyticalNode type exposes the following members.
...
|  | [NodeType](69a337fb-627e-d669-de4e-91dcad69c541.md) | The type of electrical analytical node. |
...
|  | [TotalLoad](1fe925a7-744c-52cc-956f-7590167d1046.md) | The Total Connected Load. |
