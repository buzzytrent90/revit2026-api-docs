...
# BuiltInFailuresEnergyAnalysisFailuresProblemWithPowerLoadWarn Property  
...
```
```vb
Public Shared ReadOnly Property ProblemWithPowerLoadWarn As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ ProblemWithPowerLoadWarn {
