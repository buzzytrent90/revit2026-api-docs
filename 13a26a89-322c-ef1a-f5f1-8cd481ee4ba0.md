...
SystemObject Autodesk.Revit.DBBuiltInFailuresInfillFailures
...
```
```vb
Public NotInheritable Class InfillFailures
```
```cpp
public ref class InfillFailures abstract sealed
```
```fsharp
[<AbstractClassAttribute>]
[<SealedAttribute>]
type InfillFailures = class end
```
