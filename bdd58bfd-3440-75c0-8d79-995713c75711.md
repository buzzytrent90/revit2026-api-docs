...
```
```vb
Public Class StructuralSectionUserDefined
...
```
```fsharp
type StructuralSectionUserDefined = 
    class
...
The StructuralSectionUserDefined type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionUserDefined](138700d1-7067-0994-8043-00cf46528868.md) | Creates a new instance of Structural Section User Defined shape with the associated set of parameters, used to attach to structural element. |
