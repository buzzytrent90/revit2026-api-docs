...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.MechanicalMechanicalEquipmentSetType
...
```
```vb
Public Class MechanicalEquipmentSetType
...
```
```fsharp
type MechanicalEquipmentSetType = 
    class
        inherit ElementType
    end
```
...
The MechanicalEquipmentSetType type exposes the following members.
...
|  | [Create](74330acb-c529-5add-44b8-0ec564282c0e.md) | Creates a new type of a mechanical equipment set and adds it to the document. |
