...
# ExternalServiceRegistryExecuteService(Guid, Document, IExternalData) Method  
...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Executing a recordable service in a document that is not modifiable. |
