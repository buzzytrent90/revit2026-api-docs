...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBIFCCategoryTemplate

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class IFCCategoryTemplate : Element
```
```vb
Public Class IFCCategoryTemplate
	Inherits Element
```
```cpp
public ref class IFCCategoryTemplate : public Element
```
```fsharp
type IFCCategoryTemplate = 
    class
        inherit Element
    end
```
...
The IFCCategoryTemplate type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [IFCCategoryTemplate](b11f6251-400c-4cfd-4719-0b8a086bab5b.md) | Custom constructor for this element. |
...
|  | [IsValidCategoryMappingFile](a0b47162-2abc-27c5-9991-9460f1cc5303.md) | Whether or not the category mapping file is valid. |
...
|  | [CopyTemplate](51cf7870-c0f8-d3d7-800e-726e942fcbe7.md) | Create copy of mapping template with new name. |
|  | [Create](ba0e5b7b-0cd9-5e96-3d67-65251bfa9071.md) | Create a IFC category mapping template with default values. |
...
|  | [ExportToFile](5e33fc18-a7d6-c0e5-e43e-e1a56f71db75.md) | Export mapping template to a text file. |
|  | [FindByName](b71fda2c-869c-e7d8-5af1-9b0a3333a8f4.md) | Returns mapping template element by name. |
|  | [GetActiveTemplate](1e418c35-b6e5-4cbb-5ffc-98ab761edbce.md) | Gets the active mapping template element in the document. |
|  | [GetCategoryMappingTable](cf72fe8f-b5f6-18cd-7150-9c40ea216a54.md) | Gets the table that contains a mapping from Revit categories to IFC entities. |
...
|  | [GetMappingInfoById](9304b014-4d75-7ace-6a31-bea372c9f5d7.md) | Gets a copy of IFC mapping info by category id. |
...
|  | [GetOrCreateInSessionTemplate](62b8adbe-dcd0-aac0-2d0e-a44e10af0013.md) | Gets the in-session non-serializable template or create new. |
...
|  | [ImportFromFile](c8618241-dc08-7698-05e8-b5c4d5514255.md) | Import mapping template from a text file. |
...
|  | [IsValidName](b0a3e046-b2e5-78a4-7133-07ff384fe00c.md) | Returns result that the proposed name is valid and not exist in the specified document. |
...
|  | [ListNames](0da28c8e-08d0-ad93-1f53-65b87008af93.md) | Returns a list of names of IFC export mapping templates. |
...
|  | [ResetActiveTemplate](02e9d474-8d59-fe69-1818-64a1d414e036.md) | Removes the information about active mapping temple of the document. |
|  | [ResetCategoryToDefault](c16d57a7-f360-8776-dce8-860b85396906.md) | Reset one category, sub-category, or special category in the current mapping table to the default values defined in Revit |
...
|  | [UpdateCategoryList](086a1260-b82d-ae84-7288-e5af0887ebf8.md) | Updates the mapping table with the categories from the document. |
