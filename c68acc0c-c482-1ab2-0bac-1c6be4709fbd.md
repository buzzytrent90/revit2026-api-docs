...
# WireConduitTypeSetReverseIterator Method  
...
```
```fsharp
abstract ReverseIterator : unit -> WireConduitTypeSetIterator 
override ReverseIterator : unit -> WireConduitTypeSetIterator 
```


#### Return Value

[WireConduitTypeSetIterator](d6f64a0b-6752-6df6-821d-9f8bb85f4ab3.md)Returns a backward moving iterator to the set.
