...
# TileTileEdgeRoughness Property  
...
```csharp
public static string TileEdgeRoughness { get; }
```
```vb
Public Shared ReadOnly Property TileEdgeRoughness As String
	Get
```
```cpp
public:
static property String^ TileEdgeRoughness {
	String^ get ();
}
```
```fsharp
static member TileEdgeRoughness : string with get
```
