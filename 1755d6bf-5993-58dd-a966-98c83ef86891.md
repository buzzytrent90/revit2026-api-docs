...
# CurveLoopCreateViaThicken(CurveLoop, Double, XYZ) Method  
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input thickness is too short for a curve. -or- the curve loop is not marked as open. |
