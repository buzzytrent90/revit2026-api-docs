...
```csharp
public static string TileChangeColumn { get; }
```
```vb
Public Shared ReadOnly Property TileChangeColumn As String
	Get
```
```cpp
public:
static property String^ TileChangeColumn {
	String^ get ();
}
```
```fsharp
static member TileChangeColumn : string with get
```
