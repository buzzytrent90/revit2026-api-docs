...
The [MEPHiddenLineSettings](36aa6fd1-8948-f89d-3206-8bba2c3db54c.md) type exposes the following members.
...
|  | [DrawHiddenLine](2ab82d4f-b35b-e5da-ebba-5b2e8f545484.md) | Indicates if duct or piping is drawn with the line style and gaps specified for hidden lines. |
...
|  | [InsideGap](da56920b-4e46-c401-2945-ce3d4e5d0c5c.md) | The gap for the lines that appear within a crossing segment. |
...
|  | [LineStyle](2c028b70-ea27-ff38-0788-f2c4dd211bd5.md) | The line style that determines how the lines of a hidden segment display at the point where the segments cross. |
...
|  | [OutsideGap](d5a7eadf-7388-1251-7c58-778cd5a3add6.md) | The gap for the lines that appear external to the crossing segments. |
...
|  | [SingleLineGap](f522b726-a699-b433-8fc0-460f48003b10.md) | The gap for the single hidden lines where segments cross. |
