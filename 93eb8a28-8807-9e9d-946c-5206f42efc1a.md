...
viewDisplayModel [ViewDisplayModel](9864e320-a160-dd24-23f6-a30c482a8e5f.md)
     View display model settings to set. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The silhouette line style id is not a valid line style to apply to the view. |
