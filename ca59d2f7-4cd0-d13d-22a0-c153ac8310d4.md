...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBElevationMarker
...
The ElevationMarker type exposes the following members.
...
|  | [CurrentViewCount](de8f6462-5392-8dc7-730f-339b2aa59973.md) | The current number of views hosted by this ElevationMarker. |
...
|  | [IsReference](d414ea87-a529-54a3-a2e9-0df0102214c0.md) | Indicates if this is a reference ElevationMarker. Only reference elevations can be hosted by reference ElevationMarkers. |
...
|  | [MaximumViewCount](d750401a-9b00-9af9-5cd6-27dfbdc41053.md) | The maximum number of views that can be hosted by this ElevationMarker. |
...
|  | [CreateElevation](ef15bad0-1f09-2a61-b74b-f4967137a47b.md) | Creates a new elevation ViewSection on the ElevationMarker at the desired index. |
|  | [CreateElevationMarker](2f707487-817c-d648-4b99-559f9000f123.md) | Creates a new ElevationMarker. |
|  | [CreateReferenceElevation](38ef8e37-3f09-9e01-5e34-031fb7490ffc.md) | Creates a reference elevation on the ElevationMarker at the desired index. |
|  | [CreateReferenceElevationMarker](21c6e391-32f7-5ee8-03d9-269c4ecb3892.md) | Creates a new ElevationMarker. |
...
|  | [GetViewId](a66f506d-5a5f-9a14-5b7b-aacf46c8f08d.md) | Returns the ViewSection id for the index of the ElevationMarker. |
|  | [HasElevations](e40ae5a5-57d0-bf4b-00bf-c5b185aeaeac.md) | Returns true if the ElevationMarker has at least one elevation view, false otherwise. |
...
|  | [IsAvailableIndex](aa4c7c20-1e0c-39f3-1892-156fbc1fb2b9.md) | Returns true if a new elevation ViewSection can be placed at %index%, returns false otherwise. |
