...
SystemObject [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSection](65b59d7d-bd7b-c71b-7159-dfc506a912ee.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionRectangular](fc038108-6279-839c-285b-effe342b4491.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionHotRolled](60cc6328-1e99-2a7b-03fb-983e52350e55.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md) Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionIParallelFlange
...
```
```vb
Public Class StructuralSectionIParallelFlange
...
```
```fsharp
type StructuralSectionIParallelFlange = 
    class
...
|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionIParallelFlange](e1a731a9-ea32-bef5-18b4-a92d89d085e7.md) | Creates a new instance of Structural Section I Parallel Flange shape with the associated set of parameters, used to attach to structural element. |
...
|  | [BoltDiameter](1030bec7-f126-7b70-e428-39a3e350b7d0.md) | Maximum bolt hole diameter, in. (mm) |
|  | [BoltSpacing](4b316e2f-ef19-49b0-32da-0a99c8d2e627.md) | Standard bolt spacing, in. (mm) |
...
|  | [ClearWebHeight](a3ecb2bb-18df-2162-152b-2e6834e6a68d.md) | Detailing depth between the web toes of the fillets, in.(mm) |
...
|  | [FlangeFillet](dcbf6a27-cdd3-0cd6-5d62-816919635667.md) | Flange Fillet - fillet radius at the flange end. (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
...
|  | [FlangeToeOfFillet](2cbc82c1-fa59-26b6-ed48-c26d7f607989.md) | Detailing distance from center of web to flange toe of fillet, in. (mm) (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
...
|  | [SlopedFlangeAngle](a6ca0625-e72e-5964-3368-269b51e938c3.md) | Sloped flange angle. (rad) (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
...
|  | [WebToeOfFillet](cda6d038-dcae-fa11-7f5e-288d8424da3b.md) | Detailing distance from outer face of flange to web toe of fillet, in. (mm) (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
...
|  | [GetFlangeThicknessInFlangeCenter](46f6b1ef-44f4-d429-fd63-b5a98db15f2f.md) | Returns thickness of flange measured in the 0.25 * (width - webThickess), sometimes used for sections with width > 300 mm. (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
|  | [GetFlangeThicknessInQuarterWidth](9319279c-d6dc-72f5-fa4d-2e9b1b4feb10.md) | Returns thickness of flange measured in the 0.25 * width, sometimes used for sections with width <= 300 mm. (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md)) |
