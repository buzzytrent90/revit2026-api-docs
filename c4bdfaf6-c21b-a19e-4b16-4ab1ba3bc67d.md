...
# RoutingPreferenceManagerAddRule(RoutingPreferenceRuleGroupType, RoutingPreferenceRule, Int32) Method  
...
rule [RoutingPreferenceRule](28dd1a35-5115-c0fb-26e3-7bce14893b89.md)
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | index is not a valid zero-based index within groupType. -or- The rule cannot be added to the groupType. -or- Thrown if the index is out of bounds, or the rule is not valid for this group (e.g. an elbow may not be added to the junction group). |
