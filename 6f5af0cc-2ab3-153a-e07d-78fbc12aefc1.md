...
# InternalDefinitionSetAllowVaryBetweenGroups Method  
...
ICollection[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The ids of elements that were updated to align the values between groups. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | This parameter does not support the specified value of allowVaryBetweenGroups. -or- document is not a project document. |
