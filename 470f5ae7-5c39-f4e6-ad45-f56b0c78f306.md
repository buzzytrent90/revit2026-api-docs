...
# FailureDefinitionSetDefaultResolutionType Method  
...
```
```vb
Public Function SetDefaultResolutionType ( 
...
member SetDefaultResolutionType : 
        type : FailureResolutionType -> FailureDefinition 
```
...
[FailureDefinition](b0c061b0-d712-0c41-6054-b8ce8f996256.md) The FailureDefinition. 
