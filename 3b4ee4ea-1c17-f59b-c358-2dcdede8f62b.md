...
The [MultiReferenceAnnotationType](046b4d91-40b3-4dd0-be1b-635fb30956c2.md) type exposes the following members.
...
|  | [CreateDefault](25edda1f-9be3-5f7e-2d3b-255293c08b2a.md) | Creates the first MultiReferenceAnnotationType element and adds it to the document. |
...
|  | [GetAllowedTagCategory](06cf5deb-d580-4ce1-f0fd-a17b5558b3c9.md) | Returns the category ID for the tag types which can be used by this multi-reference annotation type. |
...
|  | [IsAllowedDimensionStyle](d55188f4-3723-7444-8086-5c23e58333ed.md) | Checks if the dimension style can be used with multi-reference annotations. |
|  | [IsAllowedReferenceCategory](44d8f0d4-67f2-3c2a-0941-350401e9ec9b.md) | Checks if the reference category can be used with multi-reference annotations. |
|  | [IsAllowedTagCategory](2bff739f-d084-8596-0633-28013e778e6c.md) | Returns true if tag types belonging to this category can be used with multi-reference annotation types. |
|  | [IsAllowedTagType](4f7f0cf5-ed38-ec2c-cfc9-7568b29a4601.md) | Checks if the tag type can be assigned to this multi-reference annotation type. |
