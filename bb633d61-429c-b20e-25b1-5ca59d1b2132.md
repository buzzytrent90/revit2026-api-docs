...
```
```vb
Public Class StructuralSectionConcreteRectangleCut
...
```
```fsharp
type StructuralSectionConcreteRectangleCut = 
    class
...
The StructuralSectionConcreteRectangleCut type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionConcreteRectangleCut](c84db48f-2b73-fcf4-24b2-456b331124d7.md) | Creates a new instance of Structural Section Concrete Rectangle Cut shape with the associated set of parameters, used to attach to structural element. |
...
|  | [BottomCutHeight](49e34259-9af7-11ba-d407-f36420996b0e.md) | Section height left Cut. |
|  | [BottomCutWidth](a5639d96-28fb-4cb9-ad59-a2ea6efeb0eb.md) | Section width left Cut. |
...
|  | [TopCutHeight](7d94c048-7f1f-847b-ba1f-50029a5ae947.md) | Section height right Cut. |
|  | [TopCutWidth](b790a27a-db66-5eda-dfb0-c394e19ca8b6.md) | Section width right Cut. |
