...
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The wire has only 2 vertices, so one cannot be removed. -or- Can't remove the vertex when the vertex is start or end point and the wire connects to one element. |
