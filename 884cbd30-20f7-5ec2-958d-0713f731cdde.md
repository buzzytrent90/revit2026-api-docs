...
```
```vb
Public Class StructuralSectionConcreteT
...
```
```fsharp
type StructuralSectionConcreteT = 
    class
...
The StructuralSectionConcreteT type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionConcreteT](db7e4710-7148-9942-b99d-9c6b1fb326b3.md) | Creates a new instance of Structural Section Concrete T shape with the associated set of parameters, used to attach to structural element. |
...
|  | [CantileverHeight](fdd22fcc-f58c-9a48-0287-868d1ea2537b.md) | Flange cantilever thickness. |
|  | [CantileverLength](e3df545b-9e1d-7521-6b54-8b5b4b8cce43.md) | Flange cantilever length. |
