...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ArchitectureStairsRunType
...
The StairsRunType type exposes the following members.
...
|  | [HasRisers](80526e1c-bfa5-643d-5b59-72b7390c51de.md) | True if the stairs run will include risers on steps, false otherwise. |
|  | [HasTreads](afc95198-c67e-7de7-3237-67f03e106c2f.md) | True if the stairs run will include treads on steps, false otherwise. |
...
|  | [IsMonolithic](e221f2fe-930c-3a7b-c731-6c1838f2d979.md) | True if the stairs run is monolithic, false otherwise. |
|  | [IsSlanted](8585de07-e216-358a-7aff-0581c9c7d81a.md) | True if risers will be slanted, false if they will be straight. |
...
|  | [MaterialId](f8b6de5f-2765-ad23-a271-ce65005b79e0.md) | The material of the stairs run, only available for monolithic stairs run. |
...
|  | [NosingLength](df67964e-9f7b-f4b8-5b67-4e2faf985853.md) | The amount of the tread depth that overhangs the next tread. |
|  | [NosingProfile](5f4c8bb3-da54-fb00-387a-2e7c13800840.md) | The id of the nosing profile of the treads. |
...
|  | [RiserProfile](f9c01688-2700-8144-47f3-a41896ca071a.md) | The id of the profile of the risers. |
|  | [RiserThickness](c1499b8a-f969-18f0-c7fd-b42609e5603a.md) | The thickness of the risers. |
|  | [RiserToTreadConnect](38e441dd-7c1d-4c60-ab69-4a5f936f177c.md) | The connection of the riser to tread in relation to each other. |
|  | [StructuralDepth](796c6515-9e91-e455-d0e8-91b15241074c.md) | The structural depth of the stairs run, only available for monolithic stairs run. |
|  | [TotalDepth](00e10880-4a18-381a-44fb-51dd1ba226b8.md) | The total depth of the stairs run, only available for monolithic stairs run. |
|  | [TreadNosingPosition](e5f0486c-4ca8-72fd-35cc-d8a0c9a77a7c.md) | Represents on which edges of the nosing to apply the nosing profile. |
|  | [TreadProfile](9d40bd4c-480a-3cf6-6b48-f81dfd2e7ad9.md) | The id of the profile of the treads. |
|  | [TreadThickness](0c6c2238-aba9-0056-4f1f-33793c18b012.md) | The thickness of the treads. |
|  | [UndersideSurfaceStyle](4ac85f7d-ec42-335a-8bfb-ae2389fb1c28.md) | The underside surface style of the stairs run, only available for monolithic stairs run. |
