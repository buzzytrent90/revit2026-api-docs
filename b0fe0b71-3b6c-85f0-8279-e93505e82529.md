...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) [Autodesk.Revit.DBMEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.md) Autodesk.Revit.DB.PlumbingPipingSystemType
...
```
```fsharp
type PipingSystemType = 
    class
        inherit MEPSystemType
    end
```


The PipingSystemType type exposes the following members.
...
|  | [Create](046cbcbc-bf76-4a77-672b-0da66b906963.md) | Creates a new instance of a piping system type and adds it to the document. |
...
|  | [ValidateRiseDropSymbolType](43506db8-5f55-8f67-780e-44ce3dda5cb4.md) | Confirms if the parameter is a valid piping rise/drop symbol type. |
