...
```
```vb
Public Class StructuralSectionZProfile
...
```
```fsharp
type StructuralSectionZProfile = 
    class
...
The StructuralSectionZProfile type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionZProfile](30803a25-436d-f19d-fe70-c51a26e57e13.md) | Creates a new instance of Structural Section Z Profile shape with the associated set of parameters, used to attach to structural element. |
