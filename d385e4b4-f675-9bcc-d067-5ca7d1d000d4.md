...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalConduitSizeSettings
...
```
```fsharp
type ConduitSizeSettings = 
    class
        inherit Element
        interface IEnumerable<KeyValuePair<string, ConduitSizes>>
    end
```


The ConduitSizeSettings type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddSize](dcb1141a-656d-31fd-7e04-e2ffe12da313.md) | Inserts a new ConduitSize in to the conduit size settings. The conduit standard name determines the location of the new size in the size table. |
...
|  | [CreateConduitStandardTypeFromExisingStandardType](140bee14-3c01-d17a-5017-2f4301524c04.md) | Creates one conduit standard type with the new name and assign the conduit sizes to it from the existing standard type. |
...
|  | [DoesConduitStandardTypeExist](3ef858e5-0984-0d1d-c063-2ff07feed167.md) | Checks if the specified conduit standard exist. |
...
|  | [GetBasicIEnumerator](52ead6fa-0234-1689-518f-82ab16fe4a18.md) | Returns an enumerator that iterates through a collection. |
|  | [GetConduitSizeSettings](f46950b6-1f00-7137-663f-cf1fb8b5e99a.md) | Gets the conduit size settings of the project. |
|  | [GetConduitSizeSettingsIterator](8d9283aa-e31a-b7bc-66e3-08b9ed143d54.md) | Returns a ConduitSizeSettingIterator to the conduit size settings. |
...
|  | [GetEnumerator](85207543-4387-b1e5-0db7-0106f0344785.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetSizeCount](cc196c19-2cb5-9120-879d-12053637af11.md) | Gets the size count of the conduit size table. The conduit standard name the location of the size in the size table. |
...
|  | [RemoveConduitStandardType](608651d0-d4f2-d85a-5230-672dd360d4e2.md) | Erases the existing ConduitSizes with this conduit standard name; the consuit standard type can not be removed if it is in use. |
|  | [RemoveSize](e16228d0-e1a4-d583-aa5f-4338390688d3.md) | Erase the existing ConduitSize with this nominal diameter. The conduit standard name determines the location of the size in the size table. |
