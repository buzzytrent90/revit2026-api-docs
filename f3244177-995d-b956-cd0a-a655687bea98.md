...
# MetallicPaintMetallicpaintFlecksSize Property  
...
```csharp
public static string MetallicpaintFlecksSize { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintFlecksSize As String
	Get
```
```cpp
public:
static property String^ MetallicpaintFlecksSize {
	String^ get ();
}
```
```fsharp
static member MetallicpaintFlecksSize : string with get
```
