...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) [Autodesk.Revit.DBDimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md) Autodesk.Revit.DBSpotDimensionType
...
```
```fsharp
type SpotDimensionType = 
    class
        inherit DimensionType
    end
```


The SpotDimensionType type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AlternateUnits](c6e3383f-be38-6738-5d7e-18487fa01de5.md) | The alternate units display mode for this DimensionType. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [AlternateUnitsPrefix](c2e2e6e4-4042-ca9d-e537-8d7430e621c9.md) | The prefix text for the alternate units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [AlternateUnitsSuffix](fc89169d-afb1-55e4-c8c0-98fab0f097ef.md) | The suffix text for the alternate units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [Prefix](8bc987fd-a5f3-9c11-e9be-860947445f81.md) | The prefix text for the dimension value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [StyleType](2c31c41a-cd12-4fef-2b2e-439012efc810.md) | The dimension style type of this DimensionType. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [Suffix](1caee7d4-8990-7790-f41b-fb03166d7c58.md) | The suffix text for the dimension value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [CanHaveEqualityFormula](eda97893-d225-4564-471d-dd2f1a4277e5.md) | Checks whether this DimensionType can have an equality formula. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [CanHaveOrdinateDimensionSetting](aaab2cfd-af6c-9ef4-2754-91f2be6ee5bd.md) | Checks whether this DimensionType can have an ordinate dimension settings. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [GetAlternateUnitsFormatOptions](81fca2c9-ca3c-0f70-366e-8841944bdac7.md) | Gets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [GetEqualityFormula](086fb666-7be0-f093-516e-670b149be97d.md) | Gets an ordered list of the entries in the equality formula definition. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [GetOrdinateDimensionSetting](97c6109a-f5af-eccf-5db7-2a72f608b685.md) | Gets the ordinate dimension settings for this DimensionType. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [GetSpecTypeId](bcdcd878-9956-0531-deac-e68dd6f7149a.md) | Gets the spec of this dimension style. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [GetUnitsFormatOptions](ca121374-9437-d76c-06e8-7a98d16829fd.md) | Gets the FormatOptions to optionally override the default settings in the Units class for the units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [SetAlternateUnitsFormatOptions](a8203fee-0893-99fe-a279-950b80cd22ee.md) | Sets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
...
|  | [SetEqualityFormula](1fbbcd04-ce47-e054-6ed7-706171f97ec0.md) | (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [SetOrdinateDimensionSetting](b6201e90-b02d-a2a0-a239-9230f79e8a20.md) | Sets the ordinate dimension settings for this DimensionType. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
|  | [SetUnitsFormatOptions](3589c9ad-24df-58ca-07a1-2b0c3e2ac157.md) | Sets the FormatOptions to optionally override the default settings in the Units class for the units value. (Inherited from [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md)) |
