...
# BuiltInFailuresStairRampFailuresMultistoryStandardStairTopEndExceedsOrNotReach Property  
...
```
```fsharp
static member MultistoryStandardStairTopEndExceedsOrNotReach : FailureDefinitionId with get
```
