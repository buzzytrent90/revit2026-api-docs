...
# DocumentPublishCoordinates Method  
...
locationId [LinkElementId](6e18abde-8787-9906-8576-ab0c9c5432c6.md)
     The ElementId of the ProjectLocation in the linked document, to which the transform would be published to. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | locationId does not contain a valid linkInstanceId. -or- Only RevitLinkInstance is supported through API for publish coordinates. |
