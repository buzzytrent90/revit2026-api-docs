...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisEnergyAnalysisConstruction
...
```
```vb
Public Class EnergyAnalysisConstruction
	Inherits Element
```
```cpp
...
```
```fsharp
type EnergyAnalysisConstruction = 
    class
        inherit Element
    end
```
...
The EnergyAnalysisConstruction type exposes the following members.
