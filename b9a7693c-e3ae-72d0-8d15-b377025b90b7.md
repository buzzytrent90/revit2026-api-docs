...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisBuildingOperatingDaySchedule
...
```csharp
public class BuildingOperatingDaySchedule : Element
```
```vb
Public Class BuildingOperatingDaySchedule
	Inherits Element
```
```cpp
public ref class BuildingOperatingDaySchedule : public Element
```
```fsharp
type BuildingOperatingDaySchedule = 
    class
        inherit Element
    end
```
...
The BuildingOperatingDaySchedule type exposes the following members.
...
|  | [ScheduleName](33d8a083-a371-12d5-ea56-b9dab918c6e5.md) | The name of the schedule. |
...
|  | [Create](efcf91a1-73e0-9b97-0ab1-e8b8acfb794b.md) | Creates a new instance of a BuildingOperatingDaySchedule. |
...
|  | [GetValueForHour](f73beefa-df3a-68dd-775f-3bd2d79eb97f.md) | Gets the usage value for an hour. |
...
|  | [SetValueForHour](7b251879-4b7c-05c1-b50d-0b28f8da1b8d.md) | Sets the usage value for an hour. |
