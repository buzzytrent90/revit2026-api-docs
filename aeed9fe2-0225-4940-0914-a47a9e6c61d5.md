...
# RebarFreeFormAccessorGetCouplerIdAtIndex Method  
...
```
```vb
Public Function GetCouplerIdAtIndex ( 
...
```cpp
public:
ElementId^ GetCouplerIdAtIndex(
	int barPositionIndex, 
	int end
)
```
```fsharp
member GetCouplerIdAtIndex : 
...
[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Returns id of the Rebar Coupler at the specified end. 
