...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBIndependentTag](e52073e2-9d98-6fb5-eb43-288cf9ed2e28.md) Autodesk.Revit.DB.StructureFabricReinSpanSymbol
...
```
```vb
Public Class FabricReinSpanSymbol
...
The FabricReinSpanSymbol type exposes the following members.
...
|  | [Create](5b20c5e2-9ee4-c3a9-0820-a7e370f104f9.md) | Places a new instance of the Structural Fabric Reinforcement Symbol into the project relative to a particular FabricSheet and View. |
