...
# ApplicationIsStructureEnabled Property  
...
```
```vb
Public Property IsStructureEnabled As Boolean
	Get
	Set
```
```cpp
public:
property bool IsStructureEnabled {
	bool get ();
	void set (bool value);
}
```
```fsharp
member IsStructureEnabled : bool with get, set
```
