...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBBrowserOrganization
...
The BrowserOrganization type exposes the following members.
...
|  | [SortingOrder](3746ebf0-7ef3-5b14-c4cc-0a9b1d3108eb.md) | The sorting order if sorting of items is applicable in the browser. |
|  | [SortingParameterId](f709abcf-baa3-085c-4fdd-8ab09ee976b8.md) | **Obsolete.** The Id of the parameter used to determine the sorting order of items in the browser. |
|  | [Type](20c64d61-44cb-d40c-eafe-0fb191977514.md) | Get BrowserOrganizationType. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AreFiltersSatisfied](0e3cabea-8309-3c7b-a684-b1248601cb64.md) | Determines if the given element satisfies the filters defined by the browser organization. |
...
|  | [GetCurrentBrowserOrganizationForPanelSchedules](9488ac90-2894-62ec-1b4b-b9aa1109fdc4.md) | Gets the BrowserOrganization that applies to the Panel Schedules section of the project browser. |
|  | [GetCurrentBrowserOrganizationForSchedules](b32365b9-54d0-08b3-ee34-4a2cde7fa1d8.md) | Gets the BrowserOrganization that applies to the Schedules section of the project browser. |
|  | [GetCurrentBrowserOrganizationForSheets](62479943-c356-7d0a-7ca4-b5e4db785948.md) | Gets the BrowserOrganization that applies to the Sheets section of the project browser. |
|  | [GetCurrentBrowserOrganizationForViews](08b2637d-816b-5cca-541d-8e3168bef3e7.md) | Gets the BrowserOrganization that applies to the Views section of the project browser. |
...
|  | [GetFolderItems](6d61981d-4d9c-477c-a85a-6ae375bc8cfc.md) | Returns a collection of leaf [FolderItemInfo](ef79812e-ea11-eda4-9c51-b54df57dc197.md) objects each containing the given element Id. |
...
|  | [GetSortingParameterIdPath](fc632868-4931-1c5e-2603-37a9b17e0b6c.md) | The parameter Id path used to determine the sorting order of items in the browser. |
