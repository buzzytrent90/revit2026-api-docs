...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBFabricationServiceSettings
...
```
```vb
Public Class FabricationServiceSettings
	Inherits Element
```
```cpp
...
The FabricationServiceSettings type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AirFluidType](87ee74d9-77d8-3517-5ae8-45eb95e07524.md) | A special fluid type for fabrication HVAC services. |
...
|  | [GetFabricationServiceSettings](cce22614-e34d-b846-ff1c-20169f128500.md) | Gets the settings element in the document. |
|  | [GetFluidTemperature](6bbd6cfd-4876-f23b-fa59-c4a9cf8194d5.md) | Gets the fluid temperature of the specified service. |
|  | [GetFluidType](a68293fe-39d0-207d-e222-a4b49c22b65a.md) | Gets the fluid type of the specified service. |
...
|  | [HasValidFluidSetting](cd2d80d9-7c35-a1a8-e975-909f17733a77.md) | Is the service associated with a fluid type and temperature? |
...
|  | [RemoveFluidSetting](7eaaddca-683d-7d6b-9191-d61e06492c38.md) | Clears the fluid setting of the specified service if found. |
...
|  | [SetFluidTypeAndTemperature](353cecb8-5a1e-62ca-97db-9e36387ca7a5.md) | Sets the fluid type and temperature of the specified service. |
