...
# BuiltInFailuresDesignOptionFailuresConfusingSweepByElementsInMainModelWarn Property  
...
```
```fsharp
static member ConfusingSweepByElementsInMainModelWarn : FailureDefinitionId with get
```
