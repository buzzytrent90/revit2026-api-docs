...
# ParameterTypeIdAnalyticalElementHasAssociation Property  
...
```
```vb
Public Shared ReadOnly Property AnalyticalElementHasAssociation As ForgeTypeId
	Get
```
```cpp
public:
static property ForgeTypeId^ AnalyticalElementHasAssociation {
	ForgeTypeId^ get ();
}
```
```fsharp
