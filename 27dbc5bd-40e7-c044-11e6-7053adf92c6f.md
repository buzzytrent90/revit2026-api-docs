...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBComponentRepeater
...
type ComponentRepeater = 
    class
        inherit Element
        interface IEnumerable<ComponentRepeaterSlot>
    end
```


The ComponentRepeater type exposes the following members.
...
|  | [DefaultFamilyType](5c58ac2c-7cf7-3fe1-dab4-7749c1b5a055.md) | The default family type for the component repeater. |
...
|  | [DimensionCount](c958b9ec-0aeb-d97f-0fcb-a0ecc58b9db6.md) | The dimension count of the component repeater. |
...
|  | [CanElementBeRepeated](85030abd-7476-91fc-a67b-50dd8bcf9697.md) | Determines whether an element can be repeated using the **RepeatElements** method. |
...
|  | [GetBasicIEnumerator](f88e21de-e2b8-571f-5ba3-5cf746506737.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetEnumerator](95071080-0ca2-ca24-76a2-5fd4ec2fb209.md) | Returns an enumerator that iterates through a collection. |
...
|  | [IsTypeValidForRepeater](64b2d4bf-7c8f-e641-5d78-e95565bc5c77.md) | Determines whether given family type can be used as the default type for the repeater. |
...
|  | [RemoveRepeaters](f36b63f5-18dd-9279-7596-99548faf325e.md) |  |
|  | [RepeatElements](fea4df07-ac92-08f3-ae93-8d0a512d0e76.md) |  |
