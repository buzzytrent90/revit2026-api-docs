...
ISet[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Collection of Ids of Curve Elements. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The given Id does not represent any of the two end-points of a curve element. A valid value of either '0' or '1' is expected. |
