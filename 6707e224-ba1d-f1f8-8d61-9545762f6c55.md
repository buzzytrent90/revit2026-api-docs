...
# AlignmentGetVCurveNormalAtStation Method  
...
```
```vb
Public Function GetVCurveNormalAtStation ( 
	station As Double
) As XYZ
```
```cpp
...
```
```fsharp
member GetVCurveNormalAtStation : 
        station : float -> XYZ 
```
...
[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)2d (X and Y components of returned vector) vertical normal at given station.
