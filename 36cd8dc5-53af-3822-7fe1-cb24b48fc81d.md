...
```csharp
public static string CeramicType { get; }
```
```vb
Public Shared ReadOnly Property CeramicType As String
	Get
```
```cpp
public:
static property String^ CeramicType {
	String^ get ();
}
```
```fsharp
static member CeramicType : string with get
```
