...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ArchitectureStairsLanding
...
The StairsLanding type exposes the following members.
...
|  | [BaseElevation](43d0fed8-4a1f-2cd3-0c01-33b13fec59c5.md) | The base elevation of the landing. |
...
|  | [IsAutomaticLanding](3eb3c125-de9d-bb0d-4463-a1443e2a3338.md) | True if the landing is an automatic landing, False otherwise. |
...
|  | [Thickness](7eb40b33-4e7b-6cca-2f81-58b0deded957.md) | The thickness of the landing. |
...
|  | [CanCreateAutomaticLanding](e62d4713-6b77-f2ae-aa4a-6679c56daa07.md) | Checks whether automatic landing(s) can be created between the given two stairs runs and logically join(s) with the stairs runs. |
...
|  | [CreateAutomaticLanding](48bca49d-ae21-0329-072e-777553f38c07.md) | Creates automatic landing(s) between two stairs runs. |
|  | [CreateSketchedLanding](0ae077db-8f31-a4f7-34f8-4735c480a48d.md) | Creates a customized landing between two runs by providing the closed boundary curves of the landing. |
|  | [CreateSketchedLandingWithSlopeData](453848e3-2cab-8777-4c46-e94275898425.md) |  |
...
|  | [GetAllSupports](0aeb598f-bc73-c12a-20bd-29911c89a1bd.md) | Returns all the supports hosting the stairs landing. |
|  | [GetConnections](0a80d27c-a959-a712-6298-de5410502ed8.md) | Returns information about the connections in which the stairs landing participates. |
...
|  | [GetFootprintBoundary](d034d8f7-2125-5013-67ed-fce94c280afa.md) | Returns the landing's boundary curves which are projected on the stairs base level. |
...
|  | [GetStairs](b3f42d91-f8ea-ea09-fe74-d4fc9798343c.md) | Returns the stairs to which the landing belongs. |
|  | [GetStairsPath](9b7d51c5-1a8c-62d9-4aa4-e7dd1bfe8090.md) | Returns the stairs path curves on the landing. The curves are projected on the stairs base level. |
...
|  | [SetSketchedLandingBoundaryAndPath](06a069c8-d944-b723-5b7d-90ec9a896fae.md) | Sets the boundary and path curves of the sketched landing. |
