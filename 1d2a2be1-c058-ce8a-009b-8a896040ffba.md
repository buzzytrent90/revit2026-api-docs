...
# ElectricalLoadClassificationPanelEstimatedLabel Property  
...
```csharp
public string PanelEstimatedLabel { get; set; }
```
```vb
Public Property PanelEstimatedLabel As String
	Get
	Set
```
```cpp
public:
property String^ PanelEstimatedLabel {
	String^ get ();
	void set (String^ value);
}
```
```fsharp
member PanelEstimatedLabel : string with get, set
```
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: panelEstimatedLabel is not a valid globalization format string. |
