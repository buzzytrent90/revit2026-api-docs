...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ElectricalWireMaterialType
...
```csharp
[ObsoleteAttribute("WireMaterialType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use ConductorMaterial instead. ConductorMaterials will be created by WireMaterialTypes properly during document upgrade.")]
...
```
```cpp
[ObsoleteAttribute(L"WireMaterialType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use ConductorMaterial instead. ConductorMaterials will be created by WireMaterialTypes properly during document upgrade.")]
...
The WireMaterialType type exposes the following members.
...
|  | [Name](93aaef5d-baa6-f731-46d9-e5a5cbb857bb.md) | Get name of wire material type. (Overrides [ElementTypeName](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.md)) |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddGroundConductorSize](21dcbeef-656d-7a93-144a-a4f65f3395c1.md) | Add new electrical ground conductor size type into this material type. |
|  | [AddTemperatureRatingType](e07cf6c5-d374-ff37-4dc3-1ca59577e466.md) | Add a new temperature rating type into material type. |
...
|  | [RemoveGroundConductorSize](772b5f7e-7bf6-d462-158a-78905761388c.md) | Remove an existing ground conductor size from this material type. |
|  | [RemoveTemperatureRatingType](84c4992a-c355-2a2b-23de-606791e00e03.md) | Remove an existing temperature rating type from this material type. |
