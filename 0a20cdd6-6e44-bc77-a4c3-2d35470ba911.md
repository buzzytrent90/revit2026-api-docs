...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBSpatialElementTag [Autodesk.Revit.DB.ArchitectureRoomTag](3593ae3b-3046-4fd1-ced3-ce1368e3adb3.md) [Autodesk.Revit.DBAreaTag](8bbf0942-d7ce-02f0-8e07-aaa6e7aff169.md) [Autodesk.Revit.DB.MechanicalSpaceTag](ef54adf0-d922-e041-0e8c-34cff3ebdb8f.md)
...
The SpatialElementTag type exposes the following members.
...
|  | [HasElbow](3a30f767-9284-8287-ba2f-dc1660c368b8.md) | Identifies if the tag's leader has an elbow point or not. |
|  | [HasLeader](645e86f1-72c0-00b4-ac36-f5e09a9be15f.md) | Identifies if a leader is displayed for the tag or not. |
...
|  | [IsOrphaned](f2e699b0-20cf-9af1-98c5-aa9f339260a0.md) | Identifies if the tag is orphaned or not. |
|  | [IsTaggingLink](75f8aca2-6dbe-c124-02fa-001620407989.md) | Identifies if the tag has reference to a spatial element in a linked document or not. |
...
|  | [LeaderElbow](8c75fb6c-8b26-077b-125e-b4e2bce3d230.md) | The position of the leader's elbow (middle point). |
|  | [LeaderEnd](32bac43c-9a67-7d69-4068-eb4fe34f6acb.md) | The position of the leader's end. |
...
|  | [Location](ac42ff31-d480-8b0e-4735-b5eb6ee1d53e.md) | The location of the tag.(Overrides [ElementLocation](89438f4f-7e15-835a-0c66-d6adbc8dd00c.md)) |
...
|  | [RotationAngle](b82d0c41-45b0-9fb8-8370-f481988fc19b.md) | The rotation angle of the tag relative to its view |
|  | [TagHeadPosition](4a5d8e7d-2a08-faec-4266-6773280aeb61.md) | The position of the tag's head. |
|  | [TagOrientation](710d99f6-e7eb-7254-d81c-392b18e9ddc6.md) | The orientation of the tag. |
|  | [TagText](0d546fcf-75eb-85e2-d603-171a629ed9fc.md) | The text displayed by the tag. |
...
|  | [View](abc98018-65b1-0908-373d-1d9359346167.md) | The view in which the tag was placed. |
...
|  | [MoveToReferenceLocation](d6a80b4d-020f-6271-49eb-54db837725a5.md) | Moves the SpatialElementTag to the location of SpatialElement that the tag is associated with. |
