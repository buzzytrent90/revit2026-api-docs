...
# PanelScheduleViewGetLoadClassificationConnectedCurrent Method  
...
```
```vb
Public Function GetLoadClassificationConnectedCurrent ( 
	nRow As Integer,
	nCol As Integer
) As String
```
...
```
```fsharp
member GetLoadClassificationConnectedCurrent : 
        nRow : int * 
        nCol : int -> string 
```
...
String The Connected Current for the given Load Classification 
