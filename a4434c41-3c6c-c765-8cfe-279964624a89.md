...
# CableTypeConductorMaterial Property  
...
```
```vb
Public Property ConductorMaterial As ElementId
	Get
	Set
```
```cpp
public:
property ElementId^ ConductorMaterial {
	ElementId^ get ();
	void set (ElementId^ value);
}
```
```fsharp
member ConductorMaterial : ElementId with get, set
```
