...
# BuiltInFailuresStairRampFailuresRailProfileOpen Property  
...
```
```vb
Public Shared ReadOnly Property RailProfileOpen As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ RailProfileOpen {
	FailureDefinitionId^ get ();
}
```
```fsharp
static member RailProfileOpen : FailureDefinitionId with get
```
