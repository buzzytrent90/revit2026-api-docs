...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.MechanicalSystemZoneElementType
...
```csharp
public class SystemZoneElementType : ElementType
```
```vb
Public Class SystemZoneElementType
	Inherits ElementType
```
```cpp
public ref class SystemZoneElementType : public ElementType
```
```fsharp
type SystemZoneElementType = 
    class
        inherit ElementType
    end
```
...
The SystemZoneElementType type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AirChangesPerHour](6c93d0e7-462a-c867-9313-2985b4bae1e6.md) | The air changes per hour. |
...
|  | [CoolingSetPoint](da3fb2e1-8549-0251-db02-403daebae41b.md) | The cooling temperature set point in unit Kelvin (K). |
...
|  | [DehumidificationSetPoint](1919d11c-e2b2-849e-6e9a-06a2c9852563.md) | The humidification set point as a number between 0 and 1. |
...
|  | [GeometricDefinition](390508b5-7a64-cfd2-99a8-5b5b1b62b125.md) | The geometric definition for this element type. |
...
|  | [HeatingSetPoint](afa6b22d-2c93-8da5-5aaa-76e899e8be43.md) | The heating temperature set point in unit Kelvin (K). |
|  | [HumidificationSetPoint](06411fd9-3f21-65d7-5ab0-d92b105330d4.md) | The humidification set point as a number between 0 and 1. |
...
|  | [OutdoorAirPerArea](5d770e66-4050-e38d-c269-9ec756b55c8e.md) | The outdoor air per area in unit feet per second. |
|  | [OutdoorAirPerPerson](f70bd0a8-1038-33a4-254c-ef8248cc4ea2.md) | The outdoor air in unit cubic feet per second per person. |
...
|  | [UseDehumidificationSetPoint](eacd82d0-91f8-0676-7a67-c03886e976b8.md) | Use the dehumidification set point. |
|  | [UseHumidificationSetPoint](09cce937-0a5a-44d1-9545-9c070a45f782.md) | Use the humidification set point. |
...
|  | [CreateSketchBased](f08251f7-468d-ec59-233b-50c4e0d22676.md) | Creates a new element type for sketch-based system-zone elements and adds it to the document. |
|  | [CreateSpaceBased](090dedf2-3243-5dfd-6dbd-b254065670fb.md) | Creates a new element type for space-based system-zone elements and adds it to the document. |
