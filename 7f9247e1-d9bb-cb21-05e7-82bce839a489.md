...
```csharp
public static string TileFadeVariance { get; }
```
```vb
Public Shared ReadOnly Property TileFadeVariance As String
	Get
```
```cpp
public:
static property String^ TileFadeVariance {
	String^ get ();
}
```
```fsharp
static member TileFadeVariance : string with get
```
