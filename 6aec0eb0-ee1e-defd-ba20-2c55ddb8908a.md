...
# BuiltInFailuresStairRampFailuresStairsRunRunJoinNotAllowedFailure Property  
...
```
```vb
Public Shared ReadOnly Property StairsRunRunJoinNotAllowedFailure As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ StairsRunRunJoinNotAllowedFailure {
