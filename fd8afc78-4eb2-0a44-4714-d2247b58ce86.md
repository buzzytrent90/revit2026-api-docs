...
# BuiltInFailuresEnergyAnalysisFailuresNoRoofsSpacesBoundingWarn Property  
...
```
```vb
Public Shared ReadOnly Property NoRoofsSpacesBoundingWarn As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ NoRoofsSpacesBoundingWarn {
