...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalElectricalAnalyticalLoadSet
...
```
```vb
Public Class ElectricalAnalyticalLoadSet
	Inherits Element
```
```cpp
...
```
```fsharp
type ElectricalAnalyticalLoadSet = 
    class
        inherit Element
    end
```
...
The ElectricalAnalyticalLoadSet type exposes the following members.
...
|  | [QuantityOnStandBy](93cb3c22-efd8-be20-0ae7-c0733a774e9e.md) | The number of Equipment Loads that are not operational at any time. |
|  | [TotalQuantity](50ed6c01-3acd-d974-f8e1-1e61b3e1ce41.md) | The total count of the Equipment Loads in the LoadSet. |
...
|  | [Create](1552184e-755d-1f60-3e40-4178923f44fc.md) | Creates an electrical analytical load set. |
...
|  | [GetLoadIds](2b5171dd-45be-b19d-6980-2a0bc5a90398.md) | Gets Equipment Load ids in the LoadSet. |
