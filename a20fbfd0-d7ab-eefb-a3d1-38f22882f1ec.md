...
```
```fsharp
member DropDownClosed : IEvent<EventHandler<ComboBoxDropDownClosedEventArgs>,
...
EventHandler[ComboBoxDropDownClosedEventArgs](e2bf5805-fb7c-5285-3c22-08534cfce159.md)
