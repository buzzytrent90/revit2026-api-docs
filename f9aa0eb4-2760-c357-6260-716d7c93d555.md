...
# PlasticVinylPlasticvinylType Property  
...
```csharp
public static string PlasticvinylType { get; }
```
```vb
Public Shared ReadOnly Property PlasticvinylType As String
	Get
```
```cpp
public:
static property String^ PlasticvinylType {
	String^ get ();
}
```
```fsharp
static member PlasticvinylType : string with get
```
