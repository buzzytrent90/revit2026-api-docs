...
Creates a new instance of Structural Section I Welded shape with the associated set of parameters, used to attach to structural element. 
...
Public Sub New ( 
	width As Double,
	height As Double,
	topFlangeThickness As Double,
	topFlangeWidth As Double,
	bottomFlangeThickness As Double,
	bottomFlangeWidth As Double,
...
new : 
        ...
        shearAreaWeakAxis : float -> StructuralSectionIWelded
```
