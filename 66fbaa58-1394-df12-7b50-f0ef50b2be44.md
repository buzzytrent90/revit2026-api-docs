...
path [CurveArray](55103aad-38fd-45d2-6bf7-67a5203e99f3.md)
...
profile [SweepProfile](1b77356c-e92b-e151-f8c9-727b3e2b8934.md)
...
profilePlaneLocation [ProfilePlaneLocation](7ee6064e-ae88-1efe-a030-dabfae9bacaf.md)
    The location on the profileLocationCurve where the profile plane will be determined.

#### Return Value

[Sweep](ed383459-badd-2323-4f73-0d94fd76ce0f.md)If creation was successful the new Sweep is returned, otherwise an exception with failure information will be thrown.

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when the input argument-path-is  or empty. |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | Thrown when the input argument-profile-is . |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | Thrown when the input argument-profileLocationCurveIndex-is out of index bounds. |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | Thrown when the input argument-profilePlaneLocation-does not exist in the ProfilePlaneLocation enumeration. |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when creation is attempted in Conceptual Mass, 2D, or other family where sweeps cannot be created. |
