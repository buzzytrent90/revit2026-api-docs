...
# BuiltInFailuresMEPFabricationFailures Class  
  
---  
  
Failures about MEP fabrication. 

SystemObject Autodesk.Revit.DBBuiltInFailuresMEPFabricationFailures

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public static class MEPFabricationFailures
```
```vb
Public NotInheritable Class MEPFabricationFailures
```
```cpp
public ref class MEPFabricationFailures abstract sealed
```
```fsharp
[<AbstractClassAttribute>]
[<SealedAttribute>]
type MEPFabricationFailures = class end
```


The BuiltInFailuresMEPFabricationFailures type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AdditionalPartNotLoaded](17baf655-2197-a356-b5e9-8bed3fd5fb11.md) | An additional part was not loaded. |
|  | [CannotConvertFlexPipeToPart](c84eb0ba-ca83-2cb1-a5af-91ad7954789c.md) | Cannot convert flex pipe to fabrication part. |
|  | [CannotMatchFabricationHangerSizeToHost](2df28deb-a2a2-1259-5d07-1bafa71cc08e.md) | The hanger cannot be re-sized to match the re-sized host. |
|  | [FabDbChangeConn](587e7425-4d77-bd37-96c9-a43e977ed6f0.md) | Fabrication Database changes altered connectivity |
|  | [FabDbOpenJobConn](29272303-5485-e3e1-d794-3a6f26f6fde8.md) | Fabrication job imported had bad connectivity |
|  | [FabDbSwapOut](bff282fd-c9bd-3bbe-5f97-1ea02490294f.md) | Fabrication Database reload could not swap out for newer parts. |
|  | [FabricationConfigurationCorrupted](8380505d-1508-3a07-a713-acf81d5e4acd.md) | It looks that the Fabrication Configuration %1!s! was corrupted, please check it at %2!s!. |
|  | [FabricationHangerCannotBeSloped](0366bd7b-f2dd-412c-c467-320484fb0d1b.md) | A hanger cannot be sloped or placed on a sloped element. |
|  | [FabricationHangerHostNotFound](a45ca5d7-ace1-6b12-806c-2e00f62886d9.md) | The hanger will disconnect because we can't find the suitable host. |
|  | [FabricationHangerNotConnectToHost](001f5115-a02a-8973-ca1f-a78a12185ea7.md) | Fabrication Hanger didn't connect to the %s host. |
|  | [FabricationHangerOutOfHost](51527e2f-6e87-9682-3156-154f5e8644c4.md) | The hanger is out of its host and will be disconnected. |
|  | [FabricationHangerSizeNotMatch](3b143519-2fe3-f1e8-f889-77a9d36a1540.md) | The hanger size does not match the size of the host, so it can not be connected. |
|  | [FabricationOutOfSizeCondition](85ef6496-b0a7-a54f-407b-2fc243485f8c.md) | The fabrication part size is not within the correct size range for the service button condition. |
|  | [FabricationOverSizedCheck](3067d96d-7595-2952-88ef-b08de16f85aa.md) | Fabrication part is too large to fit on the sheet metal. Replace the part with multiple smaller parts, or notify the CAM operator. |
|  | [FabricationPartBadConnectionAlignmentWarning](22cc20d3-1bd0-ebc9-6a2c-5dc3336c419b.md) | The connection invalid due to the connector are not aligned and/or this is a gap between the connectors. |
|  | [FabricationPartBadConnectionConnectivityWarning](f55aa84c-df8c-c719-23ff-787ea1ff220f.md) | The connection invalid due to connection types associated to the connectors are not compatible. |
|  | [FabricationPartBadConnectionSizeWarning](7a7ffc2c-221e-e04c-55ec-d2ce72d097f6.md) | The connection invalid due to connectors sizes are not the same. |
|  | [FabricationPartCannotBeMirrored](768aefbf-073d-4c8d-7098-970760a83ae0.md) |  |
|  | [FabricationPartCannotChangeServiceSizeWarning](85244bb3-6e6c-c7c9-b52e-bf57ccd8a8af.md) | The selected fitting(s) cannot successfully change service or change size. You must disconnect the connections on the fitting(s) and try again. |
|  | [FabricationPartCannotChangeSlopeError](f3dc0e0f-5926-6bfb-6c2d-0a8596dd3112.md) | The connected fitting(s) cannot successfully change to the new slope value. You may try to disconnect the connections on the fitting(s) and try again. |
|  | [FabricationPartCannotChangeTypeBadDimError](80be01c2-73e0-c7d1-6265-46fb900c90cb.md) | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part may have badly configured dimensions or be constrained due to connected fitting(s). You may try to disconnect the connections on the fitting(s) and try again. |
|  | [FabricationPartCannotChangeTypeBadDimUnConnError](6befc086-4872-4100-2061-9adb02a8d226.md) | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part may have badly configured dimensions, resulting in bad geometry. |
|  | [FabricationPartCannotChangeTypeError](5d819cec-31a8-119d-c8a1-ca5e7d7c4a17.md) | The selected fitting(s) cannot successfully change the type. You must disconnect the connections on the fitting(s) and try again. |
...
|  | [FabricationPartInvalidInsulationSpecificationWarning](6c173090-0a9d-75b5-d457-88462f1c8b92.md) | The insulation specification is invalid for the pinned fabrication part. |
...
|  | [NotAllPartsWereConvertedUnsuportedFittingOffsets](ff9e5034-a6ce-b606-e912-d2fd602a1659.md) | Not all parts were converted. Eccentric transitions and taps that have offsets from the center line are unsupported and cannot be converted. |
