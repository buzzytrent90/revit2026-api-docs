...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBMultiSegmentGrid
...
The MultiSegmentGrid type exposes the following members.
...
|  | [Text](8ec5e47a-8821-5d3c-0951-33d051a58b96.md) | name shared by grids in this MultiSegmentGrid |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AreGridsInSameMultiSegmentGrid](742243de-2773-a7c5-7b6d-ee4ce3b4b7d1.md) | Determine whether two Grids are members of the same GridChain. |
...
|  | [Create](706e504e-20dd-e017-6bdf-e5265848d150.md) | Create a MultiSegmentGrid element from the specified curve loop. |
...
|  | [GetGridIds](203790e1-56b4-52d3-83f5-14ccd3409466.md) | Get the element ids of the Grids that make up this MultiSegmentGrid. |
...
|  | [GetMultiSegementGridId](141c947b-7be3-4eee-9a92-627865023bf8.md) | Retrieve the element id of the MultiSegmentGrid of which the specified Grid is a member. |
...
|  | [IsValidCurveLoop](cc8ce9f7-9dc9-a807-76c1-f4bfb12232b9.md) | Identifies whether the specified curve loop is valid for creation of a MultiSegmentGrid. |
|  | [IsValidSketchPlaneId](aa463929-733e-8831-3075-a34e3fe12bcf.md) | Identifies whether provided element id corresponds to a SketchPlane that is valid for GridChain creation. |
