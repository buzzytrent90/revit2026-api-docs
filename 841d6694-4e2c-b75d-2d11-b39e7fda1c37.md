...
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | tabName or panelName is Empty or the tab name duplicates the name of another tab in the Revit UI. |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Too many custom tabs have been created in this session. (Maximum is 20). |
