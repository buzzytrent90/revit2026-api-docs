...
# AdvancedWoodWoodUseLatewoodBump Property  
...
```
```vb
Public Shared ReadOnly Property WoodUseLatewoodBump As String
	Get
```
```cpp
public:
static property String^ WoodUseLatewoodBump {
	String^ get ();
}
```
```fsharp
static member WoodUseLatewoodBump : string with get
```
