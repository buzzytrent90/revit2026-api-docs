...
```
```vb
Public Shared ReadOnly Property StoneBumpMap As String
	Get
```
```cpp
public:
static property String^ StoneBumpMap {
	String^ get ();
}
```
```fsharp
static member StoneBumpMap : string with get
```
