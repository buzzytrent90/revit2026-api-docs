...
# AnalyticalLinkTypeRotationZ Property  
...
```
```fsharp
member RotationZ : AnalyticalFixityState with get, set
```
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The fixity state rotationZ is not valid for Analytical Link Type parameters. |
