...
|  | [CopyCurveLoopsInSketch](5605fe73-f63e-ee85-2670-4765dc11641b.md) | Creates copies of the CurveLoops in the FabricArea sketch. |
...
|  | [GetBoundaryCurveIds](eae59f38-12a2-87cb-a153-642aa88d6c55.md) | Retrieves the identifiers of the set of curves forming the boundary of the Fabric Area. |
...
|  | [GetFabricSheetElementIds](7c1f56f7-0dd8-d0b6-c49e-b70c3e34bafd.md) | Retrieves the identifiers of all the FabricSheet Elements in the FabricArea. |
...
|  | [GetReinforcementRoundingManager](6dc448b9-1be0-95f7-a38d-c540a440c5e3.md) | Returns an object for managing reinforcement rounding override settings. |
...
|  | [GetTotalSheetMass](53bbfc7e-3255-6e68-7339-5dd39af0d75b.md) | Calculates the total sheet mass: Volume of Wire * Unit Weight. |
...
|  | [GetValidViewsForTags](be0c10c4-f8b0-0149-0a73-2879cdec5076.md) | Gets ids of the views where tags and symbols can be placed for the FabricArea and/or FabricSheets |
...
|  | [IsCoverOffsetValid](81963ad4-c71e-481d-3b62-d7942bcaaab3.md) | Identifies if the specified value is valid for use as a cover offset. |
...
|  | [IsValidMajorLapSplice](0dfb7466-d504-e38b-7c1b-9f1d2a2eb736.md) | Identifies if the specified value is valid for use as a major lap splice. |
|  | [IsValidMinorLapSplice](604dc875-594e-1e63-4cc0-1fe22848b09d.md) | Identifies if the specified value is valid for use as a minor lap splice. |
...
|  | [RemoveFabricReinforcementSystem](f3972463-e0b1-6998-a12e-20ee51fbd6f0.md) | Deletes the specified FabricArea, and converts its FabricSheet elements to equivalent Single Fabric Sheet elements. |
