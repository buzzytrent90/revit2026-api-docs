...
# FilterableValueProviderIsIntegerValueSupported Method  
...
```
```vb
Public Function IsIntegerValueSupported ( 
	element As Element
) As Boolean
```
```cpp
public:
bool IsIntegerValueSupported(
	Element^ element
)
```
```fsharp
member IsIntegerValueSupported : 
