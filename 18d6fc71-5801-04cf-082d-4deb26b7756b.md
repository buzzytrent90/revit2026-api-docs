...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisBuildingOperatingYearSchedule
...
```csharp
public class BuildingOperatingYearSchedule : Element
```
```vb
Public Class BuildingOperatingYearSchedule
	Inherits Element
```
```cpp
public ref class BuildingOperatingYearSchedule : public Element
```
```fsharp
type BuildingOperatingYearSchedule = 
    class
        inherit Element
    end
```
...
The BuildingOperatingYearSchedule type exposes the following members.
...
|  | [Create](dc482205-3384-6a11-0937-290acb36ee73.md) | Creates a valid BuildingOperatingYearSchedule with the given name, where every day has the schedule daySchedule. |
...
|  | [GetScheduleForDay](4490df4c-ce78-fa02-56a0-c6f26e80787c.md) | Gets the BuildingOperatingDaySchedule for this day of the year. |
...
|  | [SetScheduleForDay](904d2cfb-6f50-4922-8ee9-681dc6b5f73d.md) | Sets the BuildingOperatingDaySchedule for this day of the year. |
