...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.StructureStructuralConnectionApprovalType
...
```
```vb
Public Class StructuralConnectionApprovalType
...
```
```fsharp
type StructuralConnectionApprovalType = 
    class
        inherit ElementType
    end
```
...
The StructuralConnectionApprovalType type exposes the following members.
...
|  | [Create](909e20ae-e44f-095e-775d-604d9600de79.md) | Creates a new StructuralConnectionApprovalType. |
...
|  | [GetAllStructuralConnectionApprovalTypes](17a6b10f-a08b-0dab-8356-546f546146e7.md) |  |
...
|  | [IsValidApprovalTypeName](4efb1275-c310-a4ee-34b2-55f1a07d10c4.md) | Verifies if the provided approval name is unique in the document. |
