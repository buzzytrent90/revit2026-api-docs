...
# PanelScheduleViewGetLoadClassificationDemandLoad Method  
...
```
```vb
Public Function GetLoadClassificationDemandLoad ( 
	nRow As Integer,
	nCol As Integer
) As String
```
...
```
```fsharp
member GetLoadClassificationDemandLoad : 
        nRow : int * 
        nCol : int -> string 
```
...
String The Demand Load for the Load Classification 
