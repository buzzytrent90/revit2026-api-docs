...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalCableTraySizes
...
The CableTraySizes type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddSize](3911b16c-b0e0-7730-0190-53b89974d697.md) | Inserts a new MEPSize into the cable tray sizes. For cable tray, the nominal diameter of MEPSize is used . |
...
|  | [ClearAll](9be03014-448d-a06e-2b4c-6f8dafa914aa.md) | Removes all MEPSizes in the cable tray sizes. |
|  | [Contains](041d076f-979f-6a91-854a-8e8e56f7a2fd.md) | Checks whether a cable tray size with the nominal diameter exists. |
...
|  | [GetBasicIEnumerator](61619f00-44c0-9693-a553-a2b76465e7cb.md) | Returns an enumerator that iterates through a collection. |
|  | [GetCableTraySizes](ed9b68ba-8759-16ad-e8e7-7d2c363c2662.md) | Gets the cable tray sizes of the project. |
|  | [GetCableTraySizesIterator](a0aabc61-8f85-c9eb-c3ce-0026f4e5758d.md) | Returns a CableTraySizeIterator to the MEP cable tray sizes. |
...
|  | [GetEnumerator](decc5942-dc4a-7508-b82f-cd5fe5c12a65.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetSizeCount](3f140e73-ea0e-8d67-7061-63ff73d2de4c.md) | Gets the size count of the cable tray size table. |
...
|  | [RemoveSize](06e0062d-fe6d-84dc-839b-ed50b8054eb4.md) | Erases the existing MEPSize. For cable tray, the nominal diameter is used in MEPSize. |
