...
The [IExternalResourceUIServer](aee37f3f-98e9-79c6-e02d-1b07e3ffd89c.md) type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [GetDBServerId](7a58e7fb-d4ed-cb5b-3b3d-496b6be34bd7.md) | Implement this method to return the id of the server which is associated with this UI server. |
...
|  | [HandleBrowseResult](7a1805d4-0142-5162-4507-882ab705ab01.md) | Implement this method to handle results from browsing external resources in the UI. It is recommended that the server only respond in the case of a critical error. |
|  | [HandleLoadResourceResults](5a6b5313-eca3-8929-4fd2-750d924f06d7.md) |  |
