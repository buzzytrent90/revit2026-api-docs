...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBViewport
...
|  | [CanAddViewToSheet](1da33e38-255f-a27a-0626-9891d897b29a.md) | Verifies that the view can be added to the ViewSheet. |
...
|  | [Create](0f951f28-eb6b-2a37-668a-b248bfb7de97.md) | Creates a new Viewport at a given location on a sheet. |
...
|  | [GetBoxCenter](10a5ede6-0c97-79e0-a31a-2ffd90c7fc97.md) | Returns the center of the outline of the viewport on the sheet, excluding the viewport label. |
|  | [GetBoxOutline](034750ce-be6c-456b-7f3f-ee0ab5b5e2c0.md) | Returns the outline of the viewport on the sheet, excluding the viewport label. |
...
|  | [GetLabelOutline](dcc1b956-d611-2554-a040-da9ed1633c06.md) | Gets the outline viewport's label on the sheet. |
...
|  | [GetPositionAtViewAnchor](e5c279a1-b4e1-4bb2-6e62-2ba971bb16ae.md) | Gets the position coordinates at the ViewAnchor. |
|  | [GetProjectionToSheetTransform](3c55684a-b4fd-851e-3b32-6a3eb1e9eb3b.md) | Returns the transform from the view's projection space to the sheet space. |
...
|  | [HasViewportTransforms](474169c5-2e94-ed0b-95e2-851d96dd3723.md) | Indicates if the viewport has transforms. |
...
|  | [IsViewIdValidForViewport](9ab7aa51-8dce-bdda-10e5-7d2d3dfd09b2.md) | Verifies that the Viewport can change it's view id to the input %viewId%. |
...
|  | [SetBoxCenter](71734b96-6582-e6c5-674a-e6c092ced0f2.md) | Moves this viewport so that the center of the box outline (excluding the viewport label) is at a given point. |
...
|  | [SetViewAnchorAndPosition](d4ad4603-33b8-2c4f-b7e5-2c012a80d932.md) | Sets the ViewAnchor and position to Viewport. |
