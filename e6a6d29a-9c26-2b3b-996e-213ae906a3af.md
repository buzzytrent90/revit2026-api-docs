...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureAnalyticalElement [Autodesk.Revit.DB.StructureAnalyticalMember](57c87ac5-a82e-5c7e-2f06-6dbf1f697566.md) [Autodesk.Revit.DB.StructureAnalyticalSurfaceBase](9cad2b9c-a5d2-f434-2d9a-3c9183a55ada.md)
...
```
```vb
Public Class AnalyticalElement
	Inherits Element
```
```cpp
...
The AnalyticalElement type exposes the following members.
...
|  | [GetCurve](1eebc63e-4b20-a2a1-3537-283e2d284ee4.md) | Returns the curve of the Analytical Element. |
...
|  | [GetReference](9804934b-e6dd-3a0f-5994-30307fecca2d.md) | Returns a reference to a given curve within the Analytical Element. |
...
|  | [GetTransform](23e0c0f8-3f72-235e-0b1f-b977bbe5d697.md) | Returns the transform which reflects Analytical Element orientation. |
...
|  | [IsSingleCurve](b9d6eb46-2e7d-4501-004e-704b69600d1f.md) | Indicates if the Analytical Element can be expressed as a single curve. |
|  | [IsValidAnalyzeAs](98f5eb53-b973-3cdc-ebce-7f0ee16d1378.md) | Checks whether the value set for Analyze As is valid for an Analytical Element. |
|  | [IsValidSelector](9b076f25-113f-2c09-d63b-2d2a68082c9b.md) | Indicates if the input selector is valid for the Analytical Element. |
|  | [IsValidStructuralRole](c53f8bf2-a819-c1c8-890b-f2571c087549.md) | Checks whether the value set for Analytical Structural Role is valid for an Analytical Element. |
|  | [IsValidTransform](4c5b9a26-118a-d022-e2ff-bf9a2c4a9c3a.md) | Checks whether the value set for Local Coordinate System is valid for an Analytical Element. |
...
|  | [SetTransform](a36c9fe3-38ed-65f3-62c6-45c41e086edb.md) | Sets the transform of Analytical Element Local Coordinate System. |
