...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.AnalysisHVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md) Autodesk.Revit.DB.AnalysisHVACLoadBuildingType
...
```
```fsharp
type HVACLoadBuildingType = 
    class
        inherit HVACLoadType
    end
```


The HVACLoadBuildingType type exposes the following members.
...
|  | [Create](3dfb45e3-59e1-6543-1869-796c94b1965e.md) | Creates a building type element. |
...
|  | [IsNameUnique(String)](21117b1f-1cb9-e298-10b5-2425755b425a.md) | Determines whether a potential building type name is unique. |
|  | [IsNameUnique(Document, String)](f82bc870-072c-9780-bf35-c6fc4f798417.md) | Determines whether a potential building type name is unique. |
...
|  | [IsValidTime](e367b4dc-a8b1-fc4b-6e7b-bfff3d7dd2c9.md) | Check if the string can be parsed to a valid time for opening time and closing time. A valid string can be "16:30" or "4:30 PM"; |
