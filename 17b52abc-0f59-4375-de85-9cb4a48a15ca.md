...
# MetallicPaintMetallicpaintPearlIor Property  
...
```csharp
public static string MetallicpaintPearlIor { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintPearlIor As String
	Get
```
```cpp
public:
static property String^ MetallicpaintPearlIor {
	String^ get ();
}
```
```fsharp
static member MetallicpaintPearlIor : string with get
```
