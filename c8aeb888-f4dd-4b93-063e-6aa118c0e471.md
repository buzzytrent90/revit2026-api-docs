...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalElectricalLoadClassification
...
```
```fsharp
type ElectricalLoadClassification = 
    class
        inherit Element
    end
```
...
The ElectricalLoadClassification type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Abbreviation](0db5b2ff-f375-c8a9-135f-c611fa1e47af.md) | The abbreviation of the load classification name |
|  | [ActualElectricalLoadLabel](3fe33973-722e-d21f-b55c-7a997040ee74.md) | The name template for the actual load parameter on the load classification. |
...
|  | [DemandFactorId](ae578380-e6de-dea0-dfe3-27b2bb5a6bc3.md) | The demand factor definition this load classification element uses. |
...
|  | [LoadSummaryDemandFactorLabel](369f3896-80ec-fbe0-4d7b-72e27ff29ffa.md) | The name template for the demand factor parameter of the load classification. |
...
|  | [Motor](8c83c855-b589-df98-0f9a-d6942f10b01d.md) | Indicates if this load classification is to be used for motors. |
...
|  | [Other](d6202bbd-afec-3025-3c36-00e109cef646.md) | Indicates if it is the default load classification, and its name is Other. |
...
|  | [PanelConnectedCurrentLabel](6fba9d40-590f-3e3b-aaac-3a354d69c2a0.md) | The name template for the connected current parameter on the load classification. |
|  | [PanelConnectedLabel](4b4f489c-273a-cefd-dbca-10fc55710fad.md) | The name template for the connected load parameter of the load classification. |
|  | [PanelEstimatedCurrentLabel](c08bf3b3-a85f-e1b5-be75-a9635f46222f.md) | The name template for the estimated current parameter on the load classification. |
|  | [PanelEstimatedLabel](1d2a2be1-c058-ce8a-009b-8a896040ffba.md) | The name template for the estimated demand parameter on the load classification. |
...
|  | [SpaceLoadClass](514b8c66-dffc-aef1-cb67-0e2f52f9340f.md) | The electrical load class associated with a space. |
|  | [Spare](d838962d-bba2-9010-1540-e57e412948ac.md) | Indicates if this load classification is to be used for spare. |
...
|  | [Create](323c8700-09d4-badb-06e2-d126173b2f8a.md) | Creates a new instance of load classification and adds it to the document. |
