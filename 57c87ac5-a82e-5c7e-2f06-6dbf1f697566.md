...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.StructureAnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md) Autodesk.Revit.DB.StructureAnalyticalMember
...
type AnalyticalMember = 
    class
        inherit AnalyticalElement
    end
```


The AnalyticalMember type exposes the following members.
...
|  | [CrossSectionRotation](aaa42138-0ce6-4adc-992f-eb658d99aab9.md) | This represents the cross-section rotation, in radians. |
...
|  | [SectionTypeId](5e8a8f22-82e6-1a60-2ca1-bea0ea6a86a1.md) | The id of the type from the structural Family assigned to the Analytical Member. |
...
|  | [StructuralSectionShape](74d01c4a-9032-e740-2338-e9a8ec6711d5.md) | The structural section shape of the Analytical Member. |
...
|  | [CanSplit](adf06b4a-485e-9368-37ce-16c5785913c9.md) | Identifies whether a particular analytical member can be split at a point on it's defining curve (by [Split(Double)](cf3996cd-4987-b101-0806-bfa7b983a4c3.md) ). |
...
|  | [Create](97853ed7-4457-02cd-5ac3-f03d7d0dbc12.md) | Creates a new instance of an Analytical Member within the project. |
...
|  | [FlipCurve](b59e2918-471d-1e72-68fb-22fdc4ce7124.md) | Flip the Analytical Member |
|  | [GetCurve](1eebc63e-4b20-a2a1-3537-283e2d284ee4.md) | Returns the curve of the Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
...
|  | [GetMemberForces](5769b806-a243-f49d-b0d9-c0f793363cbf.md) | Gets the member forces associated with this Analytical Member. |
...
|  | [GetReference](9804934b-e6dd-3a0f-5994-30307fecca2d.md) | Returns a reference to a given curve within the Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [GetReleaseConditions](95da8025-e532-bbfa-3e5a-564c2710e8d3.md) | Gets the release conditions associated with this Analytical Member. |
|  | [GetReleaseType](3cd5237d-bef2-7a12-f0e3-43318820f75a.md) | Gets the release type. |
...
|  | [GetTransform](23e0c0f8-3f72-235e-0b1f-b977bbe5d697.md) | Returns the transform which reflects Analytical Element orientation. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
...
|  | [IsSingleCurve](b9d6eb46-2e7d-4501-004e-704b69600d1f.md) | Indicates if the Analytical Element can be expressed as a single curve. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [IsValidAnalyzeAs](98f5eb53-b973-3cdc-ebce-7f0ee16d1378.md) | Checks whether the value set for Analyze As is valid for an Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [IsValidCurve](a3087787-403a-556a-ca27-05ee9caf465d.md) | Verifies if the curve is valid for an Analytical Member. |
|  | [IsValidSectionTypeId](21bdce0b-2f56-3b30-6ce3-3702c9b0387e.md) | Checks whether the family symbol id is allowed for Analytical Member as Section Type property. |
|  | [IsValidSelector](9b076f25-113f-2c09-d63b-2d2a68082c9b.md) | Indicates if the input selector is valid for the Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [IsValidStructuralRole](c53f8bf2-a819-c1c8-890b-f2571c087549.md) | Checks whether the value set for Analytical Structural Role is valid for an Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [IsValidTransform](4c5b9a26-118a-d022-e2ff-bf9a2c4a9c3a.md) | Checks whether the value set for Local Coordinate System is valid for an Analytical Element. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
...
|  | [SetCurve](a1808afa-ba67-381b-ea28-4e8b2d9e5516.md) | Sets the curve for the Analytical Member. |
...
|  | [SetReleaseConditions](79296d6b-51bd-d92c-ddb4-26689c76cc76.md) | Sets Release Conditions to Analytical Member. |
|  | [SetReleaseType](41b94d8b-c36b-d3bf-f76e-56e66ea3b19a.md) | Sets the release type. |
|  | [SetTransform](a36c9fe3-38ed-65f3-62c6-45c41e086edb.md) | Sets the transform of Analytical Element Local Coordinate System. (Inherited from [AnalyticalElement](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md)) |
|  | [Split](cf3996cd-4987-b101-0806-bfa7b983a4c3.md) | Splits the analytical member at a point on its defining curve. |
