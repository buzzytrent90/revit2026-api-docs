...
Public Function Intersect ( 
	face As Face,
	<OutAttribute> ByRef result As Curve
...
member Intersect : 
        face : Face * 
        result : Curve byref -> FaceIntersectionFaceResult 
```
...
result [Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)
    A single Curve representing the intersection.

#### Return Value

[FaceIntersectionFaceResult](dafc9c77-f17a-1ad8-0bcb-422b4309ee43.md)
...
| Exception | Condition |
| --- | --- |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | The face is . |
