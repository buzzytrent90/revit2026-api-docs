...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisEnergyAnalysisWindowType
...
```
```vb
Public Class EnergyAnalysisWindowType
	Inherits Element
```
```cpp
...
The EnergyAnalysisWindowType type exposes the following members.
...
|  | [Description](bbca8f19-4d5e-1b6f-7366-b6d5322aaa5d.md) | The description of the window type. |
...
|  | [HeatTransferCoefficient](bd9fa292-8578-7f79-27e1-c9ea2eb4d387.md) | The heat transfer coefficient value (U-value) of the window type, in W/(m^2*K) (equivalent to kg/(k*s^3)). |
...
|  | [IsSchematic](1b319cfa-8840-d8ab-1c56-f51883077b2f.md) | Indicates if this originates from a schematic or analytical construction. |
...
|  | [SolarHeatGainCoefficient](fc1f4e33-b633-ef35-8683-9c4480b1f640.md) | The solar heat gain coefficient (SHGC-value) for the window type, from 0.0 to 1.0. |
|  | [Transmittance](c5020760-7c5e-0169-c0aa-b7de93e86a6a.md) | The visual light transmittance value (VLT-value) for the window type, from 0.0 to 1.0. |
...
|  | [WindowTypeName](1b64102a-91e8-e9cd-d027-60cfbe614b04.md) | The name of the window type. |
...
|  | [GetSolarHeatGainCoefficientsForSolarIndicientAngles](92ef74d2-14ac-a155-4f64-120ef770c68e.md) | Returns a map with solar heat gain coefficients (SHGC-values) for specific incident angles for the window type. |
