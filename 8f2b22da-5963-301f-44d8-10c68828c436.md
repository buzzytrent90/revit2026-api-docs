...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBNumberingSchema
...
|  | [MaximumStartingNumber](f7a8b906-ee60-2a71-bc1a-30fa81b4f299.md) | A static property defining the maximum number a numbering sequence can use as its starting number (the lowest number in the sequence). |
...
|  | [NumberingParameterId](94659f29-c7f2-9643-f443-9451a3177cc2.md) | Id of the parameter that stores values of the numbers on enumerated elements. |
...
|  | [SchemaType](6c9d8ec5-3622-95ca-e3dc-c663f0a3b155.md) | Identifies the kind of elements/objects this numbering schema is used for. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AppendSequence](0a89ca78-ca34-93fa-4fa7-71883a535497.md) | Appends all elements of one numbering sequence to the end of another sequence. |
...
|  | [AssignElementsToSequence](fd765b3c-368b-cf14-6bb0-b772f503370f.md) |  |
...
|  | [ChangeNumber](dc93cd7f-dc11-45da-3ed6-c459d1c55c97.md) | Replaces an existing number with a new one (that does not exist yet). |
...
|  | [GetMinimumNumberOfDigits](80ac3f63-6383-ba62-380f-0e61b98e8dd7.md) | Returns the minimum number of digits to be used for formating the Number parameter of all enumerable elements of the given document. |
...
|  | [GetNumberingSchema](fb3e529c-bccd-40fb-c24d-c5de5296edea.md) | Returns an instance of the specified Numbering Schema in the given document. |
|  | [GetNumberingSequences](0eea26e0-24c0-154b-b7ac-c24b47eafa96.md) | Returns all numbering sequences within this numbering schema. |
|  | [GetNumbers](3153106d-9f77-eb5d-20af-cd651e91b640.md) | Returns all numbers currently used in the given numbering sequence |
...
|  | [GetSchemasInDocument](9bd7a9f5-49af-1d41-9f55-932723b7023e.md) | Returns a set of Ids of all Numbering Schema elements for a given document. |
...
|  | [IsValidPartitionName](a250660a-5dcb-47a6-1960-e3750fd4df8a.md) | Tests if the given string can be used as a name for a numbering partition. |
...
|  | [MergeSequences](45697dc7-68b2-4fa8-1bea-8f65983f23a0.md) |  |
|  | [MoveSequence](9ae38f60-e76f-5bd7-1d71-bd57cf06f641.md) | Moves all elements of a numbering sequence from one partition to another. |
...
|  | [RemoveGaps](a97a1aff-4afe-7aa7-098a-f71229efdccd.md) | Removes gaps, if any, in a numbering sequence |
...
|  | [SetMinimumNumberOfDigits](5b78eda1-9ad6-9c9d-bfe4-bdb6752c262f.md) | Sets a new value for the minimum number of digits to be used for formating the Number parameter of all numbered elements of the given document. |
|  | [ShiftNumbers](8962e7e3-0860-acd5-c488-d8f93867b1c1.md) | Shifts all numbers in the sequence so the starting number has the given value. |
