...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) [Autodesk.Revit.DBMEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md) Autodesk.Revit.DB.ElectricalWire
...
|  | [ConnectorManager](5498400a-b28b-786d-170e-383cc0e67875.md) | The connector manager of this MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
...
|  | [Diameter](ef86c674-b088-40b1-0b28-3b91a01c7b30.md) | The diameter of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
...
|  | [GroundConductorNum](77c42cca-7a15-32a2-3a4e-172cb533a022.md) | The ground conductor number. Its default value is zero after created. |
...
|  | [Height](c8613f87-19b6-69e1-290c-53c0420cf9eb.md) | The height of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
|  | [HotConductorNum](8aee795d-931b-c13a-e4d5-bca5b01b724b.md) | The hot conductor number. Its default value is zero after created. |
...
|  | [LevelOffset](de6ae69a-d462-80c9-58e0-ea5bac2a1447.md) | The offset of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
...
|  | [MEPSystem](ad663cce-bb05-70bf-33f5-b3d32f9e9b62.md) | The system of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
...
|  | [NeutralConductorNum](e1410036-e4b6-2677-b354-2d860cba3c31.md) | The neutral conductor number. Its default value is zero after created. |
|  | [NumberOfVertices](a3396437-4d65-df7f-9400-97e5f69c0d0a.md) | The number of vertices of the wire, including the start and end point. |
...
|  | [ReferenceLevel](3d7248c5-558d-60ba-42da-c3b46d35f1cd.md) | The reference level of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
...
|  | [Width](978bbf62-3cba-1580-8080-61888b92b55d.md) | The width of the MEP curve.(Inherited from [MEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md)) |
|  | [WiringType](7a670559-0af9-8ed0-eee7-4afdff667b15.md) | The wiring type(arc or chamfer) for the wire. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AppendVertex](fd3b4f99-3178-a3f9-c88d-2fd1a0a34fc5.md) | Appends one vertex to the end of the wire. |
...
|  | [AreVertexPointsValid](fd5fb218-eecf-c670-2907-59f5446a866c.md) |  |
...
|  | [ConnectTo](a008dc1e-81a9-8e1c-cc9e-c014a68c2bd9.md) | Connects the wire to other elements. |
|  | [Create](748caa8a-5792-91bf-dd3c-b62beba5efd3.md) |  |
...
|  | [GetMEPSystems](8c5df7ee-4ee6-50d5-ca5a-70dcd6f6961f.md) | Gets the systems to which the wire belongs. |
...
|  | [GetVertex](e9fbd76e-e1b8-4d11-2368-27998769bc19.md) | Gets the position of an existing vertex. |
...
|  | [InsertVertex](998dbada-2ac1-72e7-c7b7-603492e83642.md) | Inserts a new vertex before the specified index. |
...
|  | [IsVertexPointValid](fbb3ef78-b28c-9637-b995-b03e461bc9a4.md) | Checks if the given vertex point can be added to this wire. |
...
|  | [RemoveVertex](0d16213b-1098-6ca9-1e2b-70068f619ae8.md) | Removes the vertex corresponding to the specified index. Can not remove the start or end vertex if it already connects to other element. |
