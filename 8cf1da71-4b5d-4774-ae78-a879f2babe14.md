...
# MetallicPaintMetallicpaintBaseHighlightspread Property  
...
```csharp
public static string MetallicpaintBaseHighlightspread { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintBaseHighlightspread As String
	Get
```
```cpp
public:
static property String^ MetallicpaintBaseHighlightspread {
	String^ get ();
}
```
```fsharp
static member MetallicpaintBaseHighlightspread : string with get
```
