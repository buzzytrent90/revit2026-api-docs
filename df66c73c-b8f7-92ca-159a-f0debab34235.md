...
# PipingSystemTypeSingleLineJunctionRiseType Property  
...
```
```vb
Public Property SingleLineJunctionRiseType As RiseDropSymbol
	Get
	Set
```
```cpp
public:
property RiseDropSymbol SingleLineJunctionRiseType {
	RiseDropSymbol get ();
	void set (RiseDropSymbol value);
}
```
```fsharp
member SingleLineJunctionRiseType : RiseDropSymbol with get, set
```
