...
# ApplicationIsPipingAnalysisEnabled Property  
...
```
```vb
Public Property IsPipingAnalysisEnabled As Boolean
	Get
	Set
```
```cpp
public:
property bool IsPipingAnalysisEnabled {
	bool get ();
	void set (bool value);
}
```
```fsharp
member IsPipingAnalysisEnabled : bool with get, set
```
