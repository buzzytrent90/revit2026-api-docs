...
An enumerated type listing special types that can appear in an [ExportLayerTable](e68ce1c7-a922-d1b7-53bb-f832a4bad273.md). These types do not represent an independent category in Revit, but can be mapped to specific layers on export. 
