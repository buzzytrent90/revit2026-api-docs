...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ArchitectureTopographyLinkType
...
```
```vb
Public Class TopographyLinkType
...
The TopographyLinkType type exposes the following members.
...
|  | [Reload](5ef11069-e94e-c1f5-246e-73d43b0cf673.md) | Loads or reloads the link from its currently-stored location. If the link is an external resource, Revit will contact the IExternalResourceServer to get the latest version of the link. |
