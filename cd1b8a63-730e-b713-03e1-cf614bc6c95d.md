...
# StructuralSectionIWeldedBottomFlangeThickness Property  
...
```
```vb
Public Property BottomFlangeThickness As Double
	Get
	Set
```
```cpp
public:
property double BottomFlangeThickness {
	double get ();
	void set (double value);
}
```
```fsharp
member BottomFlangeThickness : float with get, set
```
