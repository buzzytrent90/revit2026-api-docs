...
```csharp
public static string TileVerticalGap { get; }
```
```vb
Public Shared ReadOnly Property TileVerticalGap As String
	Get
```
```cpp
public:
static property String^ TileVerticalGap {
	String^ get ();
}
```
```fsharp
static member TileVerticalGap : string with get
```
