...
# ViewScheduleBodyTextTypeId Property  
...
```
```vb
Public Property BodyTextTypeId As ElementId
	Get
	Set
```
```cpp
public:
property ElementId^ BodyTextTypeId {
	ElementId^ get ();
	void set (ElementId^ value);
}
```
```fsharp
member BodyTextTypeId : ElementId with get, set
```
