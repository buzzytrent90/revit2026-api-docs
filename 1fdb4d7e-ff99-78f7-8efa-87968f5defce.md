...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalPanelScheduleSheetInstance
...
```
```cpp
public ref class PanelScheduleSheetInstance : public Element
```
```fsharp
type PanelScheduleSheetInstance = 
    class
        inherit Element
    end
```
...
The PanelScheduleSheetInstance type exposes the following members.
...
|  | [Origin](e22ecee3-e31b-c04f-c176-50496c8c2865.md) | The sheet instance offset in drawing sheet coordinates. |
...
|  | [ScheduleId](ac8663cf-52bf-f4f4-b457-4f1b443f6840.md) | The panel schedule id. |
...
|  | [Create](fbf7861e-0b5e-3c66-56e1-87a18a28858b.md) | Creates a new instance of panel schedule on sheet and adds it to the document. |
...
|  | [GetSchedule](13e276fc-7ce3-ec0e-2667-6f8c38cd3865.md) | Gets the panel schedule view. |
...
|  | [SplitSegment](586f7208-319a-7101-3e6d-ba01dfcba1c5.md) | Split the panel schedule into Thrown if the index is out of bounds. |
