...
SystemObject [Autodesk.Revit.DBBaseImportOptions](75898e94-cff4-fb64-c613-9596599444c4.md) Autodesk.Revit.DBSTEPImportOptions

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class STEPImportOptions : BaseImportOptions
```
```vb
Public Class STEPImportOptions
	Inherits BaseImportOptions
```
```cpp
public ref class STEPImportOptions : public BaseImportOptions
```
```fsharp
