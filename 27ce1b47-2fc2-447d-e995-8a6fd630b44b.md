...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBCurveElement](61673852-2d08-003d-e9fd-4be89d533774.md) Autodesk.Revit.DB.StructureAreaReinforcementCurve
...
```
```vb
Public Class AreaReinforcementCurve
...
The AreaReinforcementCurve type exposes the following members.
...
|  | [Curve](301bf966-bbf1-62b2-fed5-6703e55aeb57.md) | Returns the 3D curve forming part of the boundary of an Area Reinforcement element. |
