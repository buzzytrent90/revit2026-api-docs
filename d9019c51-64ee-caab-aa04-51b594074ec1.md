...
# MaterialSurfaceForegroundPatternColor Property  
...
```
```vb
Public Property SurfaceForegroundPatternColor As Color
	Get
	Set
```
```cpp
...
```
```fsharp
member SurfaceForegroundPatternColor : Color with get, set
```
