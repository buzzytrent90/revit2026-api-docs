...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalPanelScheduleTemplate
...
The PanelScheduleTemplate type exposes the following members.
...
|  | [IsBranchPanelSchedule](6c9ef6ab-a248-040f-f717-a0a8fc9b74f2.md) | Checks to see if this object is branch panel schedule template element. |
|  | [IsDataPanelSchedule](065e52f3-c115-160a-c681-51e5a78e956b.md) | Checks to see if this object is data panel schedule template element. |
|  | [IsDefault](06c3a815-be62-eb35-d3cd-cda4e948adbf.md) | Checks to see if this is default template for the given panel schedule type. |
...
|  | [IsSwitchboardSchedule](30f565e3-fb0a-9738-ce07-cf07d679b032.md) | Checks to see if this object is switchboard schedule template element. |
...
|  | [CopyFrom](9d71d5fd-d9bb-dd85-d58d-709e089e9d2b.md) | Copies all values from other element to this object. |
|  | [Create](e8890707-6930-e739-1f09-8690885410de.md) | Creates a new instance of a panel schedule template. |
...
|  | [GetPanelScheduleType](8a9ee9e3-1d73-d65a-517a-014f43ba1b22.md) | Returns the panel schedule type. |
...
|  | [GetSectionData](232a1d1e-9112-362c-7539-4ce3b68689b9.md) | Gets the writable section data object. |
...
|  | [GetTableData](0e1fec60-7429-5eba-b2a4-25ac0439e3c5.md) | Gets the writable table data object. |
...
|  | [HasSameType](03c9e112-1fb3-5e42-1114-e99555cd1bfd.md) | Checks if given template has the same panel schedule type with this template. |
...
|  | [IsValidPanelConfiguration](d665ea95-a150-8f0b-43bf-6894bb9c0f5d.md) | Checks if given panel configuration is valid for given panel schedule type. |
...
|  | [SetTableData](130f4d8a-fdbf-f00c-7f6f-6638fe37c48b.md) | Assigns table data to this template |
