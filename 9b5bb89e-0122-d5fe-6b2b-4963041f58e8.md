...
SystemObject Autodesk.Revit.DBBuiltInFailuresMEPCalculationFailures
...
```
```vb
Public NotInheritable Class MEPCalculationFailures
```
```cpp
public ref class MEPCalculationFailures abstract sealed
```
```fsharp
[<AbstractClassAttribute>]
[<SealedAttribute>]
type MEPCalculationFailures = class end
```
...
|  | Name | Description |
| --- | --- | --- |
|  | [AtLeastOneEquipmentOnDuty](44b6cb71-efa9-41a4-3c8e-984614f3a087.md) | There should be at least one equipment on duty. |
|  | [ClassificationNotSetInFamily](8d4975fa-4175-57d2-515b-e759bf8b10ff.md) | A calculation did not complete because the Classification parameter in the Mechanical Equipment family is not set. |
|  | [DemandFlowNotSetInLossFamily](7e7817ea-20d4-1293-3040-41685341d2c1.md) | A calculation did not complete because the Demand Flow for the element is not set. |
|  | [DuctFittingAndAccessoryPressureDropCalculatorNotAvailable](2acb16b3-41f7-a33c-59f6-89204b83834d.md) | Duct Fitting/Accessory Pressure Drop Calculator Not Available: [Calculator Name] |
|  | [DuctPressureDropCalculatorNotAvailable](514f9505-3fb9-922a-7652-37ccfb7112c8.md) | Duct Pressure Drop Calculator Not Available: [Calculator Name] |
|  | [ExtraPumpSet](e02d38b3-ba09-1cba-d355-60ba43e0beb4.md) | More than one parallel pump set defined for the same loop. Verify the flow distribution and delete the extra set, if desired. |
|  | [FlowAndPressureCalculationMethodHasBeenImproved](68dde6ef-ad0a-e53c-b0ce-3a4061528c5f.md) | During upgrade pressure drop calculations for hydronic piping systems using Simplified Colebrook or Custom Calculation methods have been recalculated using the Colebrook equation. |
|  | [HydraulicSeparationAmbiguity](bf4579b9-bc4a-c61c-8224-c97c7e12f520.md) | Unable to hydraulically separate until the system has flow. |
|  | [HydraulicSeparationOfOneSystem](9ca4a886-0717-4877-43e3-f88933b66e22.md) | Unable to hydraulically separate the loop when both supply and return are assigned to the same system. Try again with both start and end selected. |
|  | [InvalidFluidProperty](dd949dc1-85a1-0b87-81df-100b9cf86ae8.md) | Some network components may have a flow value of 0 (zero), due to invalid value settings for fluid Dynamic Viscosity or Density. \nVerify that you have selected the correct fluid type and that the fluid Dynamic Viscosity and Density values are set correctly in the Mechanical Settings dialog. |
|  | [InvalidNumberOfMechanicalEquipmentOnDuty](e30ce807-0690-2445-1a4c-cb7915c1b537.md) | The number of on duty equipment must be less than or equal to the number of available equipments. |
|  | [LoopSeparationNotCompleted](3c311432-e04e-73f9-8b9f-0d50d9e27876.md) | The loop separation is not completed yet. Only one side of the secondary/tertiary loop is separated. In order to correctly calculate the flow and pressure loss, please check and separate the other end of the loop. |
|  | [MechanicalEquipmentSetBeingDeleted](2f92b4ae-afdc-6342-7a6f-96329238b1f4.md) | The mechanical equipment set was deleted because it no longer contained any members. |
|  | [Network_ElementNodeIsNotPartOfNetwork](828d0861-9b99-1092-4828-215847d82b85.md) | The calculation could not be executed as configured. At least one of the elements in this network uses a node that is not part of the network. |
|  | [Network_NodePropertyNotSet](de28ea85-85f1-97a1-dbf9-8d6da345036e.md) | The calculation could not be executed as configured. Specify a constraint property set for the following input or output node(s). |
|  | [Network_NoInputNode](9d63b356-60a3-23aa-fd83-4578fc426455.md) | The calculation could not be executed as configured. Select an input node before analyzing this network. |
|  | [Network_NoOutputNode](bb920964-5fdc-52eb-bc09-79c4fe19c246.md) | The calculation could not be executed as configured. Select an output node before analyzing this network. |
|  | [Network_NoPressureConstraint](d53ea3c7-3d55-c572-d1cc-9b6c3bfe2278.md) | The calculation could not be executed as configured. Each network requires at least 1 pressure constraint. Specify the pressure constraint. |
|  | [Network_NotEnoughElements](cb720bf6-8ecc-6c86-1984-0f1318185842.md) | The calculation could not be executed as configured. Specify at least 3 elements before analyzing this network. |
|  | [Network_NotEnoughNodes](4155e6c4-64c7-ecfc-d6db-176188b18e42.md) | The calculation could not be executed as configured. Specify at least 4 elements before analyzing this network. |
