...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ElectricalAreaBasedLoadType
...
```
```vb
Public Class AreaBasedLoadType
	Inherits Element
```
```cpp
...
The AreaBasedLoadType type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [ApparentPowerDensity](cf56443e-b4d5-9fcf-9c44-a818249b9dca.md) | The apparent power density of area based load type. |
...
|  | [LoadClassification](fd08a05b-e697-a519-60f8-e40a888e5bcb.md) | The load classification of area based load type. |
|  | [LoadDensity](c5e2214a-d88b-11aa-e981-301abed3ff5e.md) | The load density of area based load type. |
...
|  | [PowerFactor](95c6a466-e821-2afb-aa44-d95f76c788b3.md) | The power factor of area based load type. |
|  | [PowerFactorState](371aab79-5676-a131-7021-439165a9424e.md) | The power factor state of the area based load type. |
...
|  | [Create](86fa33e2-d5d1-7b74-13db-7f0f2de389a6.md) | Creates an area based load type. |
