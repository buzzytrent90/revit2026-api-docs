...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.StructureAreaReinforcementType
...
```
```vb
Public Class AreaReinforcementType
...
The AreaReinforcementType type exposes the following members.
...
|  | [CreateDefaultAreaReinforcementType](451102b4-f55e-df96-a1b3-4f6e968f47ca.md) | Creates a new AreaReinforcementType object with a default name. |
