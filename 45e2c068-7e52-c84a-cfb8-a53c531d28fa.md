...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ArchitectureStairs
...
|  | Name | Description |
| --- | --- | --- |
|  | [ActualRiserHeight](d3e335fe-ab3e-118b-156a-db30067ad523.md) | The actual height of the stairs risers in the stairs. |
|  | [ActualRisersNumber](8a74a295-99ff-1a98-c0e5-cb84d86fed07.md) | The total number of actually created risers in model. |
|  | [ActualTreadDepth](a29b78ff-5359-ff5f-c742-889e8f50eaa8.md) | The actual depth of the stairs treads in the stairs, actual tread depth is equal to minimum tread depth by default. |
|  | [ActualTreadsNumber](224855f5-eb2b-84bc-864a-a3819cdf855c.md) | The number of treads actually created in the stairs. |
...
|  | [BaseElevation](c53902d6-e634-b052-6327-2fcad8939807.md) | The base elevation of the stairs. |
...
|  | [DesiredRisersNumber](a595b61c-47d2-0194-a4c6-5945c6bb591b.md) | The number of risers is calculated based on the height between levels. |
...
|  | [Height](252de077-e133-070a-cb90-7737bf0f445d.md) | The height of the stair between the base and top levels. |
...
|  | [MultistoryStairsId](c355cbe0-14d8-4644-97cc-14afde78a975.md) | The id of the MultistoryStairs element to which this element belongs. If this stairs element is not a member of a MultistoryStairs element, this will be InvalidElementId. |
...
|  | [NumberOfStories](f8ac077d-035b-38d2-f669-642b6ae8c139.md) | The number of stories of a multi-story stair, or 1 for a single-story stair. |
...
|  | [TopElevation](da7ad5d7-c683-a974-7a95-757c8c4367db.md) | The top elevation of the stairs. |
...
|  | [GetAssociatedRailings](e4907577-c0b1-fd40-3ae5-99f6b2d2558d.md) | Gets a list of the Railing elements which are associated to the boundaries of the stairs. |
...
|  | [GetStairsLandings](675ad372-825f-7e26-d2ed-147abc85f726.md) | Returns all the stairs landing components in the stairs. |
|  | [GetStairsRuns](a8812cc1-6ba7-7908-bea6-92e5bcb19627.md) | Returns all the stairs run components in the stairs. |
|  | [GetStairsSupports](25cddd3f-315f-7648-b87d-a12107613cde.md) | Returns all the stairs support components in the stairs. |
...
|  | [IsByComponent](a2a67884-d354-3e11-14e6-8dc6a1d06a5b.md) | Indicates if the stairs is created by stairs components(runs, landings and supports). |
...
|  | [IsInEditMode](06d379fb-9d56-e9a1-909d-152194599997.md) | Indicates whether the stairs is in edit mode or not. |
