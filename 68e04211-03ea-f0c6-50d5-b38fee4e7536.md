...
# CompoundStructureGetNumberOfShellLayers Method  
...
There could be no core layers. You can change the shell/core layer boundary using [SetNumberOfShellLayers(ShellLayerType, Int32)](8b8ea4e3-e697-6176-92c0-dc2687723a71.md). 
