...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBDirectShape
...
|  | Name | Description |
| --- | --- | --- |
|  | [ApplicationDataId](e755cb13-e327-da62-5748-23b976c1bac0.md) | A text string that identifies the data to the creating application. |
|  | [ApplicationId](e4d69298-2138-d7f7-35eb-4519452a3438.md) | A text string that identifies the creating application. |
...
|  | [TypeId](349629c7-eb65-d4bd-801b-115e1a52878d.md) | Element id of a DirectShapeType object that holds properties to be shared by this element. Optional. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddExternallyTaggedGeometry](2c551429-8b90-ed46-3e29-a6b3dbc1cb95.md) | Adds the externally tagged geometry object to the DirectShape. |
...
|  | [AddReferencePoint(XYZ)](76610683-c067-3981-af51-47bb90e0f22e.md) | Adds a reference point to the DirectShape. |
|  | [AddReferencePoint(XYZ, DirectShapeReferenceOptions)](18f765f4-0e13-b5eb-2d27-b486f93d8908.md) | Adds a reference point to the DirectShape. |
|  | [AppendShape(IListGeometryObject)](c4ab9ba7-2507-2b4a-f660-8e8337212644.md) |  |
...
|  | [AppendShape(IListGeometryObject, DirectShapeTargetViewType)](d56956bb-c2ec-8504-fb6a-717e26e1f891.md) |  |
|  | [AreOptionsValid](d613f35a-83ad-cc32-25a9-449b9ba04723.md) | Validates that the given DirectShapeOptions are allowed for this particular DirectShape. |
|  | [AreOptionsValidForTransientDirectShape](83b95bbf-6e6d-25ab-053b-441447ac389f.md) | Validates that the given DirectShapeOptions are allowed if this DirectShape is transient. |
...
|  | [AreValidDirectShapeReferenceOptions](eaa7ecd1-5a5b-2df4-8fbb-f1a890a2b41a.md) | Validates that the input DirectShapeReferenceOptions are suitable for creating a direct shape reference object. If the options specify an ExternalGeometryId, it must not correspond to any existing reference object belonging to the DirectShape. |
...
|  | [CanCreateParts](00584d60-2960-36ab-f305-d2f4dda220f8.md) | Indicates if it is possible to create parts from this DirectShape element. |
...
|  | [CreateElement](bee8a24f-704e-44d9-e187-9e031548a6d2.md) | Creates a DirectShape object and adds it to document. |
|  | [CreateElementInstance](2a44c4e3-5056-eb56-f849-a7e9dcc478da.md) | Creates a DirectShape object and adds it to document. |
|  | [CreateGeometryInstance](8a5a08cc-14ea-9c69-26b4-5f1b0562bf53.md) | Creates a copy of a definition shape that was created earlier. |
...
|  | [GetExternallyTaggedGeometry](a32792d0-1633-37c5-6ed0-02bdb9b6c4b5.md) | Gets the externally tagged geometry by its external ID that is stored in this DirectShape. |
|  | [GetExternallyTaggedReference](22cf5a24-787e-ced2-daa4-8f23d1f2b96b.md) | Retrieve a Reference to reference geometry of the DirectShape that is associated with a particular ExternalGeometryId. |
...
|  | [GetOptions](2bc77946-040e-7c75-0258-373adb8d2966.md) | Gets a copy of the current options for this DirectShape. |
...
|  | [HasExternalGeometry](e17297d9-8bc9-2408-515d-2e9058e4fb5c.md) | Checks whether the externally tagged geometry is already present in this DirectShape. |
|  | [HasExternallyTaggedReference](98a5037a-d40a-4073-30f1-f230982f7456.md) | Checks if the externally tagged reference is already present in this DirectShape. |
...
|  | [IsSupportedDocument](8651e9ac-f5cf-840b-d271-c8db2a244377.md) | Tests whether a DirectShape or a DirectShapeType may be created in this document. |
|  | [IsValidCategoryId](c8881d31-d410-842a-1375-5ba688191cf8.md) | Test the category id to make sure the category is allowed for a DirectShape or DirectShapeType. |
|  | [IsValidGeometry](bd083561-a6e1-605e-14ce-cfe07598f3f6.md) | Validates geometry to be stored in a DirectShape. Suitable geometry validation is performed. Additionally, the geometry must make sense as a shape representation for the category assigned to this DirectShape object. |
|  | [IsValidReferenceCurve](af56ade3-831a-b432-c39e-bafbfed03e63.md) | Validates that the input curve is suitable for creating a direct shape reference curve. Bounded and unbounded lines are accepted. Other bounded and unbounded curve types with natural bounds are accepted if they are not closed. Unbounded periodic curves are not allowed. |
|  | [IsValidReferencePlaneBoundingBoxUV](fa8aa1c6-5bf2-ee0f-c264-509e53ac05b2.md) | Validates that the input BoundingBoxUV is suitable for bounding a reference plane surface. The input BoundingBoxUV must be set and not degenerate. |
...
|  | [IsValidTypeId](3720858e-aa72-b1b8-a9e6-7f6dc5a83a76.md) | Tests the type id to make sure it satisfies the following conditions |
...
| [IsValidUsage](66c74377-1553-5b90-45d7-14f24a53eede.md)|  Validates that the ExternallyTaggedGeometryObject's usage is set to an allowed value for a DirectShape.   
...
| [RemoveAllReferenceObjects](33cfa8d2-806e-8ba0-ac10-f317ed42da6a.md)|  Removes all reference objects (if any) from the DirectShape.   
| [RemoveExternallyTaggedGeometry](f25a46b4-5eb7-f503-1599-bfb3b549d632.md)|  Removes the externally tagged geometry object by its external ID from this DirectShape.   
...
| [ResetExternallyTaggedGeometry](c209aeeb-03c9-9dbb-6b85-dd7e26188c5c.md)|  Removes all of the externally tagged geometry in this DirectShape.   
...
| [SetName](9ff002c5-3197-9feb-bd85-a497ad2c6f14.md)|  Sets the name for the DirectShape element.   
| [SetOptions](a7163c75-af77-624c-ca60-e5271827c03f.md)|  Sets the options to use for this DirectShape.   
...
| [SetTypeId](077e58a6-977e-be35-6e20-dd07daa1fdd0.md)|  Sets the DirectShapeType for the DirectShape element.   
| ToString| Returns a string that represents the current object.(Inherited from Object)  
|  | [UpdateExternallyTaggedGeometry](c15c6964-0514-7c53-fdf0-9900ec68636f.md) | Updates the externally tagged geometry object in the DirectShape. |
