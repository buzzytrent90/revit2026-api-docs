...
# RebarContainerItemHasPresentationOverrides Method  
...
Default presentation settings can be overriden using [SetBarHiddenStatus(View, Int32, Boolean)](0310106a-d8a1-0dd9-fcbe-272b7e231d52.md), [SetPresentationMode(View, RebarPresentationMode)](686fc4e7-a053-fafd-affe-61b6018e9634.md) methods 
