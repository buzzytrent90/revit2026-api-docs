...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBViewNavigationToolSettings
...
```
```fsharp
type ViewNavigationToolSettings = 
    class
        inherit Element
    end
```
...
The ViewNavigationToolSettings type exposes the following members.
...
|  | [GetHomeCamera](dadadb67-e2f8-f2f4-0346-742cea12452f.md) | Gets a copy of the structure containing information about the store Home view orientation. |
...
|  | [GetViewNavigationToolSettings](bf17eb5d-094d-208a-28c9-048edbb41601.md) | Gets the instance of the settings for the given document. |
...
|  | [IsHomeCameraSet](0aed2fda-abf9-eb16-7832-1e211cd13a0f.md) | Checks if the home view is set in the settings. |
