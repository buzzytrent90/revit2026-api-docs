...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureStructuralConnectionSettings
...
```
```vb
Public Class StructuralConnectionSettings
	Inherits Element
```
```cpp
...
```
```fsharp
type StructuralConnectionSettings = 
    class
        inherit Element
    end
```
...
The StructuralConnectionSettings type exposes the following members.
...
|  | [IncludeWarningControls](401729b1-e312-6b68-ada6-7f813cb4ef42.md) | This property controls how Structural Connection Element is generated. If set to true and warnings are reported for given Element, additional yellow triangle is displayed. |
...
|  | [GetStructuralConnectionSettings](58eaed43-a72c-2bf8-3926-0d7c8040e85b.md) | Obtains the StructuralConnectionSettings object for the specified project document. |
