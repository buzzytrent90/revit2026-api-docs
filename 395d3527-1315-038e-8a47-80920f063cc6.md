...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBComponentRepeaterSlot
...
The ComponentRepeaterSlot type exposes the following members.
...
|  | [FamilyType](a838e63a-c320-8536-6d16-f174d25b7fd5.md) | The id of the family type of the component in the slot, or invalid id if the slot is empty. |
...
|  | [IsDefault](74f08994-5ee8-a7a5-a1e1-6632f1176b06.md) | A flag indicating whether the slot currently holds an instance of the default family type of the component repeater. |
|  | [IsEmpty](083c8dcf-61be-2182-90f3-bdcb62c70302.md) | A flag indicating whether the slot is currently empty. |
...
|  | [IsTypeValidForSlot](26db1b51-32b3-5535-7c3e-74bae8462fcb.md) | Determines whether instance of given family type can be used in the component repeater slot. |
...
|  | [MakeDefault](1f0c0f01-6fdf-5a5c-1498-f062a2d32c25.md) | Populates the slot with an instance of the default family type of the component repeater. |
|  | [MakeEmpty](a3e78a12-1414-efc0-f0af-b2e7ac904e1e.md) | Makes the slot empty by removing the instance currently held by the slot. |
