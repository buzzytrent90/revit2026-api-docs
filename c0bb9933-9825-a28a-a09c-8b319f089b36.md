...
# FormattedTextSetListType Method  
...
listType [ListType](7163554f-3446-22eb-afa4-5490d5df29c8.md)
     The [ListType](7163554f-3446-22eb-afa4-5490d5df29c8.md) to set on the paragraph. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | This text range is empty. -or- This start index of this text range is not within the text range identifying the entire text. -or- The end of this text range is not within the text range identifying the entire text. -or- This list type is not valid to set on a paragraph. |
