...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.StructureStructuralConnectionHandlerType
...
```
```vb
Public Class StructuralConnectionHandlerType
...
The StructuralConnectionHandlerType type exposes the following members.
...
|  | [ConnectionGuid](625f6a3a-b0af-0d21-1f20-0af3609049bd.md) | The GUID to use for identifying connection geometry generation algorithm. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddElementsToCustomConnection](4ce5c475-c74a-c5aa-0724-8df7c1a0cacb.md) | **Obsolete.** |
...
|  | [CreateDefaultStructuralConnectionHandlerType](3334270c-e2eb-855c-b8d6-4a7f0388ebe8.md) | Creates a new StructuralConnectionHandlerType object with a default name. |
...
|  | [FindGenericConnectionType](83298a62-78c9-8182-f742-a4aeff747bec.md) | Finds StructuralConnectionHandlerType which is Generic Connection type. |
|  | [GetDefaultConnectionHandlerType](f9b606a4-2656-dca7-8f8e-469630bd151e.md) | Gets a default type id for Structural Connection. |
...
|  | [IsCustom](ecd5d004-964f-eb6a-c4b2-0916fd8e0b93.md) | Checks if StructuralConnectionHandlerType is custom. |
...
|  | [IsDetailed](0a36101d-7ce2-c7b5-7e94-ae2b824d10c4.md) | Checks if StructuralConnectionHandlerType is detailed. |
...
|  | [IsGeneric](697a72c2-a01f-4203-db5c-c3c95d44261e.md) | Checks if StructuralConnectionHandlerType is generic. |
...
|  | [IsTypeNameValidForCustomConnection](1b1a9194-d048-7d41-eb53-94b9201e2a9b.md) | Validates if the input name matches the criteria of StructuralConnectionHandlerType name. Name must be unique among other existing StructuralConnectionHandlerTypes and cannot contain any of the following characters: new line, {}[];`~\\\/:*?";<> | or any of the non-printable characters. |
...
|  | [RemoveMainSubelementsFromCustomConnection](09882898-b699-9b91-742b-ea6bd75942a1.md) | **Obsolete.** |
...
|  | [UpdateCustomConnectionType](bd060853-9bb7-9fa6-10aa-1aa5b86c8e5a.md) |  |
