...
# RebarBendDataTerminationRotationAngle1 Property  
...
```
```vb
Public Property TerminationRotationAngle1 As Double
	Get
	Set
```
```cpp
public:
property double TerminationRotationAngle1 {
	double get ();
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The given value for terminationRotationAngle1 is not finite |
