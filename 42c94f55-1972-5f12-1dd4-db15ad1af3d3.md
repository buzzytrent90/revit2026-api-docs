...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) Autodesk.Revit.DBCurtainGridLine
...
The CurtainGridLine type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AllSegmentCurves](122fa101-38a5-3f23-6c86-855f942df7e0.md) | Retrieve the curves of all segments. |
...
|  | [ExistingSegmentCurves](8595a252-e9fd-5537-2a78-2517dd950d28.md) | Retrieve all the existing segment curves of the grid line. |
|  | [FullCurve](6bc234da-f624-9ac2-a306-6e62cfc77945.md) | Retrieve the geometry curve of the curtain grid line. |
...
|  | [IsUGridLine](71ec9099-79fa-07b0-495d-74ad73d6d4d8.md) | Retrieve the direction of a grid line.If it is true,we say it is a UGridLine,otherwise it is VGridLine |
...
|  | [Lock](835099bf-8511-65d8-bd42-746e992c7bca.md) | Retrieves or changes the lock state of the curtain grid line. |
...
|  | [SkippedSegmentCurves](8456b83c-bbb2-c22c-5bb1-23521721b545.md) | Retrieve all the removed segment curves of the grid line. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddAllSegments](5c4a3c78-b527-31c8-aeb8-b9d51c2b56e4.md) | All the segments on this grid line will be added. |
|  | [AddMullions](c6a78e90-5ce1-5bf3-cb82-f3de750e0255.md) | Add mullions on the specified segments of a grid. If any segment already has a mullion, no change is made to that segment. |
|  | [AddSegment](0e6a1adb-8953-4afb-9769-34f8142e50ee.md) | Add a segment based on the specified segment curve of the gridline. |
...
|  | [RemoveSegment](024f4880-1bfd-0819-a1b3-8cd11113cfad.md) | Remove the segment specified by the input curve. |
