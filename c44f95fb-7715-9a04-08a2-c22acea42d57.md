...
SystemObject [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSection](65b59d7d-bd7b-c71b-7159-dfc506a912ee.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionRectangular](fc038108-6279-839c-285b-effe342b4491.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionColdFormed](f77557fc-2bc9-e1f9-5984-57cbbe93508a.md) Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionSigmaProfileWithLips
...
```
```vb
Public Class StructuralSectionSigmaProfileWithLips
...
```
```fsharp
type StructuralSectionSigmaProfileWithLips = 
    class
        inherit StructuralSectionColdFormed
    end
```


The StructuralSectionSigmaProfileWithLips type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionSigmaProfileWithLips](cd6b71f6-1821-6ba1-5d2b-2bca14902138.md) | Creates a new instance of Structural Section Sigma Profile With Lips shape with the associated set of parameters, used to attach to structural element. |
...
|  | [BendWidth](e5ad6b8f-40fb-8265-eef5-c85434a0039d.md) | Bend segment width. |
...
|  | [LipLength](c57b8428-afe0-adcc-ed8e-4571a2a81ac3.md) | Lip segment length. |
|  | [MiddleBendLength](17a0da0f-fa1f-e0a6-1101-3bbfc8885eae.md) | Middle Bend segment length. |
...
|  | [TopBendLength](e28813b9-a7f7-c4a4-214f-161f6b37466e.md) | Top Bend segment length. |
