...
# ParameterFilterRuleFactoryCreateLessOrEqualRule(ElementId, Double, Double) Method  
...
```
```vb
Public Shared Function CreateLessOrEqualRule ( 
...
```
```fsharp
static member CreateLessOrEqualRule : 
        parameter : ElementId * 
        value : float * 
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The given value for value is not finite -or- The given value for value is not a number -or- The given value for epsilon is not finite -or- The given value for epsilon is not a number |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | A non-optional argument was null |
  
Values greater than the user-supplied value but within _epsilon_ are considered equal; therefore, such values satisfy the condition. 

#### Reference

[ParameterFilterRuleFactory Class](317755a4-24ba-9f36-7639-f6fb2aa5a1a7.md)

[CreateLessOrEqualRule Overload](5b6d084a-a18a-467a-6f4a-10790e1a71fe.md)
