...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBKeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.md) Autodesk.Revit.DBAssemblyCodeTable
...
```
```fsharp
type AssemblyCodeTable = 
    class
        inherit KeyBasedTreeEntryTable
    end
```


The AssemblyCodeTable type exposes the following members.
...
|  | [GetAssemblyCodeTable](26b23f25-ef12-5368-3f4b-6097f93ce312.md) | Returns the AssemblyCodeTable for the specified document. |
...
|  | [GetKeyBasedTreeEntries](f485fa08-b03d-f113-0140-077c78408884.md) | Gets the KeyBasedTreeEntries for this table. (Inherited from [KeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.md)) |
...
|  | [LoadFrom](51da265d-a879-61dd-3b59-b919bf2645f4.md) | Loads KeyBasedTreeEntries from the specified external resource into this KeyBasedTreeEntryTable. (Inherited from [KeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.md)) |
...
|  | [Reload](a91169d7-4f71-c027-3a24-1d90473e7071.md) | Reloads KeyBasedTreeEntries from their currently-stored location into this KeyBasedTreeEntryTable. (Inherited from [KeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.md)) |
|  | [ServerSupports](e9a1009d-a56e-d3f6-7987-5b2de9104c93.md) | Checks if the server referenced by the given ExternalResourceReference supports the ExternalResourceReferenceType of this KeyBasedTreeEntryTable. (Inherited from [KeyBasedTreeEntryTable](c5d3e9d9-0221-520b-6163-9843db20d5ea.md)) |
