...
# BuildingOperatingDayScheduleSetValueForHour Method  
...
| Exception | Condition |
| --- | --- |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | hour must be from 0 to 23 inclusive. -or- The given value for usage must be non-negative. -or- usage should be less than or equal to 1. |
