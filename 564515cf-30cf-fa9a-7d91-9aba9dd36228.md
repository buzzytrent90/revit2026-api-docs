...
# MetallicPaintMetallicpaintPearlColor Property  
...
```csharp
public static string MetallicpaintPearlColor { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintPearlColor As String
	Get
```
```cpp
public:
static property String^ MetallicpaintPearlColor {
	String^ get ();
}
```
```fsharp
static member MetallicpaintPearlColor : string with get
```
