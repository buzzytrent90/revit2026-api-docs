...
# AssemblyViewUtilsCreateDetailSection(Document, ElementId, AssemblyDetailViewOrientation, ElementId, Boolean) Method  
...
static member CreateDetailSection : 
        ...
        direction : AssemblyDetailViewOrientation * 
        viewTemplateId : ElementId * 
        isAssigned : bool -> ViewSection 
```
...
direction [AssemblyDetailViewOrientation](941c2468-0a94-b2c0-0c73-1953e15487d6.md)
...
[ViewSection](fcc75682-bd99-a97d-5a4d-0f8eb9e92ab5.md) A new detail section assembly view. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | assemblyInstanceId is not an AssemblyInstance. -or- viewTemplateId is not a correct view template for the geom view. |
