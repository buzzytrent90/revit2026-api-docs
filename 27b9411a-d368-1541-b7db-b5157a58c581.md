...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBCombinableElement](c88bdbbc-dbbb-0817-a358-35f8686f68a2.md) [Autodesk.Revit.DBGenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.md) Autodesk.Revit.DBFreeFormElement
...
The FreeFormElement type exposes the following members.
...
|  | [CanOffsetFace](c81b5066-cb87-192a-2095-9b96e08e9806.md) | Determines if the input face of the FreeFormElement can be offset. |
...
|  | [Create](a8aa4123-03a0-14c7-f4e5-7bc5a076aa8d.md) | Creates a new FreeFormElement from a copy of the input geometry. |
...
|  | [SetFaceOffset](74cb7799-030d-aa76-0009-f2ac59aee9a8.md) | Offsets a planar face of the free form element a certain distance in the normal direction. |
...
|  | [UpdateSolidGeometry](99abedef-afcb-2117-9196-0289668f85bc.md) | Updates the geometry of the FreeForm element to the given shape preserving References to the existing geometry where possible (see remarks for rules). |
