...
# ParameterUtilsDownloadParameter Method  
...
options [ParameterDownloadOptions](7359f11b-4102-15f3-597b-51078e1141bc.md)
...
[SharedParameterElement](d8a0f2ae-7e10-39bd-e362-3756cbae661b.md) The shared parameter instance. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when the parameter identifier does not include a GUID, when required bindings are not assigned, when the requested group identifier does not identify a group that accommodates user-defined parameters, when a parameter with a matching GUID is already present in the given family document, when the given project document already contains an incompatible parameter definition with the same GUID, or when a parameter with a matching name is already present in the given family document. |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | A non-optional argument was null |
| [DefaultValueException](b26719be-e9a8-eab2-3fac-66bc8765febe.md) | Thrown when the target document is a family and the downloaded parameter is a Family Type parameter and no family of the requisite category exists in the family document. |
| [NetworkCommunicationException](77e5da6e-c129-8e56-c944-26d2c5e925a3.md) | Thrown when communication with the Parameters Service is unsuccessful. |
| [ResourceNotFoundException](4ef7bcee-5831-e2c9-ee4a-06a0dd6c255f.md) | Thrown when the requested parameter definition is not found on the Parameters Service. |
| [SchemaException](9f929b36-8215-444e-30fd-518c94fb6d29.md) | Thrown when there is an error interpreting a downloaded parameter definition. |
