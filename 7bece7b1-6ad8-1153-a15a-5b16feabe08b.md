...
# BuiltInFailuresRoomFailures Class  
  
---  
  
Failures about Room. 

SystemObject Autodesk.Revit.DBBuiltInFailuresRoomFailures
...
[<SealedAttribute>]
type RoomFailures = class end
```


The BuiltInFailuresRoomFailures type exposes the following members.
