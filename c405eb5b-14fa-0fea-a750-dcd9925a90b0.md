...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBColorFillScheme
...
The ColorFillScheme type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AreaSchemeId](e24d76dd-38fb-c951-7ae4-d10101b4981b.md) | Represents the id of AreaScheme of area plan views that this scheme could be applied to. |
...
|  | [CategoryId](7f1d0a3c-4194-f165-0203-5aba9431a1b8.md) | Represents the element category that can be colored by this scheme. |
...
|  | [IsByRange](2e6a3c32-a3f8-a6dd-6552-7ba7a901d9fb.md) | Represents if the parameter values in entries are treated as value range or not. |
|  | [IsLinkedFilesIncluded](128e90fd-f78f-42c5-e1a8-aa7a34363634.md) | Represent if the scheme includes entries whose parameter values are based on elements from linked files. |
...
|  | [ParameterDefinition](554f7720-d040-ebcf-5986-9910b8038b87.md) | Represents the parameter of the elements that this scheme could be used to color. |
...
|  | [StorageType](41c8e61c-fa40-0d69-9c5c-d955baaddbf5.md) | Represents the type of parameter values stored in entries. |
|  | [Title](4a9768ad-6b47-5ac4-b4c3-b67717268fee.md) | Represents the title displayed in [ColorFillLegend](81cbdc7c-9f7f-b454-5669-77ca0514eda7.md). |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddEntry](8c7f6d04-66ab-19ef-d00c-445aa4570f82.md) | Adds new entry to the scheme. |
|  | [AreEntriesConsistentWithScheme](a368c926-4d60-0fde-4e21-0a7c815db691.md) |  |
...
|  | [CanDefineByRange](f4592c9f-40f1-703c-21e7-17bb7c2f3747.md) | Checks whether the scheme entries can be explained by range. |
...
|  | [CanRemoveEntry](d19264f1-e9f1-462f-f2c3-7f4ae9f2c9d0.md) | Checks whether entry can be removed from the scheme. |
|  | [CanUpdateEntry](f7f0bdd9-8076-69f1-bf81-776c40f42a22.md) | Checks whether entry exists in the scheme and not the same as input one. |
...
|  | [Duplicate](095596ae-d215-bf22-ccfa-fae85109d1a0.md) | Generates a copy of current scheme. |
...
|  | [GetEntries](bb3b650c-2718-28b7-c4bb-be3f80fb3e32.md) | Retrieves copies of all entries. |
...
|  | [GetFormatOptions](74e725cd-a74e-5ac6-d01e-0d1022208eb1.md) | Returns the FormatOptions of the scheme. |
...
|  | [GetSupportedParameterIds](d19ac539-c56d-1c3c-1b7b-8801e9713c06.md) | Retrieves collection of all parameters supported by the scheme. |
...
|  | [IsEntryConsistentWithScheme](887cb0a0-2ad3-9a2c-8f46-c86e404539f8.md) | Checks whether an entry can be added to the scheme or not. |
...
|  | [IsValidParameterDefinitionId](df43fe3e-0b93-ef67-c877-eedbaf6a7f49.md) | Checks whether the input parameter id can be applied to the scheme. |
|  | [IsValidSchemeName](ecae1c30-8417-dae7-8364-30f75145bb06.md) | Checks whether the name is valid for new generated scheme. |
...
|  | [RemoveEntry](e7441d50-0e17-21be-8ff6-aadadacad417.md) | Removes an entry whose parameter value is the same as the input from the scheme |
...
|  | [SetEntries](a2099010-ccb3-5ad1-5e80-5209422add42.md) |  |
|  | [SetFormatOptions](6558114a-4587-ff68-17a9-e58f0dfea0bb.md) | Sets the FormatOptions of the scheme. |
|  | [SortEntries](b1cec6a3-6b60-b47f-2ea6-a6d7df9555c0.md) | Sorts the scheme entries ascending. |
|  | ToString | Returns a string that represents the current object.(Inherited from Object) |
|  | [UpdateEntry](47fece43-de9a-e343-62be-e6907c584933.md) | Updates the scheme entry with the same parameter value as the input entry. |
...
You can retrieve the entries with [GetEntries](bb3b650c-2718-28b7-c4bb-be3f80fb3e32.md), or modify entries with [AddEntry(ColorFillSchemeEntry)](8c7f6d04-66ab-19ef-d00c-445aa4570f82.md), [RemoveEntry(ColorFillSchemeEntry)](e7441d50-0e17-21be-8ff6-aadadacad417.md), [UpdateEntry(ColorFillSchemeEntry)](47fece43-de9a-e343-62be-e6907c584933.md) and SetEntries().
...
API works slightly different with UI:
  ...
  3. To modify multiple entries, it's better to use SetEntries() but not modify them one by one with other methods for better performance.
