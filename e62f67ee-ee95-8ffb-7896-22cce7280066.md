...
# ReferenceableViewUtilsChangeReferencedView Method  
...
desiredViewId [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
     The id of the View that the reference section or callout will refer to. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | referenceId is not a valid reference view. -or- desiredViewId is not a view that can be referenced by referenceId. |
