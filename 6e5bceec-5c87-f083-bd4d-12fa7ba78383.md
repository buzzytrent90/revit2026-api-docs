...
# BuiltInFailuresRoomFailuresRoomsInSameRegionSpaces Property  
...
```
```vb
Public Shared ReadOnly Property RoomsInSameRegionSpaces As FailureDefinitionId
	Get
```
```cpp
public:
static property FailureDefinitionId^ RoomsInSameRegionSpaces {
	FailureDefinitionId^ get ();
}
```
```fsharp
static member RoomsInSameRegionSpaces : FailureDefinitionId with get
```
