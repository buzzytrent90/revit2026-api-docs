...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisMassLevelData
...
The MassLevelData type exposes the following members.
...
|  | [IsEmpty](c9e0abfe-b8fa-e48b-edab-b83185b158fb.md) | Indicates if the MassLevelData (Mass Floor) has a geometrical representation. May not if the level does not intersect the mass geometry. |
...
|  | [IsMassFamilyInstance](a2bc9949-9c4f-afc4-6c79-38050507e784.md) | Checks if the ElementId is a mass family instance. |
...
|  | [IsValidConceptualConstructionTypeElement](453bc7cc-a667-fdb6-72d9-efb2db40badd.md) | Checks if the ElementId is an acceptable conceptual construction type ElementId for the MassLevelData (Mass Floor). |
