...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ArchitectureMultistoryStairs
...
The MultistoryStairs type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [ActualTreadDepth](736ed3f5-be03-a819-96b8-1cd302f3ae22.md) | The actual depth of the stairs treads in the stairs, actual tread depth is equal to minimum tread depth by default. |
...
|  | [StandardStairsId](2430a0ec-b9b4-28ad-de89-3d7a1340d239.md) | Id of the stair associated with the Reference Level for the multistory stairs. The standard stair is regarded as a definition to generate new stairs when extending multistory stairs to a different level height. |
...
|  | [CanConnectLevel](01069be7-0661-3d91-48d3-9a6dea6c9711.md) | Checks if the given level can be connected into multistory stairs. You cannot connect levels between standard stairs top and bottom or already connected. |
...
|  | [CanDisconnectLevel](471db1d0-7f14-6a45-a31e-b31a85f1f124.md) | Checks if the given level can be disconnected from multistory stairs. You cannot disconnect the levels of standard stair (the stair associated with the Reference Level for the multistory stairs) or already disconnected. |
...
|  | [ConnectLevels](e6734f94-80de-fedd-e972-488899569085.md) |  |
|  | [Create](97782290-9eb0-9559-1012-6d46212b5476.md) | Creates a multistory stairs from an existing component-based stairs. |
...
|  | [DisconnectLevels](482be079-8bd4-e275-8231-7d3ae487e73c.md) |  |
...
|  | [GetAllConnectedLevels](c6c09472-e44a-9bf5-6847-e4a0c2212d00.md) | Gets all connected level ids of this multistory stairs. |
|  | [GetAllStairsIds](a66792ff-4d73-afc7-8df6-ae8733cf69de.md) | Gets the ids of all the stairs in this multistory stairs. |
...
|  | [GetStairsOnLevel](7a591c9d-6dd9-398e-9eb5-280eca78d396.md) | Gets the individual stairs or stairs group on the given base level. |
|  | [GetStairsPlacementLevels](1d81b0f3-4065-8ec7-e7f8-0fbb1d120617.md) | Gets all the levels the given stairs group placed on. |
...
|  | [IsAcceptableForMultistoryStairs](bd5ebf3c-cccc-7b4e-518d-25655532b981.md) | Checks if the given stairs can be used to create a multistory stairs. |
...
|  | [IsPinned](c9dea1f0-00e3-e5ab-d66d-84e6250accab.md) | Checks if a stair is pinned. |
...
|  | [Pin](41a11436-7ef4-f8c8-f247-04d529f8c466.md) | Restores an unpinned stairs element back into the group of stairs governed by level height. |
...
|  | [Unpin](f1eb4c84-2b7e-1b6a-dc8b-dfc6c0c994c9.md) | Removes a particular story of the stairs (identified by its base level id) from a stairs group. |
