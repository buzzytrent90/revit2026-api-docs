...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.PlumbingFluidType
...
type FluidType = 
    class
        inherit ElementType
        interface IEnumerable<FluidTemperature>
    end
```


The FluidType type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddTemperature](b45f6462-c9d6-95c1-8561-a1024020532c.md) | Adds a fluid temperature to the set. |
...
|  | [ClearAllTemperatures](b530979d-4f94-bd52-0c02-83b740cf6947.md) | Clears all fluid temperatures in the set. |
...
|  | [GetBasicIEnumerator](8036c0e2-44b5-02e2-34e3-9d84261c1f83.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetEnumerator](07f0208b-99ac-a800-d161-4821a1c7bd5e.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetFluidTemperatureSetIterator](890a61fc-60fe-b8bf-6f64-ebf94618493a.md) | Returns a FluidTemperatureSetIterator that iterates through the collection. |
|  | [GetFluidType](18596b04-d15b-c946-8a71-53914510476e.md) | Gets a fluid type by name. |
...
|  | [GetTemperature](c9aa98b4-430f-d035-4e32-a0c55392c6f6.md) | Gets a copy of the FluidTemperature object matching a given temperature value. |
...
|  | [IsFluidInUse](8cbe2182-6144-a90a-26c6-41526bff00f4.md) | Identifies if the fluid type is in use. |
...
|  | [RemoveTemperature](91ab315a-b3ba-0fae-1c52-c750037a6fe8.md) | Removes a fluid temperature via the temperature value from the set. |
