...
```csharp
public class StructuralSectionConcreteCross : StructuralSectionRectangular
```
```vb
Public Class StructuralSectionConcreteCross
	Inherits StructuralSectionRectangular
```
```cpp
public ref class StructuralSectionConcreteCross : public StructuralSectionRectangular
```
```fsharp
type StructuralSectionConcreteCross = 
    class
...
The StructuralSectionConcreteCross type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionConcreteCross](827cbc28-b366-20e5-9fe2-3840bb59a008.md) | Creates a new instance of Structural Section Concrete Cross shape with the associated set of parameters, used to attach to structural element. |
...
|  | [CantileverHeight](643a10d5-5d94-dde2-398b-924f67194cc9.md) | Flange cantilever thickness. |
|  | [CantileverLength](0a1bf912-867b-9e65-f34a-0ebd8432a364.md) | Flange cantilever length. |
