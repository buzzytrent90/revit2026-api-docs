...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.AnalysisPathOfTravel
...
The PathOfTravel type exposes the following members.
...
|  | [LineStyle](012d6c63-fd01-a578-5b42-9a9ca095c843.md) | The line style of the path. |
...
|  | [PathEnd](a763a360-481d-14e3-bcde-e3b7aea2bc82.md) | The end point of the path. The Z coordinate will equal the view's level elevation. To update path calculations, call update. |
|  | [PathMidpoint](ab45a2d1-62d0-8823-0947-823f2d130e93.md) | The midpoint of the path. The Z coordinate will equal the view's level elevation. |
|  | [PathStart](967e4fe9-ad0b-d275-05e9-e0bdf37c650a.md) | The start point of the path. The Z coordinate will equal the view's level elevation. To update path calculations, call update. |
...
|  | [FindEndsOfShortestPaths](607571b1-bebe-f647-28c1-30b409475c65.md) |  |
|  | [FindShortestPaths](ed038de8-768b-f9ce-91f5-c25ac559d5fe.md) |  |
|  | [FindStartsOfLongestPathsFromRooms](d76f7dbc-c20e-ea61-8c6b-a4bd59f444c2.md) |  |
|  | [GetCurves](7c222d22-ce15-daf8-aec8-01ed3098530c.md) | Gets the array of curves representing the path of travel. |
...
|  | [GetWaypoints](dad6abd9-812c-f9bb-e7b9-d4a3c2e32bef.md) | return the waypoints set for the Path of Travel |
...
|  | [InsertWaypoint](75f4e1f0-a543-5f50-9958-030c0fa2a2dd.md) | Insert a waypoint at the specified index |
...
|  | [IsInRevealObstaclesMode](f158a901-fc99-dc87-d8de-79b739b86a43.md) | Returns current state of Reveal Obstacles mode for the given view. |
...
|  | [RemoveWaypoint](180917fd-f296-54f9-a824-301b99376fb5.md) | Remove a waypoint. |
...
|  | [SetRevealObstaclesMode](d2a2f84c-a90e-9ef0-28aa-025af61b8be3.md) | Sets Reveal Obstacles mode for the given view. |
|  | [SetWaypoint](32d98435-a0bb-148f-1139-4b338b4ccd6b.md) | Updates the specified waypoint. |
|  | ToString | Returns a string that represents the current object.(Inherited from Object) |
|  | [Update](738b8438-8952-7af5-86d9-a1d631ec903b.md) | Updates the path of travel by recalculating the path between the original start and end points. |
