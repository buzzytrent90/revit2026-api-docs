...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBDefaultDivideSettings

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class DefaultDivideSettings : Element
```
```vb
...
```
```cpp
public ref class DefaultDivideSettings : public Element
```
```fsharp
type DefaultDivideSettings = 
    class
        inherit Element
    end
```
...
The DefaultDivideSettings type exposes the following members.
...
|  | [PathDistance](651d91ee-9edb-5106-fb10-0c06331e61cb.md) | A default Divided Path distance for a fixed, minimum, or maximum distance layout. |
|  | [PathLayout](f945b3cf-7725-41b2-75ac-ff0f3cf60d42.md) | A default Divided Path layout. |
|  | [PathMeasurementType](6f4f7a4d-112c-10ef-d675-da94d5ea4404.md) | A default Divided Path measurement type for distance layouts. |
|  | [PathNumber](b9b98d23-5e6f-ec10-1264-458c3cf43472.md) | A default Divided Path number for a fixed number layout. |
...
|  | [GetDefaultDivideSettings](6919eb7d-3c9b-a1ad-9a73-3cc0e0b357d8.md) | Obtains the DefaultDivideSettings object for the specified document. |
...
|  | [GetSurfaceDistance](4eb288d9-3f40-0e3b-7264-358e02dad22e.md) | Gets the default Divided Surface distance for a fixed, minimum, or maximum distance layout for U or V gridlines. |
|  | [GetSurfaceLayout](c30c0676-0174-f6b5-5c5b-3b7f9ade3ac6.md) | Gets the default Divided Surface layout for U or V gridlines. |
|  | [GetSurfaceNumber](d31775cf-ad0c-26d3-60b4-1e90f5663d2d.md) | Gets the default Divided Surface number for a fixed number layout for U or V gridlines. |
...
|  | [SetSurfaceDistance](d9f9b486-3b4c-7ac6-5e9d-9068960708ac.md) | Sets the default Divided Surface distance for a fixed, minimum, or maximum distance layout for U or V gridlines. |
|  | [SetSurfaceLayout](5555599e-ce36-8558-2120-aff759855072.md) | Sets the default Divided Surface layout for U or V gridlines. |
|  | [SetSurfaceNumber](3d652d69-084c-3f2b-f966-e95760a6f038.md) | Sets the default Divided Surface number for a fixed number layout for U or V gridlines. |
