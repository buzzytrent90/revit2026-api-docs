...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBMultiReferenceAnnotationType
...
```
```fsharp
type MultiReferenceAnnotationType = 
    class
        inherit ElementType
    end
```
...
The MultiReferenceAnnotationType type exposes the following members.
...
|  | [DimensionStyleId](2849b4f5-70fd-747b-e31c-d286ee518645.md) | The dimension style which will be used by the child dimension of the multi-reference annotation. |
...
|  | [GroupTagHeads](c8bbdb4c-9c69-b4b8-7382-c3d9f54f380c.md) | Controls if parameter values for the annotation's references will be reported in one grouped tag head or if every reference will get its own tag head. |
...
|  | [ReferenceCategoryId](5d89b166-9eb2-924b-7c8b-ec41508825d0.md) | The category of elements to which this annotation applies. |
|  | [ShowDimensionText](48eb0247-c2f6-ea03-b347-f9d999662428.md) | Controls if text from the multi-reference annotation's dimension will be shown. |
|  | [TagTypeId](27b53b40-5506-9a4a-321a-cd8db9b09ceb.md) | The tag type which will be used by the child tag the multi-reference annotation. |
