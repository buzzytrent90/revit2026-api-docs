...
Public Sub New ( 
	...
	topCutWidth As Double,
	topCutHeight As Double,
	bottomCutWidth As Double,
	bottomCutHeight As Double
)
```
```cpp
public:
...
new : 
        ...
        bottomCutHeight : float -> StructuralSectionConcreteRectangleCut
```
...
bottomCutWidth Double
     Section width left Cut. 
bottomCutHeight Double
