...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBMEPSystem [Autodesk.Revit.DB.ElectricalElectricalSystem](158b4be3-bbe5-11eb-cccc-788edd3a7590.md) [Autodesk.Revit.DB.MechanicalMechanicalSystem](ef83dd58-07d6-4f9a-8dc6-f4b1fd8246d2.md) [Autodesk.Revit.DB.PlumbingPipingSystem](6abbdfa2-69a5-eef1-2663-89a5faf91831.md)
...
The MEPSystem type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [Add](f40dba23-b703-6a37-0e09-7dfcd2eb1955.md) | Add elements into the system and connect them with the system using given connectors. |
...
|  | [DivideSystem](1bb1e7d5-a9f6-0c2d-e413-064bd4aa2c02.md) | Divide the phyisical networks in the system and create a new system for each network. |
...
|  | [GetCriticalPathSectionNumbers](b68ff5b9-e8cf-2565-2b50-03a8d2489ac3.md) | Obtains a list of the critical path section numbers. |
...
|  | [GetPhysicalNetworksNumber](23ca7db4-fa65-1149-95d7-9f17b80e073a.md) | Get the physical networks number in the system. |
|  | [GetSectionByIndex](dd53cbe2-37e6-19a1-e627-74a2aacb3433.md) | Get the section from the index. |
|  | [GetSectionByNumber](11cc783a-32f8-b0e0-2da6-5ecc6b9e57a6.md) | Get the Section from section number |
...
|  | [IsSystemDividable](4764bc4f-7ca7-820e-2b06-ac1a25750971.md) | Checks if the system is dividable. The system is dividable if there is more than one physical network in the system. Currently, only HVAC and piping systems support dividing. |
