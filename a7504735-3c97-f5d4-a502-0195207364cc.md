...
SystemObject SystemEventArgs [Autodesk.Revit.DB.EventsRevitAPIEventArgs](7c98499c-e345-cfda-ef89-48eccd3c9992.md) [Autodesk.Revit.DB.EventsRevitAPISingleEventArgs](446fa3c6-4f35-47f4-e8c2-e5235c321836.md) Autodesk.Revit.UI.EventsMacroUpdatedEventArgs
...
```csharp
public class MacroUpdatedEventArgs : RevitAPISingleEventArgs
```
```vb
...
```
```cpp
public ref class MacroUpdatedEventArgs : public RevitAPISingleEventArgs
```
```fsharp
type MacroUpdatedEventArgs = 
    class
...
The MacroUpdatedEventArgs type exposes the following members.
