...
# MetallicPaintMetallicpaintFlecksColorByObject Property  
...
```csharp
public static string MetallicpaintFlecksColorByObject { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintFlecksColorByObject As String
	Get
```
```cpp
public:
static property String^ MetallicpaintFlecksColorByObject {
	String^ get ();
}
```
```fsharp
static member MetallicpaintFlecksColorByObject : string with get
```
