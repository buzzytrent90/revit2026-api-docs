...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ElectricalInsulationType
...
```csharp
[ObsoleteAttribute("InsulationType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use InsulationMaterial instead. InsulationMaterials will be created by InsulationTypes properly during document upgrade.")]
...
```
```cpp
[ObsoleteAttribute(L"InsulationType is deprecated in Revit 2026 and will be removed in a future version of Revit. Please use InsulationMaterial instead. InsulationMaterials will be created by InsulationTypes properly during document upgrade.")]
...
The InsulationType type exposes the following members.
...
|  | [IsInUse](ca2a32ab-5bd4-922f-580b-328021383f77.md) | Indicate whether the insulation type is in use. |
...
|  | [Name](d821a86d-0511-38e8-cfd0-6a1d2e2fd185.md) | Get name of Insulation type. (Overrides [ElementTypeName](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.md)) |
