...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.StructureLoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md) Autodesk.Revit.DB.StructureLineLoad
...
The LineLoad type exposes the following members.
...
|  | [EndPoint](55965bc2-8cc9-1609-2a9a-0566e478d97d.md) | Returns the three dimensional location of the end point for the line load. |
|  | [ForceVector1](50cbbc07-492f-b5f3-2753-1da47d52a8db.md) | The force vector applied to the start point of the line load, oriented according to OrientTo setting. |
|  | [ForceVector2](3b7d9168-aaa1-9efa-cc74-d384736e62c7.md) | The force vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
|  | [IsProjected](482ec1fe-b5f4-75fb-2f17-440a6170aa37.md) | Indicates if the load is projected. |
...
|  | [IsUniform](e315fe82-508c-b64e-0f9a-4863596544f2.md) | Indicates if the load is uniform. |
...
|  | [MomentVector1](0094b002-656b-9c6b-2a9c-9a4d9eb97705.md) | The moment vector applied to the start point of the line load, oriented according to OrientTo setting. |
|  | [MomentVector2](ca5f8ab4-f017-81f7-46b9-de5154beaa70.md) | The moment vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
|  | [StartPoint](77e175b5-7495-7a20-98fc-6aa5706a7687.md) | Returns the three dimensional location of the start point for the line load. |
...
|  | [GetCurve](9c5b8a89-b69e-63a3-b93e-8ee058e92874.md) | Returns curve that define geometry of the line load. |
...
|  | [IsCurveInsideHostBoundaries](4bdb0447-3312-6ce7-08a6-f9a8de84ab3e.md) | Indicates if the curve is inside panel's boundaries or on panel's edges or if the curve is on the member's curve. |
...
|  | [IsValidHostId](f294365b-5eee-57c0-ad6a-cbdd7bd7637f.md) | Indicates if the provided host id can host line loads The document containing both the host and the load The id of the analytical element that is about to host a line load True if a line load can be placed on the input host id |
...
|  | [SetCurve](2066b893-dc5e-7082-adc2-0fef5e397b6e.md) | Sets the curve for the line load. |
...
|  | [SetPoints](41589a19-523d-ab5f-d72e-4e3bd7bc020d.md) | Sets start and end point of the line load. |
