...
doc [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)
     A Document. 
serverGUID Guid
     The API server GUID. Should be the same that the function GetServerId() from class derived from [IRebarUpdateServer](3e845cad-eca0-ccb3-785b-48a32a9f2677.md) returns. This server has the responsibility to calculate the bars of Rebar. 
