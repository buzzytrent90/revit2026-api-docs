...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBSSEPointVisibilitySettings
...
```
```vb
Public Class SSEPointVisibilitySettings
	Inherits Element
```
```cpp
...
```
```fsharp
type SSEPointVisibilitySettings = 
    class
        inherit Element
    end
```
...
The SSEPointVisibilitySettings type exposes the following members.
...
|  | [GetVisibility](d255a3cc-ed2d-5f00-3fa7-9b2688cc464a.md) | Gets the SSE point visibility for the given category. |
...
|  | [SetVisibility](0e276f4e-febe-a078-cc7c-228c1cdb01dd.md) | Sets the SSE point visibility for the given category. |
