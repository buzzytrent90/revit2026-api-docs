...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureLoadUsage
...
```csharp
public class LoadUsage : Element
```
```vb
Public Class LoadUsage
	Inherits Element
```
```cpp
public ref class LoadUsage : public Element
```
```fsharp
type LoadUsage = 
    class
...
The LoadUsage type exposes the following members.
...
|  | [Create](32ab758e-72e1-b024-3c9c-a21b7ed2d575.md) | Creates a new LoadUsage. |
