...
# SpaceDesignOtherLoadperArea Property  
...
```
```vb
Public Property DesignOtherLoadperArea As Double
	Get
	Set
```
```cpp
public:
property double DesignOtherLoadperArea {
	double get ();
	void set (double value);
}
```
```fsharp
member DesignOtherLoadperArea : float with get, set
```
