...
The [BuiltInFailuresElectricalFailures](3797ca4f-563c-ec8c-ff8b-258789a73766.md) type exposes the following members.
...
|  | [CircuitBecomeASpare](f0dd83c3-ed3f-7d08-0a40-e0a9eed8c4dd.md) | Circuit [Circuit Name] in [Panel Name] has become a spare because all connected elements have been disconnected. Click Delete if you want to remove the Spare, click OK to preserve the Spare.. |
|  | [CircuitOverload](289e61f4-9ac7-f454-7544-f5bd100dec76.md) | Total connected apparent power for Circuit [Name] is exceeding 80% of the defined rating ([Rating Value]). |
...
|  | [InvalidNumberOfCircuitValueForDataPanel](3535e918-afdd-824c-24d0-daa08918d9bb.md) | The number of circuits on the data panel currently exceeds the value you entered for Maximum Amount of Circuits parameter. Reduce the number of circuits on the equipment before changing this value. |
...
|  | [MismatchDistributionSystem](501d1f6d-205c-4be4-f517-4a0d61dc9a00.md) | [Name1] and [Name2] cannot connect with each other due to mismatched voltage or number of phases. |
...
|  | [MismatchNmbOfPolesAssignPanel](1c36e87f-c035-2348-7ce0-6060ce9e9232.md) | Cannot assign [Element] to Circuit. The Number of Poles for [Element] does not match the Number of Poles ([Name]) for the Circuit. |
...
|  | [NoDistributionSystem](3172c4e4-01b8-197e-816c-10daf0f8d835.md) | The distribution system of [CategoryName] [Name] is set to None. Assign a distribution system. |
|  | [NoPanelCircuitBecomeASpare](c8853f1b-cc42-53c1-585f-fc9305d64b7d.md) | Circuit [Circuit Name] in the model has become a spare because all connected elements have been disconnected. Click Delete if you want to remove the Spare, click OK to preserve the Spare.. |
...
|  | [NotEnoughAvailSlotsForConnectionChange](01b40f28-b77e-d3b2-da6a-fad5c5ce7df5.md) | You can't change the connection type to Breakers connect to panel [Panel Name] because there aren't enough slots. \nYou can increase the [ParameterName] to be greater than [Number] to connect through breaker slots or open the panel schedule and manually reshuffle non - consecutive slots. |
|  | [NotEnoughAvailSlotsOnDataPanel](9e8b1d13-d568-360f-c484-e788025daa37.md) | You can't connect to data panel [Panel Name] because there isn't enough space \nYou can increase the number of circuits to be greater than [Number]. |
|  | [NotEnoughAvailSlotsOnPanel](592744db-773f-36e5-e5b6-63ec6fab970d.md) | You can't connect to panel [Panel Name] because there aren't enough slots. \nYou can increase the [ParameterName] to be greater than [Number] to connect through breaker slots or open the panel schedule and manually reshuffle non - consecutive slots. |
...
|  | [NumberOfCircuitFullForConnectionChange](d474e383-ce33-50a1-f19d-42c1ea5d15b7.md) | You can't change the connection type to Breakers and connect to switchboard [Panel Name] because there aren't enough space. \nYou can increase the number of circuits to be greater than [Number] to connect through breakers. |
|  | [NumberOfCircuitFullOnSwitchPanel](cffe6141-6232-dd6d-d319-650e80b83b57.md) | You can't connect to switchboard [Panel Name] because there aren't enough space. \nYou can increase the number of circuits to be greater than [Number] to connect through breakers. |
...
|  | [PrimaryNumOfPhasesNotEqualWithSecondary](68d19490-ce1c-a555-2fd0-8b7ea4aa8758.md) | Number of Phases of the primary distribution system isn't equal with the secondary distribution system's |
...
|  | [SecondaryNumOfPhasesNotEqualWithPrimary](c2bd1fc5-6569-309c-e413-d010f9167ea6.md) | Number of Phases of the secondary distribution system isn't equal with the primary distribution system's |
...
|  | [TransformerNoDistributionSystem](761000b2-b413-055a-999b-c80cdf3ca176.md) | At least one of the distribution systems of Electrical Analytical Transformer [Name] is set to None. Assign distribution systems to the transformer. |
|  | [UnsignedCircuit](2a2ad6a4-47af-a2d5-1bb4-84c38f9dcf27.md) | Circuit is not assigned to a panel |
|  | [UnsupportedTransformerPrimaryDS](e6d4e440-60a8-ae53-a941-aaf66d9b366d.md) | [Distribution System Name] cannot appear on the primary side of the transformer. |
