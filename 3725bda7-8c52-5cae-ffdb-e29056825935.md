...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBViewPosition

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class ViewPosition : Element
```
```vb
...
```
```cpp
public ref class ViewPosition : public Element
```
```fsharp
type ViewPosition = 
    class
...
The ViewPosition type exposes the following members.
...
|  | [Position](ab4953f3-1df2-d057-9b5c-63d452cce7d8.md) | Specifies view's position. |
...
|  | [ViewAnchor](39095e75-5102-8afe-8d52-e817d9227cc5.md) | Specifies the method by which the view will be positioned on the sheet. Default is set to ViewAnchor.ViewOrigin. |
...
|  | [Create](2fa7e4cb-8f6f-bbf0-13cc-253669aae2a2.md) | Creates a new view position element. |
...
|  | [GetPlacedViewportIdsForViewPosition](d6ebf176-abab-ac58-5ada-c8098991bc6c.md) | Gets the placed viewport ids for the view position. |
