...
SystemObject SystemException [Autodesk.Revit.ExceptionsApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) [Autodesk.Revit.ExceptionsArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) Autodesk.Revit.ExceptionsArgumentsInconsistentException
...
```vb
<SerializableAttribute>
Public Class ArgumentsInconsistentException
...
```fsharp
[<SerializableAttribute>]
type ArgumentsInconsistentException = 
    class
...
The ArgumentsInconsistentException type exposes the following members.
