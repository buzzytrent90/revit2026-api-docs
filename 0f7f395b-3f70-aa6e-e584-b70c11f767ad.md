...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureAnalyticalToPhysicalAssociationManager
...
```
```vb
Public Class AnalyticalToPhysicalAssociationManager
	Inherits Element
```
```cpp
...
The AnalyticalToPhysicalAssociationManager type exposes the following members.
...
|  | [EnableAssistedAssociation](d829b828-282c-406e-b89e-a6f7cf5a84ec.md) | Indicates if associations between Analytical and Physical Elements should be created automatically. |
...
|  | [GetAnalyticalToPhysicalAssociationManager](a0df87ca-af1c-a17f-7f8c-e6a7af41a267.md) | Returns the AnalyticalToPhysicalAssociationManager for this document. |
|  | [GetAssociatedElementId](59274411-94e7-633b-2d9e-8989a903cc48.md) | Returns id of the element which is in association with the element with the given ElementId. |
|  | [GetAssociatedElementIds](f3710676-cd32-eb7d-59aa-8a11be872ba9.md) | Returns ids of the elements which are in association with the element with the given ElementId. |
...
|  | [HasAssociation](2534dbba-e2c6-e85d-5b96-c7b610993b15.md) | Verifies if the element has already defined an association. |
...
|  | [IsAnalyticalElement](626c3ad8-60e1-f7b0-47e9-8e1105b068ec.md) | Returns true if the element is an analytical element. |
...
|  | [IsPhysicalElement](9fa06267-c3b6-f681-43f5-9027948ab0cb.md) | Returns true if the element is a physical element. |
...
|  | [RemoveAssociation](05d00613-cf7f-ea84-61a4-b6ce4805dafd.md) | This method will remove the association for the element with the given ElementId. |
