...
voltageType [VoltageType](6b462685-b825-f8f9-f218-035107f7aaf0.md)
    Specify the voltage type to be removed.

| Exception | Condition |
| --- | --- |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Voltage type can be removed only if it isn't in service with any distribution systems. |
