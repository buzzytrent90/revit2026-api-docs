...
# RibbonPanelAddStackedItems(RibbonItemData, RibbonItemData, RibbonItemData) Method  
...
member AddStackedItems : 
        ...
        item3 : RibbonItemData -> IList<RibbonItem> 
```


#### Parameters

item1 [RibbonItemData](eb399d25-88cb-c3a1-c445-37077b3a5aa1.md)
...
item2 [RibbonItemData](eb399d25-88cb-c3a1-c445-37077b3a5aa1.md)
...
item3 [RibbonItemData](eb399d25-88cb-c3a1-c445-37077b3a5aa1.md)
...
IList[RibbonItem](79225f03-1633-3722-15b0-752c91a3740d.md) A collection containing the added items. 

| Exception | Condition |
| --- | --- |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | Thrown when item1, item2 or item3 is . |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when an item with item1.Name or item2.Name or item3.Name already exists in the panel or the data is not of the correct type. |
