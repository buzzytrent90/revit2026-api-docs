...
sourceAssemblyInstanceId [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
     Id of the assembly instance that currently owns the assembly views. 
targetAssemblyInstanceId [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
     Id of the assembly instance which will become the new owner of the assembly views. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | sourceAssemblyInstanceId is not an AssemblyInstance with assembly views. -or- targetAssemblyInstanceId is not an AssemblyInstance. -or- sourceAssemblyInstanceId and targetAssemblyInstanceId are not AssemblyInstances from the same assembly type. |
