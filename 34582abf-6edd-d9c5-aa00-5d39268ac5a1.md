...
# WorksharingDisplaySettingsGetGraphicOverrides(CheckoutStatus) Method  
...
ownershipStatus [CheckoutStatus](f6f6e300-5a37-7e44-7ee1-8dc0c016778a.md)
     The ownership status of interest. 

#### Return Value

[WorksharingDisplayGraphicSettings](994d2fb5-11cc-6756-155b-d496eedbe800.md) Returns the graphic overrides assigned to a particular ownership status. 
