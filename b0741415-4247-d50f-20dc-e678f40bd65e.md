...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBIndependentTag](e52073e2-9d98-6fb5-eb43-288cf9ed2e28.md) Autodesk.Revit.DB.StructurePathReinSpanSymbol
...
```
```vb
Public Class PathReinSpanSymbol
...
The PathReinSpanSymbol type exposes the following members.
...
|  | [Create](2e279903-79bd-1bea-206a-a3d1e6797b83.md) | Creates a new instance of PathReinSpanSymbol in the project. |
