...
# BendingDetailCustomFieldPropertiesLineStyleId Property  
...
```
```vb
Public Property LineStyleId As ElementId
	Get
	Set
```
```cpp
public:
property ElementId^ LineStyleId {
	ElementId^ get ();
	void set (ElementId^ value);
}
```
```fsharp
member LineStyleId : ElementId with get, set
```
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The lineStyleId should be an id of a line style. |
