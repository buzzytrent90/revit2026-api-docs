...
# ExternalResourceServerUtilsServerSupportsAssemblyCodeData Method  
...
```
```vb
Public Shared Function ServerSupportsAssemblyCodeData ( 
...
```
```fsharp
static member ServerSupportsAssemblyCodeData : 
