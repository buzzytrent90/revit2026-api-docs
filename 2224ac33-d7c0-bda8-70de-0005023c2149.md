...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBMultiReferenceAnnotation
...
The MultiReferenceAnnotation type exposes the following members.
...
|  | [DimensionId](99cb3709-901d-d73d-4e0d-4c75d3e0237e.md) | The child dimension owned by this multi-reference annotation. |
...
|  | [TagId](33f7bb8b-f277-0eee-e7ec-69c53e2d21e1.md) | The child IndependentTag owned by this multi-reference annotation. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AreElementsValidForMultiReferenceAnnotation](b49935de-bcad-70d0-cc8d-e53e4cb34031.md) | The method validates if the input elements match the element category id for the MultiReferenceAnnotationType. |
...
|  | [AreReferencesValidForLinearDimension](3e6aaebc-28a1-da82-8022-ec76d26122c6.md) | If the DimensionStyleType is Linear, validates that the references are valid for an aligned multi-reference annotation. |
|  | [AreReferencesValidForLinearFixedDimension](75111b29-eff1-c970-7f70-ba3cbcf7766e.md) | If the DimensionStyleType is LinearFixed, validates that the references are valid for an aligned multi-reference annotation. |
...
|  | [Create](b3646880-ef76-d0d4-68d9-2c976163c340.md) | Creates a new MultiReferenceAnnotation. |
...
|  | [Is3DViewValidForDimension](4674a228-8bcd-1851-60af-65e91b221bad.md) | If the DimensionStyle is LinearFixed, it cannot be created in a 3D View. If the DimensionStyle is Linear, it cannot be created in a 3D View if the view direction is perpendicular to the current work plane normal. Returns true if the ownerViewId is not a 3D view. |
...
|  | [IsLinearFixedDimensionDirectionValid](15ea4e06-bb36-6328-e456-6c4528766a23.md) | If the DimensionStyleType is LinearFixed, this function verifies that the dimension line direction matches either the view's vertical or horizontal direction. |
