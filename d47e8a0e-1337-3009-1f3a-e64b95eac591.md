...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBDimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md) Autodesk.Revit.DBRadialDimension
...
```
```cpp
public ref class RadialDimension : public Dimension
```
```fsharp
...
The RadialDimension type exposes the following members.
...
|  | [Create](96a9f77a-7a4e-5063-3d85-ca821b61cd64.md) | Creates a new instance of an Radial Dimension element within the project. |
