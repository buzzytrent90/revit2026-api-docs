...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) Autodesk.Revit.DBFaceWall
...
```
```cpp
public ref class FaceWall : public HostObject
```
```fsharp
type FaceWall = 
    class
...
The FaceWall type exposes the following members.
...
|  | [Create](751ee1bb-878d-da68-9a70-57f051f4d13e.md) | Creates a new instance of a wall attached to a non-vertical massing face. |
...
|  | [IsValidFaceReferenceForFaceWall](82a3b2c5-c712-b558-2b4f-825c2e841611.md) | Identifies if a reference may be used as the parent of a face wall. |
