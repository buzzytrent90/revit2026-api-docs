...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureRebarContainer
...
type RebarContainer = 
    class
        inherit Element
        interface IEnumerable<RebarContainerItem>
    end
```


The RebarContainer type exposes the following members.
...
|  | [ItemsCount](1ef0af6d-ca4a-9a2e-8095-f86d20286c59.md) | The count of Items in this Rebar Container. |
...
|  | [PresentItemsAsSubelements](a949781c-f4be-54bf-6f74-52dff40b28f7.md) | Identifies if Items should be presented in schedules and tags as separate subelements. |
|  | [ScheduleMark](45faac1a-a8ec-2df3-4cfd-8d49b98ee92b.md) | The Schedule Mark parameter. On creation, the Schedule Mark is set to a value that is unique to the host, but it can be set to any value. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AppendItemFromCurves(RebarStyle, RebarBarType, RebarHookType, RebarHookType, XYZ, IListCurve, RebarHookOrientation, RebarHookOrientation, Boolean, Boolean)](5e226c33-9073-1211-2ddb-8bd061b6ebf1.md) | **Obsolete.** |
|  | [AppendItemFromCurves(RebarStyle, RebarBarType, RebarHookType, RebarHookType, XYZ, IListCurve, RebarTerminationOrientation, RebarTerminationOrientation, Boolean, Boolean)](8b636f93-c8d0-14b9-8044-d3b75b0db6d7.md) |  |
|  | [AppendItemFromCurvesAndShape(RebarShape, RebarBarType, RebarHookType, RebarHookType, XYZ, IListCurve, RebarHookOrientation, RebarHookOrientation)](4f027562-d8b9-17b7-74db-3ffde449be5f.md) | **Obsolete.** |
|  | [AppendItemFromCurvesAndShape(RebarShape, RebarBarType, RebarHookType, RebarHookType, XYZ, IListCurve, RebarTerminationOrientation, RebarTerminationOrientation)](02e34460-f53b-3cd1-71ba-74232d66080b.md) |  |
|  | [AppendItemFromRebar](b7e0adc7-0f2e-af1e-9224-3f1ae4067e3c.md) | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. Will throw exception if given rebar is not shape driven. Will throw exception if given rebar has moved bars in set. |
|  | [AppendItemFromRebarShape](292aade1-0459-1a6a-9bd3-715e8bb634df.md) | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. |
...
|  | [CanApplyPresentationMode](4320a85e-3b48-719a-ec2e-ee74991c2dc2.md) | Checks if a presentation mode can be applied for this RebarContainer in the given view. |
...
|  | [ClearItems](4ba16a7e-eaaf-510b-2527-ce32948972bc.md) | Clears all the Items stored in this Rebar Container element. |
|  | [Contains](ed75fef3-8c01-c440-a1ca-db20914712fa.md) | Checks if the RebarContainer has this item as one of its members. |
|  | [Create](48da4e91-7ce6-5636-458f-bc7287ad98b0.md) | Creates a new instance of a Rebar Container element within the project. |
...
|  | [GetBasicIEnumerator](53f23133-175e-f3ce-f58d-a77358ca5129.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetEnumerator](f4f0511f-3ff8-d69f-a457-af5be5b91679.md) | Returns an enumerator that iterates through a collection. |
...
|  | [GetHostId](da5694c7-b1bb-6155-47f9-93b0b61776ea.md) | The element that contains the rebar. |
|  | [GetItem](d591f494-7c8c-a8ef-1a6a-31dc8dbc2ee4.md) | Gets the item stored in the RebarContainer at the associated index. |
...
|  | [GetParametersManager](276727c8-b3fc-d31c-a7f9-bac1871a20b1.md) | Returns an object used to manage parameters of the Rebar Container. |
...
|  | [GetRebarContainerIterator](e3368385-4e90-a01e-9335-18d0bdc75790.md) | Returns a Rebar Container Iterator that iterates through the Rebar Container Items. |
|  | [GetReinforcementRoundingManager](5149cdb5-f393-6b9e-e101-0fc3384d1236.md) | Returns an object for managing reinforcement rounding override settings. |
...
|  | [HasPresentationOverrides](cc0e04ac-56a9-f1a5-cae8-9962b0aa60a4.md) | Identifies if any RebarContainerItem of this RebarContainer has overridden default presentation settings for the given view. |
...
|  | [IsItemHidden](0c86e348-7204-5953-4398-e6ee29bc79c1.md) | Identifies if a given RebarContainerItem is hidden in this view. |
...
|  | [IsUnobscuredInView](1a9453cc-db8c-bbcf-dd6c-5380b809df09.md) | Checks if this rebar container element is shown unobscured in a view. |
...
|  | [RemoveItem](a72cdb40-2bb0-47c2-d0da-acca1289099e.md) | Removes Item from the Rebar Container. |
...
|  | [SetHostId](affeac8e-7d19-ee94-4a29-3011ab93e8a0.md) | The element that contains the rebar. |
|  | [SetItemHiddenStatus](c2eccd30-4ff7-7d9c-7858-548fc7269505.md) | Sets the RebarContainerItem to be hidden or unhidden in the given view. |
|  | [SetUnobscuredInView](484d706c-e0df-473f-5427-f3eeac17eedc.md) | Sets this rebar container element to be shown unobscured in a view. |
