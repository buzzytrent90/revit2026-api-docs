...
# StructuralAssetWoodParallelCompressionStrength Property  
...
```
```vb
Public Property WoodParallelCompressionStrength As Double
	Get
	Set
```
```cpp
public:
property double WoodParallelCompressionStrength {
	double get ();
