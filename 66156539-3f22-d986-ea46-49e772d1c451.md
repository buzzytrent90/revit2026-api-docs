...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBExportPDFSettings
...
The ExportPDFSettings type exposes the following members.
...
|  | [Create](089c5517-8e5d-7c74-b53b-d59dacb06c5d.md) | Returns an new created ExportPDFSettings element in the document with specified settings. |
...
|  | [FindByName](c7b081d1-a996-7a34-2486-a80af67977ba.md) | Returns settings element by name. |
|  | [GetActivePredefinedSettings](2ccf1b3b-786a-4cb4-c9e9-962c42a05d92.md) | Gets the active settings element in the document. |
...
|  | [GetOptions](f5d51aa8-71ae-0526-1668-e0d97eb8315e.md) | Gets a copy of options from settings for exporting. Modification on this options would not change the element. |
...
|  | [IsValidName](854b7152-17e2-8bc4-2fb4-2fd2f571812e.md) | Returns result that the proposed name is valid and not exist in the specified document. |
...
|  | [ListNames](7ad9e021-bd2f-5b85-2138-b7698e41b71a.md) | Returns all the names of the settings instances in the document. |
...
|  | [SetOptions](146cd6a1-7f80-a2dc-b1f3-525900536b9f.md) | Sets options for exporting. |
