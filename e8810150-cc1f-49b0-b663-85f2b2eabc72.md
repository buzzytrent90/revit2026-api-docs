...
# PanelScheduleViewGetLoadClassificationConnectedLoad Method  
...
```
```vb
Public Function GetLoadClassificationConnectedLoad ( 
	nRow As Integer,
	nCol As Integer
) As String
```
...
```
```fsharp
member GetLoadClassificationConnectedLoad : 
        nRow : int * 
        nCol : int -> string 
```
...
String The total load for the given Load Classification 
