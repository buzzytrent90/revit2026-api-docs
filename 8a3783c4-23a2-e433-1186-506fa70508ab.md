...
SystemObject [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSection](65b59d7d-bd7b-c71b-7159-dfc506a912ee.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionRectangular](fc038108-6279-839c-285b-effe342b4491.md) [Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionHotRolled](60cc6328-1e99-2a7b-03fb-983e52350e55.md) Autodesk.Revit.DB.Structure.StructuralSectionsStructuralSectionIWideFlange
...
```csharp
public class StructuralSectionIWideFlange : StructuralSectionHotRolled
```
```vb
Public Class StructuralSectionIWideFlange
	Inherits StructuralSectionHotRolled
```
```cpp
public ref class StructuralSectionIWideFlange : public StructuralSectionHotRolled
```
```fsharp
type StructuralSectionIWideFlange = 
    class
...
The StructuralSectionIWideFlange type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [StructuralSectionIWideFlange](fdb350a4-936d-d3fd-16ef-d11a8eb8ffc5.md) | Creates a new instance of Structural Section I Wide Flange shape with the associated set of parameters, used to attach to structural element. |
...
|  | [BoltDiameter](4aa7f0e0-be83-326b-81ca-f0aa3db6ac97.md) | Maximum bolt hole diameter, in. (mm) |
|  | [BoltSpacing](36e99673-dac2-c460-c937-37c9ad40a6af.md) | Standard bolt spacing, in. (mm) |
|  | [BoltSpacingBetweenRows](619f9685-4fe6-fa01-214b-23436c7d4a1b.md) | Standard bolt spacing between rows, in. (mm) |
|  | [BoltSpacingTwoRows](f054f8e2-65b2-d498-0f24-15ec3abf8fc1.md) | Standard bolt spacing for two rows , in. (mm) |
...
|  | [ClearWebHeight](9df0eb2c-2a95-fcfd-840d-886455074f7d.md) | Detailing depth between the web toes of the fillets, in.(mm) |
...
|  | [FlangeToeOfFillet](a4d0c0cc-a503-8036-f8e1-3f8da5bfeff0.md) | Detailing distance from center of web to flange toe of fillet, in. (mm) |
...
|  | [WebToeOfFillet](f7a6c67e-019b-266d-e147-4abd705b4607.md) | Detailing distance from outer face of flange to web toe of fillet, in. (mm) |
