...
SystemObject [Autodesk.Revit.DB.VisualAssetProperty](7be89499-d011-ab43-4715-0ee6f9335970.md) Autodesk.Revit.DB.VisualAssetPropertyDoubleArray2d
...
```
```fsharp
type AssetPropertyDoubleArray2d = 
    class
...
The AssetPropertyDoubleArray2d type exposes the following members.
