...
```
```vb
Public Shared ReadOnly Property TileBrickType As String
	Get
```
```cpp
public:
static property String^ TileBrickType {
	String^ get ();
}
```
```fsharp
static member TileBrickType : string with get
```
