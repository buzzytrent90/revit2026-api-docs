...
Public Sub New ( 
	...
	boltSpacingTwoRows As Double,
	boltSpacingBetweenRows As Double,
...
new : 
        ...
        boltDiameter : float -> StructuralSectionIWideFlange
```
...
boltSpacingTwoRows Double
     Standard bolt spacing for two rows , in. (mm) 
boltSpacingBetweenRows Double
