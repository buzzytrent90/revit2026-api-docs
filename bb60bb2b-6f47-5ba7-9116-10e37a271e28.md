...
# PlasticVinylPlasticvinylBumpAmount Property  
...
```csharp
public static string PlasticvinylBumpAmount { get; }
```
```vb
Public Shared ReadOnly Property PlasticvinylBumpAmount As String
	Get
```
```cpp
public:
static property String^ PlasticvinylBumpAmount {
	String^ get ();
}
```
```fsharp
static member PlasticvinylBumpAmount : string with get
```
