...
# BuiltInFailuresRebarFailures Class  
  
---  
  
Failures about Rebar. 

SystemObject Autodesk.Revit.DBBuiltInFailuresRebarFailures

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public static class RebarFailures
```
```vb
Public NotInheritable Class RebarFailures
```
```cpp
public ref class RebarFailures abstract sealed
```
```fsharp
[<AbstractClassAttribute>]
[<SealedAttribute>]
type RebarFailures = class end
```


The BuiltInFailuresRebarFailures type exposes the following members.
