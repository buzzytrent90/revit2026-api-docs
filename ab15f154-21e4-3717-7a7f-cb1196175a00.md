...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBDimension](210f88be-e3c5-26a4-7dd8-3296f6725cce.md) Autodesk.Revit.DBLinearDimension
...
```
```cpp
public ref class LinearDimension : public Dimension
```
```fsharp
...
The LinearDimension type exposes the following members.
...
|  | [Create](8e943cee-9e1e-66e6-b283-a6beec46a375.md) |  |
