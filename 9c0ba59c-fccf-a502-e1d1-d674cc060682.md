...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) [Autodesk.Revit.DBMEPCurve](38714847-0f40-7021-aa79-2884c3a02ce2.md) [Autodesk.Revit.DB.ElectricalCableTrayConduitBase](8a5c2986-28de-9e30-cb9f-c6997bff3940.md) Autodesk.Revit.DB.ElectricalConduit
...
```csharp
public class Conduit : CableTrayConduitBase
```
```vb
...
```
```cpp
public ref class Conduit : public CableTrayConduitBase
```
```fsharp
type Conduit = 
    class
...
The Conduit type exposes the following members.
...
|  | [Create](d54ff31b-353b-eb13-337c-cee8abb021f7.md) | Creates a new instance of conduit. |
...
|  | [IsValidConduitType](96ef9f2c-049a-19ee-8011-f4fd96cd9a67.md) | Identifies if a conduit type is valid. |
