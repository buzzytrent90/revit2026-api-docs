...
IList[TessellatedBuildIssue](123454f4-f295-c687-213b-da97c032aba6.md) Array of issues encountered while processing a face set with index 'setIndex'. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | 'SetIndex' is a valid face set index for the results stored in 'this'. |
