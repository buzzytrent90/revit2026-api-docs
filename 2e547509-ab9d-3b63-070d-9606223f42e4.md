...
# ParameterTypeIdAnalyticalModelRotation Property  
...
```
```vb
Public Shared ReadOnly Property AnalyticalModelRotation As ForgeTypeId
	Get
```
```cpp
public:
static property ForgeTypeId^ AnalyticalModelRotation {
	ForgeTypeId^ get ();
}
```
```fsharp
