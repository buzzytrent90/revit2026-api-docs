...
# ConductorSizeGetConductorSizeIds Method  
...
```
```vb
Public Shared Function GetConductorSizeIds ( 
	document As Document
) As IList(Of ElementId)
```
```cpp
public:
static IList<ElementId^>^ GetConductorSizeIds(
	Document^ document
)
```
```fsharp
static member GetConductorSizeIds : 
...
IList[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) All the Conductor Size ids in this document. 
