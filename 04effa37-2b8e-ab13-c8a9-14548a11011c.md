...
# MetallicPaintMetallicpaintPearlColorByObject Property  
...
```csharp
public static string MetallicpaintPearlColorByObject { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintPearlColorByObject As String
	Get
```
```cpp
public:
static property String^ MetallicpaintPearlColorByObject {
	String^ get ();
}
```
```fsharp
static member MetallicpaintPearlColorByObject : string with get
```
