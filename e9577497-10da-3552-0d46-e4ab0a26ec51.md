...
# BuiltInFailuresCopyPasteFailuresCannotCopySunAndShadowSettingsWarn Property  
...
```
```fsharp
static member CannotCopySunAndShadowSettingsWarn : FailureDefinitionId with get
```
