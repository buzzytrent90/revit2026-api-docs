...
Double Resulting maximum value 

| Exception | Condition |
| --- | --- |
| [InapplicableDataException](dc1a6d15-8923-a1fe-722a-4e976634a519.md) | Thrown when current measurement is >= the number of measurements for at least one primitive |
