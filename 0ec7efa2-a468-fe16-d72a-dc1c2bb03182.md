...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) Autodesk.Revit.DBFaceToposolid

**Namespace:** [Autodesk.Revit.DB](87546ba7-461b-c646-cbb1-2cb8f5bff8b2.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 26.0.4.0 (26.0.4.0)

```csharp
public class FaceToposolid : HostObject
```
```vb
Public Class FaceToposolid
	Inherits HostObject
```
```cpp
public ref class FaceToposolid : public HostObject
```
```fsharp
type FaceToposolid = 
    class
...
The FaceToposolid type exposes the following members.
...
|  | [Create](876dcb4e-43f7-a97b-6ba9-71d9246e5a30.md) |  |
...
|  | [GetReferencedFaces](2f6605da-88d6-2c55-33fb-b6033f1b6c22.md) | Gets the referenced faces of the face toposolid |
...
|  | [SetFaceReferences](30a5ca1a-1c37-5f1d-ac4d-68e186c55bcd.md) |  |
|  | ToString | Returns a string that represents the current object.(Inherited from Object) |
|  | [UpdateToFace](73dd131c-498a-128b-c51e-0854b48406ad.md) | Resets the face toposolid to its defining faces. |
