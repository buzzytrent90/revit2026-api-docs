...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.MechanicalMEPAnalyticalSystem
...
```
```vb
Public Class MEPAnalyticalSystem
	Inherits Element
```
```cpp
...
The MEPAnalyticalSystem type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AnalyticalSystemDomain](476d84d6-6569-5035-fdaa-c2e9197532a7.md) | The type of analytical system. |
...
|  | [Create](1cf0dc6c-c055-fc72-5b53-6c9262fe981f.md) | Creates a new analytical system |
...
|  | [GetAirSystemData](aae8a5b1-1302-fac4-1bb2-799179d3d18e.md) | Returns the air system data, null if not available. |
...
|  | [GetWaterLoopData](ef47f29c-aec1-03d7-385b-5c238302e8fd.md) | Returns the water loop data, null if not available. |
