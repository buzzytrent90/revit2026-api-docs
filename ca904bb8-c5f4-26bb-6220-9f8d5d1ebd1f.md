...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureReinforcementSettings
...
The ReinforcementSettings type exposes the following members.
...
|  | [HostStructuralRebar](e778d21b-369f-ffc2-ab0f-9191fec3cd8f.md) | Host Structural Rebar within Area and Path Reinforcement with touching AtomHostStructuralRebar. |
...
|  | [NumberingMethod](41b7c755-b580-71a4-fa3c-76ed4f4a326a.md) | Identifies the type of the numbering method. |
|  | [NumberVaryingLengthRebarsIndividually](7b74062d-8c65-4145-1d8c-23302ebc5b61.md) | **Obsolete.** Use this option to modify the way varying length bars are numbered (individually or as a whole). |
...
|  | [RebarPresentationInSection](511b0bb9-155f-3397-9a13-d41100fc8d72.md) | The default presentation mode for rebar sets, when: |
...
| [RebarPresentationInView](8a1b166e-3bea-5862-3fa4-996419581c5a.md)|  The default presentation mode for rebar sets, when the view direction is perpendicular to the rebar normal and the rebar set is not cut.   
| [RebarShapeDefinesEndTreatments](1961031f-e056-da42-215f-bf7d3ddcd530.md)|  End Treatments are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
| [RebarShapeDefinesHooks](dac8f11f-7001-41a2-5b51-5d619a4e2231.md)|  Hooks are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
| [RebarVaryingLengthNumberSuffix](4fbbb672-5f0c-fc86-3fce-2b1a16127fff.md)|  A unique identifier used for a bar within a variable length rebar set.   
...
|  | [GetFabricRoundingManager](e8fd5c2d-5fa1-1b02-4e4e-4057680a756e.md) | Returns an object for managing reinforcement rounding override settings used by FabricSheetType and FabricSheet elements. |
...
|  | [GetRebarRoundingManager](0471fc13-76ea-a071-b6b6-f26586ba7dd6.md) | Returns an object for managing reinforcement rounding override settings used by RebarBarTypes, Rebar and RebarInSystem elements. |
|  | [GetReinforcementAbbreviationTag](aa2e274b-4a04-2382-958e-ae8c5da76d34.md) | Gets one abbreviation tag for desired ReinforcementAbbreviationTagType. |
|  | [GetReinforcementAbbreviationTags](c99a81c9-19ec-3983-beb7-e6080a5f6431.md) | Gets a list of abbreviation tags for desired reinforcement object type. |
|  | [GetReinforcementSettings](870cbfee-b1d4-0dd8-3e14-4802f3eafd25.md) | Obtains the ReinforcementSettings object for the specified project document. |
...
|  | [IsEqual](f6924dbf-c3de-6b0a-ba9f-166a9c8a8819.md) | Checks if Reinforcement Settings is equal to other |
...
|  | [SetReinforcementAbbreviationTag](9907ed20-d7dd-f387-01e8-76f66f1c76f2.md) | Sets one abbreviation tag for desired ReinforcementAbbreviationTagType. |
