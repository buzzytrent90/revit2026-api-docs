...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBView](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) Autodesk.Revit.DB.AnalysisViewSystemsAnalysisReport
...
```csharp
public class ViewSystemsAnalysisReport : View
```
```vb
...
```
```cpp
public ref class ViewSystemsAnalysisReport : public View
```
```fsharp
...
The ViewSystemsAnalysisReport type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AnalysisDateAndTime](d16ea8b2-d425-f8ef-7c0b-d1023fe9c81d.md) | Identifies the analysis date and time when it was requested. |
...
|  | [ReportStyle](93f766a8-2575-fdf4-6f05-278c4cf921a6.md) | The report style that specifies the display content. |
...
|  | [SystemsAnalysisOutputFolder](f7814f7b-fdd7-79cc-bda3-7b6bd4906ed1.md) | The full path of the output folder for systems analysis. |
|  | [SystemsAnalysisWorkflowFile](afa99f32-2a4f-94bc-d06a-164df200e060.md) | The full path name of the original system analysis workflow file. |
...
|  | [WeatherFile](e1ae6850-4df0-d36d-3dfc-7f40acd06706.md) | The full path name of the weather file used for the systems analysis. |
...
|  | [CancelSystemsAnalysis](71520a3b-a4f6-fbd7-904d-ddd520465a5b.md) | Cancels the systems analysis based on the report element id. |
...
|  | [Create](860c6374-1268-f064-22a6-f8121ec0fc17.md) | Creates a new view for the systems analysis report. |
...
|  | [GetLatestSystemsAnalysisReport](e5aabba3-038a-3017-081b-9b1b82cf7872.md) | Gets the latest report of systems analysis. |
...
|  | [GetReportContent](cdfa90f1-c57a-6a0d-3da9-ae6396525658.md) | Gets the report content in this view. |
...
|  | [IsAnalysisCompleted](b3e54d65-dac8-50da-d25d-655e07b942ad.md) | Indicates if the background systems analysis has completed or not. |
...
|  | [RequestSystemsAnalysis](b36cb95e-9857-9028-4587-86fdb6767cbc.md) | Requests a new systems analysis to be run in the background. |
