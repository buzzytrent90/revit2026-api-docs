...
# BendingDetailCustomFieldPropertiesSegmentLengthDimensionTypeId Property  
...
| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The segmentLengthDimensionTypeId should be an id of a linear dimension type. |
