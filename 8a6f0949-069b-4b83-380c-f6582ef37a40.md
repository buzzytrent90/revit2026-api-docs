...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBWorksetDefaultVisibilitySettings
...
```
```fsharp
type WorksetDefaultVisibilitySettings = 
    class
        inherit Element
    end
```
...
The WorksetDefaultVisibilitySettings type exposes the following members.
...
|  | [GetWorksetDefaultVisibilitySettings](9dc63e54-f45b-b479-1b61-50578abe3e6f.md) | Get the WorksetDefaultVisibilitySettings of the document. |
...
|  | [IsWorksetVisible](1b15a741-d1a0-e791-5d93-d59773ecc137.md) | Indicates whether the workset is visible by default. |
...
|  | [SetWorksetVisibility](cc477191-cc03-6dbf-48b7-fd08f83d75b6.md) | Set the default visibility of a workset. |
