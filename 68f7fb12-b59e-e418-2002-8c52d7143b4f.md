...
# ParameterFilterRuleFactoryCreateContainsRule Method  
...
```
```vb
Public Shared Function CreateContainsRule ( 
...
```cpp
public:
static FilterRule^ CreateContainsRule(
	ElementId^ parameter, 
	String^ value
)
```
```fsharp
static member CreateContainsRule : 
        parameter : ElementId * 
