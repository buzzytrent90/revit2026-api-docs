...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureAreaReinforcement
...
```
```vb
Public Class AreaReinforcement
	Inherits Element
```
```cpp
...
The AreaReinforcement type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [AdditionalBottomCoverOffset](dca7d7af-c539-7712-9f12-f2a16fd160d6.md) | Additional offset from the bottom or interior cover reference. |
|  | [AdditionalTopCoverOffset](f48b73e5-5690-0a18-ee73-fc2d63ab201f.md) | Additional offset from the top or exterior cover reference. |
|  | [AreaReinforcementType](c653d882-ddde-c6bf-806d-add2df555275.md) | Retrieves the type of the Area Reinforcement. |
...
|  | [Direction](7ff9e4ed-e3e9-4bf6-b306-be10c3854d93.md) | Retrieve the Major Direction of the Area Reinforcement. |
...
|  | [ConvertRebarInSystemToRebars](0b655f89-d5c2-eef1-8900-67601a478b1a.md) | Converts all RebarInSystem elements owned by the input AreaReinforcement to equivalent Rebar elements. |
...
|  | [GetBoundaryCurveIds](75225104-99db-98f2-d407-6ee8f48ad9ae.md) | Retrieves the set of curves forming the boundary of the Area Reinforcement. |
...
|  | [GetHostId](f01b201e-507f-0100-6d58-de49f981a449.md) | The element that contains the Area Reinforcement. |
|  | [GetLayerDirection](bccd4ced-ea99-d3ba-0865-7fd8f8466d29.md) | Gets the direction of the layer. The lines are distributed along this direction. |
|  | [GetLineFromLayerAtIndex](8fa3c4da-89e0-28a5-d6dc-30f675dbb04b.md) | Gets the line from the desired layer at the specified index. |
...
|  | [GetMovedLineTransform](d07d2b3b-98ae-6ede-cc91-2d0bde1a4044.md) | Returns a transform representing the movement of the line relative to its default position along the direction of the desired layer. |
|  | [GetNumberOfLines](dff33b0e-1669-d318-5225-bd8472529eee.md) | Gets the number of lines on the specified layer. It also counts the excluded ones. |
...
|  | [GetRebarInSystemIds](164ad9af-4034-ca8b-d7f6-2e108becf7e1.md) | Returns the ids of the RebarInSystem elements owned by the AreaReinforcement element. |
...
|  | [IsLayerActive](547599ea-6b67-5d1e-7486-207e2764df70.md) | Identifies if the layer is active or not. |
|  | [IsLineIncluded](8ee8ebea-8c10-9feb-c76d-735d5ade33a0.md) | Checks whether the line from the desired layer at the specified position is included or not. |
...
|  | [IsUnobscuredInView](e68d430f-1cd3-be82-f495-438876dac18b.md) | Checks if Area Reinforcement is shown unobscured in a view. |
...
|  | [MoveLine](4fe8818c-3647-3e08-3bad-34452230ee1a.md) | This method applies the translation to the line from the desired layer, at the specified position. If the line was already moved, the method will concatenate the translation with the existing movement. The line will be translated only along the direction of the specified layer. |
...
|  | [RemoveAreaReinforcementSystem](497ef418-b0cc-e0a2-34d1-67ef49274801.md) | Deletes the specified AreaReinforcement, and converts its RebarInSystem elements to equivalent Rebar elements. |
|  | [ResetMovedLineTransform](b44bf1dd-1cdb-50e2-59ab-b7894566019d.md) | Reset the transformation representing the movement of the line relative to its default position along the direction of the specified layer. The moved line transform will be set to Identity. |
...
|  | [SetLayerActive](47b31cd0-84ba-13e3-4a6d-66a3356d3b75.md) | Sets if the desired layer is active or not. |
|  | [SetLineIncluded](c735a91d-97a6-7944-1456-4fa495ac1609.md) | Sets if the line from desired layer at the specified position is included or not. |
|  | [SetUnobscuredInView](53acd3ec-3d4e-ea81-67af-de3512d5d875.md) | Sets Area Reinforcement to be shown unobscured in a view. |
