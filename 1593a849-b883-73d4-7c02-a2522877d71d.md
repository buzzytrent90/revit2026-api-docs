...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructurePathReinforcement
...
```
```vb
Public Class PathReinforcement
	Inherits Element
```
```cpp
...
The PathReinforcement type exposes the following members.
...
|  | [ConvertRebarInSystemToRebars](860c0773-13e2-00be-eeb8-25afa57fe2be.md) | Converts all RebarInSystem elements owned by the input PathReinforcement to equivalent Rebar elements. |
...
|  | [GetCurveElementIds](6a17f4fa-5d3a-2e3b-ce1c-fefa0dd941dd.md) | Retrieves the set of ElementIds of curves forming the boundary of the Path Reinforcement. |
...
|  | [GetHostId](61909903-e670-132a-cd41-07f85ff6302b.md) | The element that contains the Path Reinforcement. |
...
|  | [GetOrCreateDefaultRebarShape](4db777aa-4687-e1c1-3104-0fa1c8d9e576.md) | Creates a new RebarShape object with a default name or returns existing one which fulfills Path Reinforcement bending data requirements. |
...
|  | [GetRebarInSystemIds](66d7ac46-c022-c65a-0c18-4fdedb77c5f6.md) | Returns the ids of the RebarInSystem elements owned by the PathReinforcement element. |
...
|  | [IsAlternatingLayerEnabled](2f3af8f8-18c1-8b9f-2ed4-2d049260af86.md) | Checks if alternating bars are present in Path Reinforcement. |
...
|  | [IsUnobscuredInView](051a0fc5-cd26-7756-1331-d532639d5ac3.md) | Checks if Path Reinforcement is shown unobscured in a view. |
|  | [IsValidAlternatingBarOrientation](8bf22e76-2e49-688a-0701-fafddc316572.md) | Checks if orientation for alternating bars is valid. |
|  | [IsValidPrimaryBarOrientation](96ef910c-7689-9aaa-3637-50826bce3f54.md) | Checks if orientation for primary bars is valid. |
|  | [IsValidRebarShapeId](0d570de9-c041-3bf2-dff7-47720ee6ace7.md) | Identifies whether an element id corresponds to a Rebar Shape element which can be used in Path Reinforcement. |
...
|  | [RemovePathReinforcementSystem](f363e5b7-056b-4fa2-7b0f-388614effd85.md) | Deletes the specified PathReinforcement, and converts its RebarInSystem elements to equivalent Rebar elements. |
...
|  | [SetUnobscuredInView](5533aeb2-dc1f-a329-165e-2107272a0fc3.md) | Sets Path Reinforcement to be shown unobscured in a view. |
