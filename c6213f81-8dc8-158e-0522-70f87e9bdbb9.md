...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DBImageType
...
|  | [CanReload](6090600f-8d4c-511d-a7c5-a21caf768bfc.md) | Check whether the ImageType can be reloaded from file. |
...
|  | [Create](31bb13e3-e8f5-cb66-18d0-619578d56cde.md) | Creates a new ImageType element and loads the image into it. |
...
|  | [GetImage](39ae2f0d-11f1-96be-e12b-bfbc4a6c7fae.md) | Get the bitmap image stored in the image symbol. |
...
|  | [Reload](9d45a435-bf47-e6a7-15b2-7f5584d260ec.md) | Reloads the ImageType from the file found at the location specified by the [Path](11e87696-9900-94f4-48f9-2e307dd9aae1.md) property, using the same [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.md) and resolution. |
|  | [ReloadFrom](e009ad38-c172-fdf4-56b8-c3be5940cc05.md) | Reloads the image in the ImageType from a new image file, and for a new [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.md). |
...
|  | [Unload](386b1797-4550-8e3d-d67e-0ac45e2091b0.md) | Unload the linked image. |
  
ImageType elements are created with the ImageType.Create(Document, ImageTypeOptions) method.

ImageType elements can be loaded from the following file types: *.bmp, *.jpg, *.jpeg, *.png, *.tif, *.pdf.
