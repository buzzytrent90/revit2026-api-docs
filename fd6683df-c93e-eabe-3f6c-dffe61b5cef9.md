...
[ParameterDownloadOptions](7359f11b-4102-15f3-597b-51078e1141bc.md) Settings associated with a parameter. 

| Exception | Condition |
| --- | --- |
| [AccessDeniedException](f280ddf5-9f59-eca8-634e-ace30de1f4bb.md) | Thrown when the user is not authorized to access the requested information. |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when the given parameter identifier is empty. |
...
| [ResourceNotFoundException](4ef7bcee-5831-e2c9-ee4a-06a0dd6c255f.md) | Thrown when the requested parameter is not found. |
| [ServerInternalException](dea21550-dd2d-e9d1-4f2f-5f18e0e58bc4.md) | Thrown when the Parameters Service reports an internal error. |
| [UnauthenticatedException](e94e82b6-4345-48ca-7be9-fd8393b0ff7f.md) | Thrown when the user is not signed in. |
