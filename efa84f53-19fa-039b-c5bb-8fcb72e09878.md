...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ArchitectureStairsType
...
The StairsType type exposes the following members.
...
|  | [ConstructionMethod](8d70d0f6-01f8-cc39-0134-71cf1392d0cd.md) | The construction method of the stairs. |
...
|  | [EndConnectionType](d36ce655-b97d-d332-e949-acea34fb3311.md) | The join style between a run and landing. |
...
|  | [HasMiddleSupports](b03dbd12-f514-05bd-e2c4-b1f63e276521.md) | True if the stairs type has middle supports, False otherwise. |
...
|  | [LandingType](65d623c8-e4af-4b8b-092e-62602d11ecc2.md) | The type for all landings in the stair element. |
|  | [LeftLateralOffset](dfc55b30-16bb-91f6-ad31-cc216b23dba3.md) | The offset for the left support from the edge of the run in a horizontal direction. |
|  | [LeftSideSupportType](937a6510-30b8-2a23-3c26-687fa8daa8f3.md) | The type of left support used in the stair. |
...
|  | [MaxRiserHeight](70999f80-decb-bdbb-d251-662dfcd1bf10.md) | The maximum height of each riser on the stair element. |
|  | [MiddleSupportsNumber](d1f30d8c-ee9a-1d4c-448d-655b8c2580e3.md) | The number of middle supports used in the stair. |
|  | [MiddleSupportType](be91b3a0-047b-bf7f-27e4-3a22c1930735.md) | The type of middle supports used in the stair. |
|  | [MinRunWidth](3cfd44c9-9b82-bac2-a532-ad6eec073248.md) | The initial value for the width of a common run. |
|  | [MinTreadDepth](a79f1cad-d339-1636-8025-d306e0deed9a.md) | The minimum tread width along the center path for all common runs (winder, arc, and straight). |
...
|  | [NotchExtension](25d40422-b0c8-e6d4-9f57-f60ad6aabff5.md) | The horizontal length of the notch profile. |
|  | [NotchHorizontalGap](6b88f8cc-2637-305c-49bd-de410ab901f2.md) | The width of the horizontal gap in the stairs notch. |
|  | [NotchThickness](f3c7d0c9-f3e2-5e4d-4e01-20ca3b1d51da.md) | The vertical length of the notch profile from the top. |
|  | [NotchVerticalGap](cb89c3c8-19e9-4c46-7e3b-e8a0fbd4bb86.md) | The width of the vertical gap in the stairs notch. |
...
|  | [RightLateralOffset](f98a476d-ba35-5967-c119-2d64df43a900.md) | The offset for the right support from the edge of the run in a horizontal direction. |
|  | [RightSideSupportType](71dffec6-4011-e761-4abf-be9988206ac3.md) | The type of right support used in the stair. |
|  | [RunType](06c12f95-76c2-8c0f-8124-e4bc15abb080.md) | The type for all runs in the stair element. |
