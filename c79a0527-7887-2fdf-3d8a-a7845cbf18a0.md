...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBCombinableElement](c88bdbbc-dbbb-0817-a358-35f8686f68a2.md) [Autodesk.Revit.DBGenericForm](d64cecab-ceec-407e-6f09-0b83f192aa1a.md) Autodesk.Revit.DBRevolution
...
```
```cpp
public ref class Revolution : public GenericForm
```
```fsharp
type Revolution = 
    class
...
The Revolution type exposes the following members.
