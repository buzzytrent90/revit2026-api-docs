...
# RebarFreeFormAccessorGetCrankTypeIdAtIndex Method  
...
[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The id of a Rebar Crank Type, or invalidElementId if the rebar has no crank at the specified end. 

| Exception | Condition |
| --- | --- |
| [ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | end must be 0 or 1. -or- barPositionIndex is not in the range [ 0, NumberOfBarPositions-1 ]. |
  
If this Rebar has Workshop Instructions set to Straight will return the same value for all barPositionIndex between 0 and (NumberOfBarPositions-1). This value will be the same as Rebar.GetCrankTypeId(int end).
