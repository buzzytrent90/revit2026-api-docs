...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.ElectricalCableType
...
```csharp
public class CableType : ElementType
```
```vb
...
```
```cpp
public ref class CableType : public ElementType
```
```fsharp
type CableType = 
    class
...
The CableType type exposes the following members.
...
|  | [ConductorMaterial](a4434c41-3c6c-c765-8cfe-279964624a89.md) | The Conductor Material of this Cable Type. |
|  | [CoreType](07baf32c-d991-4815-0294-5fee8776fe14.md) | The core type of the cable type. |
...
|  | [InsulationMaterial](a5e64eac-f684-0f2b-6ceb-23978e74c132.md) | The Conductor Insulation Material of this Cable Type. |
...
|  | [TemperatureRating](c395500d-e70a-71ec-d28a-40df8de79212.md) | The Conductor Temperature Rating of this Cable Type. |
...
|  | [Create](6a431d13-9d9e-f327-d434-eb5b4ccc3461.md) | Creates a Cable Type. |
...
|  | [Duplicate](d57265c5-70e8-4afa-341d-30004e15afa5.md) | Duplicates this Cable Type. |
|  | [Duplicate(String)](b0e7d5d5-f33a-8ff2-b471-78a213f06ef5.md) | Duplicates an existing element type and assigns it a new name. (Inherited from [ElementType](ffb18296-0448-559c-580c-7857cbcdc094.md)) |
...
|  | [GetCableTypeId](11a353a8-f6ae-a21b-c1d9-84d3f2d494fa.md) | Gets the Cable Type id by given cable type name. |
|  | [GetCableTypeIds](aa1891c3-3f36-e4f2-692f-cd0c8b15eef3.md) | Gets all the Cable Types in the given document, sorted by name. |
...
|  | [GetUsableCableSizeIds](9a1cfa5b-601f-285f-e2c6-a009e1e0c922.md) | Gets all the Cable Sizes that can be used by this Cable Type, sorted by name. |
...
|  | [IsCableSizeUsable](8488b8a0-1bf8-bf15-9c4f-3326b95d5fd1.md) | Checks whether the Cable Size can be used by this Cable Type or not. |
...
|  | [SetCableSizeUsable](2a0a7f44-9dcf-584e-0270-e8fbbddee4d0.md) | Marks the Cable Size can be used by this Cable Type. |
