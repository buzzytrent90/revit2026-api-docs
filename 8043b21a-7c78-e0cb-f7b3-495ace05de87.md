...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DBDividedPath
...
|  | Name | Description |
| --- | --- | --- |
|  | [AreCurveReferencesConnected](09b53bab-9266-08d6-f620-97d3f09b8756.md) |  |
...
|  | [Flip](745dae0f-0ae7-e751-48f2-11a22b963d93.md) | Toggle the flipped value |
...
|  | [GetIntersectingElements](fbdf6393-21be-362e-4033-56b62b2aff2c.md) | Get the elements whose intersection with path produces points. |
...
|  | [IsCurveReferenceValid](04a861e9-15d3-08bf-0fc6-4e73b4c4b1e1.md) | This returns true if the reference represents a curve or edge that can be used to create a divided path. |
...
|  | [IsIntersectorValidForCreation](fef969d9-4a6a-5aeb-d492-79eee88f9db5.md) | This returns true if the intersector is an element that can be used to intersect with a newly created divided path. |
|  | [IsIntersectorValidForDividedPath](af6d278b-df1c-40bb-a732-0f763e5da5f5.md) | This returns true if the intersector is an element that can be used to intersect with the divided path. |
...
|  | [IsValidBeginningIndent](0221624f-9a19-863b-28a4-2b44aea26509.md) | Checks that the indent value does not cause the beginningIndent and endIndent to overlop |
|  | [IsValidEndIndent](891b6c7f-ba0a-1e91-7eda-3672a7c3dcbe.md) | Checks that the indent value does not cause the beginningIndent and endIndent to overlop |
|  | [IsValidFixedNumberOfPoints](b5f78696-94a1-e7f7-1f8d-90312956f2ff.md) | Identifies if the indicated number of points is valid for assignment to a DividedPath with a layout type 'FixedNumber'. |
|  | [IsValidMeasurementType](0c0e00f5-bbd5-4407-9631-f55323ec970e.md) | Checks that the measurement type enumeration value is valid |
|  | [IsValidSpacingRuleJustification](6e459f58-641a-25b8-affb-19a220ec662e.md) | Checks that the justification enumeration value is valid |
|  | [IsValidSpacingRuleLayout](0fcb3940-a2ff-837f-b33e-f0cb6fa0eba8.md) | Checks that the spacing rule layout enumeration value is valid |
...
|  | [SetIntersectingElements](77d59f55-d70a-35b8-aacd-fb66a53223b9.md) |  |
