...
IList[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The created landing(s) between the two stairs runs. 

| Exception | Condition |
| --- | --- |
| [ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The firstRunId is not a valid stairs run. -or- The secondRunId is not a valid stairs run. -or- The stairs runs firstRunId and secondRunId belong to different stairs host. |
| [ArgumentNullException](631e1424-60f4-929b-4e52-dda9dcd26316.md) | A non-optional argument was null |
| [InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The stairs element to which the stairs component firstRunId belong is not in an active StairsEditScope. -or- Cannot create automatic landing(s) between stairs runs of firstRunId and secondRunId. |
...
| [RegenerationFailedException](787bb389-74c2-5ce7-cdd6-32211209ded2.md) | Failed to create automatic landing(s) due to document regeneration failures. |
