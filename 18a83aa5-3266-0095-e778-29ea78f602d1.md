...
# PanelScheduleViewGetLoadClassificationDemandFactor Method  
...
```
```vb
Public Function GetLoadClassificationDemandFactor ( 
	nRow As Integer,
	nCol As Integer
) As String
```
```cpp
public:
String^ GetLoadClassificationDemandFactor(
	int nRow, 
	int nCol
)
```
```fsharp
member GetLoadClassificationDemandFactor : 
        nRow : int * 
        nCol : int -> string 
```
...
String The Demand Factor for the given Load Classification 
