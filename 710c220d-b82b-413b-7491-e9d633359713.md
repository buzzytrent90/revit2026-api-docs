...
ISet[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Returns the set of element identifiers of fabrication part straights that were updated. 

The set of element identifiers were created by calling [ValidateConnectionsForAllFabricationParts](c514bccb-d434-8ea3-b0da-d2cd3a4d617d.md) with the option updateGapForStraights set to true. 
