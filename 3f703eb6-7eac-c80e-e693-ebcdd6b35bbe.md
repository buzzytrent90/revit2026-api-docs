...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DB.StructureLoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md) Autodesk.Revit.DB.StructurePointLoad
...
|  | [ForceVector](b21413c1-0b57-a52a-6de4-a43e4817e169.md) | The force vector applied to the point load, oriented according to OrientTo setting. |
...
|  | [HostElementId](c0fc581d-431e-0749-e7d9-7218e9b426c8.md) | The host element ID for the load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [IsConstrainedOnHost](355eed18-c9de-4a00-29fa-82ca04462a6a.md) | The load is constrained to host or not. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
|  | [IsHosted](76965c6d-473a-9ad9-8a72-baa7a47b055a.md) | Indicates if the Load is hosted or non-hosted. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [IsReaction](3d159400-28fb-9f92-b4b1-1aab870c21f0.md) | The load is reaction option. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [LoadCase](f0d56d0d-dc16-1fb2-f27f-70a989f6bbcf.md) | The load case for the load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
|  | [LoadCaseId](8bb0908c-30a7-f090-7586-b1bab8e8cc42.md) | The load case ID for the load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
|  | [LoadCaseName](9bf650db-2f9c-08c3-ad05-33ce349b9134.md) | The name of the load case to which this load belongs. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
|  | [LoadCategoryName](4a1c7865-8f07-b291-6cc8-fb23a842dad8.md) | The name of the category to which this load belongs. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
|  | [LoadNatureName](3f764b90-19b0-8fbb-50ae-f38400a89676.md) | A string representing the nature of the load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [MomentVector](ae7ef94a-aaa7-a5d5-a567-3108a351c177.md) | The moment vector applied to the point load, oriented according to OrientTo setting. |
...
|  | [OrientTo](c1252918-899f-23f0-c3e8-c0e5817ef812.md) | The load orientation option. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [Point](65e1dc52-453d-4eda-54a2-3c8a4c100dac.md) | Returns the position of point load, measured in decimal feet. |
...
|  | [WorkPlaneId](19d3d2d4-82e9-465a-5cf4-d3e613ad238f.md) | Id of the work plane which may determine the orientation of the load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [IsOrientToPermitted](8681b54f-c427-9024-9ede-98ec917d0f8d.md) | Indicates if the provided orientation is permitted for this load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
...
|  | [IsPointInsideHostBoundaries](994add06-c832-952e-38b0-1f9d30e51047.md) | Indicates if the point is inside panel's boundaries or if the point is on the member's curve.. |
|  | [IsValidHostId](c5304968-914f-7e7e-ea26-ffd6e1dee6d5.md) | Indicates if the provided host id can host point loads The document containing both the host and the load The id of the analytical element that is about to host a point load True if a point load can be placed on the input host id |
...
|  | [RemoveHostConstraint](f94ac73c-c975-70e5-f905-966439f5163a.md) | Removes constraint from host for this load. (Inherited from [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md)) |
