...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.StructureStructuralConnectionHandler
...
```
```vb
Public Class StructuralConnectionHandler
	Inherits Element
```
```cpp
...
The StructuralConnectionHandler type exposes the following members.
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddElementIds](707dc3c9-bd26-65b2-14ae-2e345c5ad977.md) |  |
|  | [AddReferences](e3df730c-4e40-92ee-714c-f2beae290839.md) |  |
...
|  | [CreateGenericConnection](887e1ee2-72cd-b3f4-0d1b-e3cfc82b0f07.md) |  |
...
|  | [GetConnectedElementIds](0c30ce4f-eef8-fd20-529f-c7b0983998dc.md) | Retrieves list of element ids of connected elements. |
...
|  | [GetInputPoint](c7a4dc5e-bc26-0987-4995-2c5d2dbcee70.md) | Returns point with specified id. Returns null if specified point does not exist |
|  | [GetInputPoints](1b74c240-55f5-c1ab-1e78-57bba4090a66.md) | Returns a list of additional points defining certain connections. |
|  | [GetInputReferences](64f39922-a906-19ae-bfa0-0642910eefdb.md) | Gets references of input elements. |
...
|  | [GetOrigin](de922052-21bc-5958-8c4b-d4398ead0a88.md) | Retrieves origin point of Structural Connection Handler element. |
...
|  | [IsCustom](f0a922df-ec34-9170-0963-86edc9243628.md) | Checks if Structural Connection Handler has the custom connection style. |
...
|  | [IsDetailed](218fb7c4-0752-74ea-2403-82f24b235e00.md) | Checks if Structural Connection Handler has the detailed connection style. |
...
|  | [RemoveElementIds](ae145719-5699-3f78-d995-981319b4703f.md) |  |
|  | [RemoveReferences](aded3846-21ad-e351-5c2a-c7bbfe1b0682.md) |  |
|  | [SetDefaultElementOrder](7b74ec8e-5790-0caa-5045-ef0ff72128fc.md) | Sorts the connected elements connection according to structural categories, element materials and geometries. The steel element is set rather than an element of other material. The priorities of the elements are set according structural categories in following order: columns, framings, walls, foundations, floors. In case of several Structural Framing elements order is determined by cutting - the cutting element is set as the primary one rather than element being cut. |
