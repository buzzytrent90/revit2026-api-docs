...
# BuiltInFailuresPerformanceFailures Class  
  
---  
  
Failures which give hints pointing to situations where performance could be improved. 

SystemObject Autodesk.Revit.DBBuiltInFailuresPerformanceFailures
...
[<SealedAttribute>]
type PerformanceFailures = class end
```


The BuiltInFailuresPerformanceFailures type exposes the following members.
