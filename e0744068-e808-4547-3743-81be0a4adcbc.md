...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBHostObject](56a32e0b-df65-a6ba-40bd-8f50a1f31dcd.md) Autodesk.Revit.DBHostedSweep [Autodesk.Revit.DB.ArchitectureFascia](04faa348-80ad-397d-60f5-dd931924e294.md) [Autodesk.Revit.DB.ArchitectureGutter](ca383537-7a16-718f-e527-a05dbdd2353e.md) [Autodesk.Revit.DBSlabEdge](8c1ba09e-d1d0-b1e4-bc2f-26ec4b6c5afa.md)
...
```
```vb
Public MustInherit Class HostedSweep
	Inherits HostObject
```
```cpp
...
The HostedSweep type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [Angle](beb95fa6-6296-2631-f30c-1fc71b3b03c5.md) | Retrieve/set the angle of the hosted sweep object relative its references (Unit : Radian). |
...
|  | [HorizontalFlipped](bf5a61c7-e8d5-631d-749a-659084be1723.md) | Retrieve the horizontal flip status of the hosted sweep object. |
|  | [HorizontalOffset](a7da1c98-55e0-b0eb-fbf4-165d7d424924.md) | Retrieve/set the horizontal offset of the hosted sweep object. |
...
|  | [Length](5f5119d2-7b2f-1a17-0ba3-ef74cbe984e9.md) | Retrieve the length of the hosted sweep object. |
...
|  | [ReferenceCurve](76c8b986-670c-1d4a-3ae4-776b3eb29ad9.md) | The curve on which the hosted sweep segment is created. |
...
|  | [VerticalFlipped](3919a432-3aed-5230-b89a-2346d2f769ca.md) | Retrieve the vertical flip status of the hosted sweep object. |
|  | [VerticalOffset](8b3de2d4-3005-afc9-cbc5-1862fd60341e.md) | Retrieve/set the vertical offset of the hosted sweep object. |
...
|  | Name | Description |
| --- | --- | --- |
|  | [AddSegment](c26f908b-140a-6f06-918d-263efe814df9.md) | Add segments to the hosted sweep object. |
...
|  | [GetEndPointParameter](9d932372-7418-6e37-6764-0cc0994959df.md) | Retrieve segment's start point or end point parameter. |
...
|  | [HorizontalFlip](c64cb45b-74b9-acef-db86-62931b11b1ee.md) | Flip the hosted sweep object along horizontal line. |
...
|  | [RemoveSegment](14ff1a00-0fd1-cc28-a20f-9e3b00083488.md) | Remove segments from the hosted sweep object. |
|  | [SetEndPointParameter](de365ff6-a402-a803-43de-c9efc847fccd.md) | Set segment's start point or end point parameter. |
...
|  | [VerticalFlip](481bf9a1-1437-9da7-0589-35d7bb9d7428.md) | Flip the hosted sweep object along vertical line. |
