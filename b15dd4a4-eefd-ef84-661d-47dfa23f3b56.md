...
# MetallicPaintMetallicpaintPearl Property  
...
```csharp
public static string MetallicpaintPearl { get; }
```
```vb
Public Shared ReadOnly Property MetallicpaintPearl As String
	Get
```
```cpp
public:
static property String^ MetallicpaintPearl {
	String^ get ();
}
```
```fsharp
static member MetallicpaintPearl : string with get
```
