...
# PlasticVinylPlasticvinylApplication Property  
...
```csharp
public static string PlasticvinylApplication { get; }
```
```vb
Public Shared ReadOnly Property PlasticvinylApplication As String
	Get
```
```cpp
public:
static property String^ PlasticvinylApplication {
	String^ get ();
}
```
```fsharp
static member PlasticvinylApplication : string with get
```
