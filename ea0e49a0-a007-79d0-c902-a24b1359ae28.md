...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) Autodesk.Revit.DB.ArchitectureStairsRun
...
|  | Name | Description |
| --- | --- | --- |
|  | [ActualRisersNumber](96279390-3c60-17bb-30a3-6be20f235db8.md) | The actual number of stairs risers in the stairs run. |
|  | [ActualRunWidth](bdf55936-55bd-fc08-ffb4-8636f9523e9d.md) | Specifies the value of the tread width excluding the width of independent side supports. |
|  | [ActualTreadsNumber](14adde99-ed13-07a8-26c9-d66b6faeaa62.md) | The actual number of stairs treads in the stairs run. |
...
|  | [BaseElevation](9ba0ccee-9ac2-0c0a-12de-11a14f3ae5f0.md) | The base elevation of the stairs run. |
|  | [BeginsWithRiser](26a3216c-bafa-e8d3-a55d-1a3bf0a1f522.md) | True if the stairs run begins with a riser, false otherwise. |
...
|  | [EndsWithRiser](e41f2154-eb17-c301-592a-30e35c982e67.md) | True if the stairs run ends with a riser, false otherwise. |
|  | [ExtensionBelowRiserBase](31d69dbe-84d3-e559-20a0-f50d98c16820.md) | Specifies a value to extend/trim the run's first step against base elevation of the stairs if the stairs begins with a riser. |
|  | [ExtensionBelowTreadBase](62bf2199-bce0-9eb6-62f3-5a5987586273.md) | Specifies a value to extend/trim the run's first step against base elevation of the stairs if the stairs begins with a tread. |
...
|  | [Height](ec9100da-66e5-b146-f2e5-6797ec63fe89.md) | The calculated height of the stairs run. |
...
|  | [LocationLineJustification](042f94e0-29af-deac-5bcd-baec4075a866.md) | The position of the run relative to the Up-direction path used to create the run. |
...
|  | [StairsRunStyle](07464cfb-9532-f76a-5b25-a013dd9c93e0.md) | The style of the stairs run such as straight, winder, etc. |
|  | [TopElevation](d4292003-1fe1-1eeb-20f9-a5b25acaa1eb.md) | The top elevation of the stairs run. |
...
|  | [CreateSketchedRun](bb782d95-4792-8335-401c-97170542b96b.md) |  |
|  | [CreateSketchedRunWithSlopeData](617ef98f-bb7b-c4ec-0342-bf2b4d743ff8.md) |  |
|  | [CreateSpiralRun](2f31d042-a202-a1a4-42fe-998b02e26a4d.md) | Creates a spiral run in the project document by providing the center, start angle and included angle. |
|  | [CreateStraightRun](54fd7462-c16c-41bf-705f-ede3af0bc572.md) | Creates a straight run in the project document. |
...
|  | [GetAllSupports](a860f418-9de2-3600-5105-a48be8544a41.md) | Retrieves all supports hosted by the stair's run. |
|  | [GetConnections](db619f61-5444-37f9-1057-97d35caf5eed.md) | Returns information about the connections in which the stairs run participates. The stairs run may have no connection, or have at maximum two connections at the lower and upper ends. |
