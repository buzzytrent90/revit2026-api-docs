...
# ApplicationIsMechanicalEnabled Property  
...
```
```vb
Public Property IsMechanicalEnabled As Boolean
	Get
	Set
```
```cpp
public:
property bool IsMechanicalEnabled {
	bool get ();
	void set (bool value);
}
```
```fsharp
member IsMechanicalEnabled : bool with get, set
```
