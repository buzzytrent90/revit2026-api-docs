...
SystemObject [Autodesk.Revit.DBElement](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) [Autodesk.Revit.DBElementType](ffb18296-0448-559c-580c-7857cbcdc094.md) Autodesk.Revit.DB.StructureStructuralConnectionType
...
```
```vb
Public Class StructuralConnectionType
...
The StructuralConnectionType type exposes the following members.

|  | Name | Description |
| --- | --- | --- |
|  | [ApplyTo](3d863213-6baf-3eaf-79f4-8f92a294bc93.md) | Choose whether this connection type applies to beams and braces, to tops of columns, or to bases of columns. |
...
|  | [Create](9d198a3e-fe9b-c094-4f5e-cf061382ff3f.md) | Create a new StructuralConnectionType, allowing the specified annotation FamilySymbol to be applied to structural members. |
...
|  | [GetAllStructuralConnectionTypeIds](33908a35-a8d8-dfe1-abd2-a59eaaa77045.md) |  |
...
|  | [GetFamilySymbolId](33ed961b-ba63-84c8-4cea-499ad8c2efc3.md) | FamilySymbol of the annotation to use for this connection type. |
...
|  | [SetFamilySymbolId](991f72fc-ef87-281a-4110-a9964d146c35.md) | FamilySymbol of the annotation to use for this connection type. |
|  | ToString | Returns a string that represents the current object.(Inherited from Object) |
|  | [ValidFamilySymbolId](16dedf76-e1c9-556a-17d7-8ecdf0385cef.md) | Checks whether the family symbol id is allowed for StructuralConnectionTypes with the given value for the applyTo property. |
